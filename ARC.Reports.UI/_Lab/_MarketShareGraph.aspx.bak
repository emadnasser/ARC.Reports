<%@ Page Title="ARC Reports - Market Share Graphs" Language="C#" MasterPageFile="~/Pages/Admin.Master" AutoEventWireup="true" CodeBehind="_MarketShareGraph.aspx.cs" Inherits="ARC.Reports.Pages._MarketShareGraph" %>
                        ...
                        <ContentCollection>
                            <dx:ContentControl ID="ContentControl1" runat="server">
                                ...
                                <dx:WebChartControl ID="WebChartControl0" runat="server" Height="480px" CssClass="AlignCenter TopLargeMargin" ClientInstanceName="Chart_0"
                                    Width="1000px" CrosshairEnabled="True" Visible="false" OnCustomCallback="WebChartControl0_CustomCallback">
                                    <SeriesSerializable>
...
<WorkdaysOptions Workdays="Sunday, Monday, Tuesday, Wednesday, Thursday"></WorkdaysOptions>
                                ...
                                <dx:WebChartControl ID="WebChartControl1" runat="server" Height="480px" CssClass="AlignCenter TopLargeMargin"
                                    Width="1000px" ClientInstanceName="Chart_1" CrosshairEnabled="True" Visible="false">
                                    <SeriesSerializable>
                                        <dx:Series Name="Market Share Value" ArgumentScaleType="DateTime" LabelsVisibility="False" ArgumentDataMember="date" ValueDataMembersSerializable="Market_Share_Value" CrosshairLabelPattern="{V:n2}">
                                            <ViewSerializable>
                                                <dx:LineSeriesView MarkerVisibility="True">
...
<WorkdaysOptions Workdays="Sunday, Monday, Tuesday, Wednesday, Thursday"></WorkdaysOptions>
                                ...
                                <dx:WebChartControl ID="WebChartControl2" runat="server" Height="480px" CssClass="AlignCenter TopLargeMargin"
                                    Width="1000px" ClientInstanceName="Chart_2" CrosshairEnabled="True" Visible="false">
                                    <SeriesSerializable>
                                        <dx:Series Name="Market Share Value" ArgumentScaleType="DateTime" LabelsVisibility="False" ArgumentDataMember="date" ValueDataMembersSerializable="Market_Share_Value" CrosshairLabelPattern="{V:n2}%">
                                            <ViewSerializable>
                                                <dx:LineSeriesView MarkerVisibility="True">
                        ...
                        <ContentCollection>
                            <dx:ContentControl ID="ContentControl2" runat="server">
                                ...
                                <dx:WebChartControl ID="WebChartControl8" runat="server" Height="480px" CssClass="AlignCenter TopLargeMargin"
                                    Width="1000px" ClientInstanceName="Chart_4" CrosshairEnabled="True" Visible="false">
                                    <SeriesSerializable>
                                        <dx:Series Name="Market Share Value" ArgumentScaleType="DateTime" LabelsVisibility="False" ArgumentDataMember="date" ValueDataMembersSerializable="Market_Share_Value" CrosshairLabelPattern="{V:n2}">
                                            <ViewSerializable>
                                                <dx:LineSeriesView MarkerVisibility="True">
...
<WorkdaysOptions Workdays="Sunday, Monday, Tuesday, Wednesday, Thursday"></WorkdaysOptions>
                                            ...
                                            <AxisY Title-Text="Market Share Value" Title-Font="Tahoma, 10pt" VisibleInPanesSerializable="-1">
                                                <WholeRange auto="False" maxvalueserializable="10000000" minvalueserializable="0"></WholeRange>
                                                <GridLines MinorVisible="True" Visible="False"></GridLines>
                                                <Label TextPattern="{V:G}">
                                                </Label>
                                            </AxisY>
                                ...
                                <dx:WebChartControl ID="WebChartControl4" runat="server" Height="480px" CssClass="AlignCenter TopLargeMargin"
                                    Width="1000px" ClientInstanceName="Chart_5" CrosshairEnabled="True" Visible="false">
                                    <SeriesSerializable>
                                        <dx:Series Name="Market Share Value" ArgumentScaleType="DateTime" LabelsVisibility="False" ArgumentDataMember="date" ValueDataMembersSerializable="Market_Share_Value" CrosshairLabelPattern="{V:n2}">
                                            <ViewSerializable>
                                                <dx:LineSeriesView MarkerVisibility="True">
...
<WorkdaysOptions Workdays="Sunday, Monday, Tuesday, Wednesday, Thursday"></WorkdaysOptions>
                                ...
                                <dx:WebChartControl ID="WebChartControl5" runat="server" Height="480px" CssClass="AlignCenter TopLargeMargin"
                                    Width="1000px" ClientInstanceName="Chart_6" CrosshairEnabled="True" Visible="false">
                                    <SeriesSerializable>
                                        <dx:Series Name="Market Share Value" ArgumentScaleType="DateTime" LabelsVisibility="False" ArgumentDataMember="date" ValueDataMembersSerializable="Market_Share_Value" CrosshairLabelPattern="{V:n2}">
                                            <ViewSerializable>
                                                <dx:LineSeriesView MarkerVisibility="True">
...
<WorkdaysOptions Workdays="Sunday, Monday, Tuesday, Wednesday, Thursday"></WorkdaysOptions>
                                ...
                                <dx:WebChartControl ID="WebChartControl6" runat="server" Height="480px" CssClass="AlignCenter TopLargeMargin"
                                    Width="1000px" ClientInstanceName="Chart_7" CrosshairEnabled="True" Visible="false">
                                    <SeriesSerializable>
                                        <dx:Series Name="Market Share Value" ArgumentScaleType="DateTime" LabelsVisibility="False" ArgumentDataMember="date" ValueDataMembersSerializable="Market_Share_Value" CrosshairLabelPattern="{V:n2}">
                                            <ViewSerializable>
                                                <dx:LineSeriesView MarkerVisibility="True">
