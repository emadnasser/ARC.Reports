...
namespace ARC.Reports.Controls
{
    public partial class MarketShareTotal_1M : System.Web.UI.UserControl
    {
        ...
        {
            var myData = SData.MarketShareAVG(Year, MarketType);
        ...
        private void GetData()
        {
            try
            {
                ...
                if (MarketType == 0)
                {
                    ASPxGridView6.DataSource = SData.MarketShareTotal_M(Year, 0);
                }
                else if (MarketType == 1)
                {
                    ASPxGridView6.DataSource = SData.MarketShareTotal_M(Year, 1);
                }
