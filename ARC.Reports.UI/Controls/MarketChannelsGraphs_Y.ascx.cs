    ...
    public partial class MarketChannelsGraphs_Y : System.Web.UI.UserControl
    {
        ...
        private void GetData()
        {
            try
            {
                ...
                if (MarketType == 0)
                {
                    x = SData.MarketShareGraphsChannelsMarketShare(0, 3);
                    y = SData.MarketShareGraphsChannelsTradeShare(0, 3);
                }
                else
                {
                    x = SData.MarketShareGraphsChannelsMarketShare(1, 3);
                    y = SData.MarketShareGraphsChannelsTradeShare(1, 3);
                }
