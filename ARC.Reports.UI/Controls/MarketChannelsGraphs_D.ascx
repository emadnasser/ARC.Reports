        ...
        <div class="widget-box transparent">
            ...
            <div class="widget-body">
                <div class="widget-main no-padding">
                    <dx:WebChartControl ID="WebChartControl2" ClientInstanceName="Chart" Width="1000px" Height="480px" CssClass="AlignCenter TopLargeMargin" runat="server" CrosshairEnabled="True">
                        <SeriesSerializable>
                            <dx:Series ArgumentDataMember="Channel" Name="APT" CrosshairLabelPattern="{S}: {V:n2}%" LabelsVisibility="True" ValueDataMembersSerializable="TradeShare">
                                <DataFilters>
                                    <dx:DataFilter InvariantValueSerializable="APT" />
                                </DataFilters>
                                <ViewSerializable>
                                    <dx:LineSeriesView>
                                    </dx:LineSeriesView>
                                ...
                                <LabelSerializable>
                                    <dx:PointSeriesLabel TextPattern="{V:n2}%">
                                    </dx:PointSeriesLabel>
                                </LabelSerializable>
                            </dx:Series>
                            <dx:Series Name="CTF">
                                <DataFilters>
                                    <dx:DataFilter InvariantValueSerializable="CTF" />
                                </DataFilters>
                                <ViewSerializable>
                                    <dx:LineSeriesView>
                                    </dx:LineSeriesView>
                            ...
                            <dx:Series Name="CTU">
                                <DataFilters>
                                    <dx:DataFilter InvariantValueSerializable="CTU" />
                                </DataFilters>
                                <ViewSerializable>
                                    <dx:LineSeriesView>
                                    </dx:LineSeriesView>
                            ...
                            <dx:Series Name="Internet">
                                <DataFilters>
                                    <dx:DataFilter InvariantValueSerializable="Internet" />
                                </DataFilters>
                                <ViewSerializable>
                                    <dx:LineSeriesView>
                                    </dx:LineSeriesView>
                            ...
                            <dx:Series Name="IPO">
                                <DataFilters>
                                    <dx:DataFilter InvariantValueSerializable="IPO" />
                                </DataFilters>
                                <ViewSerializable>
                                    <dx:LineSeriesView>
                                    </dx:LineSeriesView>
                            ...
                            <dx:Series Name="ORM">
                                <DataFilters>
                                    <dx:DataFilter InvariantValueSerializable="ORM" />
                                </DataFilters>
                                <ViewSerializable>
                                    <dx:LineSeriesView>
                                    </dx:LineSeriesView>
                            ...
                            <dx:Series Name="Mobile">
                                <DataFilters>
                                    <dx:DataFilter InvariantValueSerializable="Mobile" />
                                </DataFilters>
                                <ViewSerializable>
                                    <dx:LineSeriesView>
                                    </dx:LineSeriesView>
                            ...
                            <dx:Series Name="PTC">
                                <DataFilters>
                                    <dx:DataFilter InvariantValueSerializable="PTC" />
                                </DataFilters>
                                <ViewSerializable>
                                    <dx:LineSeriesView>
                                    </dx:LineSeriesView>
                            ...
                            <dx:Series Name="OPR">
                                <DataFilters>
                                    <dx:DataFilter InvariantValueSerializable="OPR" />
                                </DataFilters>
                                <ViewSerializable>
                                    <dx:LineSeriesView>
                                    </dx:LineSeriesView>
...
<div class="row">
    <div class="col-sm-12">
        <div class="widget-box transparent">
            ...
            <div class="widget-body">
                <div class="widget-main no-padding">
                    <dx:WebChartControl ID="WebChartControl1" ClientInstanceName="Chart" Width="1000px" Height="480px" CssClass="AlignCenter TopLargeMargin" runat="server" CrosshairEnabled="True">
                        <SeriesSerializable>
