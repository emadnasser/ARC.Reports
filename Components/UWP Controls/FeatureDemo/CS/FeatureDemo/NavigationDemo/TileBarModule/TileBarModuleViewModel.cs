...
namespace NavigationDemo {
    ...
    public class NavigationItem : BindableBase {
        ...
        public NavigationItem(string text, Type targetType, BitmapImage image, Color color, bool showFlyout, NavigationItem parent) {
            Parent = parent;
            Text = text;
    ...
    static class NavigationItemsDataProvider {
        ...
        static string[] images = new string[] {
            "ms-appx:///NavigationDemo/Images/Calc.png",
            "ms-appx:///NavigationDemo/Images/Rates.png",
            "ms-appx:///NavigationDemo/Images/Research.png",
            "ms-appx:///NavigationDemo/Images/Statistics.png",
            "ms-appx:///NavigationDemo/Images/System.png",
            "ms-appx:///NavigationDemo/Images/UserManagment.png",
            "ms-appx:///NavigationDemo/Images/ZillowLogo.png"
        };
        ...
        static NavigationItem GenerateNavigationItem(string text, Type navigationTarget, NavigationItem parent = null) {
            return new NavigationItem(text, navigationTarget, new BitmapImage(new Uri(images[random.Next(images.Length)])),
