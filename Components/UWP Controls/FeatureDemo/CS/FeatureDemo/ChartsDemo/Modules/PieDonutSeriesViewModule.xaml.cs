...
using DevExpress.UI.Xaml.Layout.Utils;
...
namespace ChartsDemo {
    ...
    public sealed partial class PieDonutSeriesViewModule : DemoModuleView, ILayoutAwareControl {
        ...
        IApplicationViewStateService service;
