...
public partial class RadarAreaSeries : ChartBasePage {
    ...
    void PerformShowMarkersAction() {
        foreach (Series series in WebChartControl1.Series)
            ((RadarAreaSeriesView)series.View).MarkerVisibility = cbShowMarkers.Checked ? DefaultBoolean.True : DefaultBoolean.False;
    }
}
