...
public partial class SplineArea3DStackedSeries : ChartBasePage {
    ...
    protected void Page_Load(object sender, EventArgs e) {
        if (!IsPostBack) {
            ...
            ComboBoxHelper.PrepareTransparencyComboBox(cbTransparency, ((StackedSplineArea3DSeriesView)series.View).Transparency);
    ...
    void PerformTransparencyAction() {
        ...
        ((StackedSplineArea3DSeriesView)WebChartControl1.SeriesTemplate.View).Transparency = transparency;
    }
