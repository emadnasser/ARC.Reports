...
public partial class Area3DFullStackedSeries : ChartBasePage {
    ...
    protected void Page_Load(object sender, EventArgs e) {
        if (!IsPostBack) {
            ...
            ComboBoxHelper.PrepareTransparencyComboBox(cbTransparency, ((Area3DSeriesView)series.View).Transparency);
    ...
    void PerformTransparencyAction() {
        ...
        ((Area3DSeriesView)WebChartControl1.SeriesTemplate.View).Transparency = transparency;
    }
