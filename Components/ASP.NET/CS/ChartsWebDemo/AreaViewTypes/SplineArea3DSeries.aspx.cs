...
public partial class SplineArea3DSeries : ChartBasePage {
    ...
    protected void Page_Load(object sender, EventArgs e) {
        if (!IsPostBack) {
            ...
            ComboBoxHelper.PrepareTransparencyComboBox(cbTransparency, ((SplineArea3DSeriesView)series.View).Transparency);
    ...
    void PerformTransparencyAction() {
        ...
        ((SplineArea3DSeriesView)WebChartControl1.SeriesTemplate.View).Transparency = transparency;
    }
