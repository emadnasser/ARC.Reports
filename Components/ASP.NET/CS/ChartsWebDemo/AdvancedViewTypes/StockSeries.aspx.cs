...
public partial class StockSeries : ChartBasePage {
    ...
    void PerformStockTypeAction() {
        View.ShowOpenClose = (StockType)ComboBoxHelper.GetSelectedItem(cbStockType, typeof(StockType));
    }
    ...
    protected void WebChartControl1_CustomCallback(object sender, CustomCallbackEventArgs e) {
        if (e.Parameter == "StockType")
            PerformStockTypeAction();
        else if (e.Parameter == "ReductionLevel")
