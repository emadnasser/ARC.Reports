...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHolder" runat="Server">
    <table class="OptionsTable" style="width: 100%">
        <tr>
            <td>
                <dx:ASPxCheckBox ID="cbAllowMinimize" runat="server" AutoPostBack="true" Checked="true" Text="Allow Minimize"></dx:ASPxCheckBox>
            </td>
            <td>
                <dx:ASPxCheckBox ID="cbShowFileTab" runat="server" AutoPostBack="true" Checked="true" Text="Show File Tab"></dx:ASPxCheckBox>
            </td>
            <td>
                <dx:ASPxCheckBox ID="cbShowTabs" runat="server" AutoPostBack="true" Checked="true" Text="Show Tabs"></dx:ASPxCheckBox>
            </td>
            <td>
                <dx:ASPxCheckBox ID="cbShowGroupNames" runat="server" AutoPostBack="true" Checked="true" Text="Show Group Names"></dx:ASPxCheckBox>
            </td>
        </tr>
    </table>
