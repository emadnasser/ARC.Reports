...
namespace DevExpress.Web.Demos {
    public static class ArtsDataProvider {
        ...
        public static ArtsDBContext DB {
            get {
                if(HttpContext.Current.Items[ArtsDataContextKey] == null)
                    HttpContext.Current.Items[ArtsDataContextKey] = new ArtsDBContext();
                return (ArtsDBContext)HttpContext.Current.Items[ArtsDataContextKey];
            }
        }
