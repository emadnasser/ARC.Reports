...
namespace DevExpress.Web.Demos {
    ...
    public class LoanAmortizationScheduleDemoHelper {
        ...
        protected Worksheet GetWorksheet(IWorkbook document) {
            if(document == null)
                return null;
        ...
        public void PrepareSpreadsheetDocument(IWorkbook document) {
        ...
        void SetupGeneralSettings(IWorkbook workbook) {
        ...
        void GenerateTableHeaders(Worksheet worksheet) {
        ...
        void ApplyStyleToTableBody(Worksheet worksheet) {
            int actualNumberOfPayments = GetActualNumberOfPayments(worksheet);
            int actualLastRow = GetActualLastRow(worksheet);
