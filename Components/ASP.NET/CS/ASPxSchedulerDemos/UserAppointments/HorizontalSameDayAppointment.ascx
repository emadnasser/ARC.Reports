            ...
            <tr>
                <td>
                    <asp:Label ID="lblStartTime" runat="server" Style="white-space: normal; font: 8pt Tahoma;
                        color: #37414D;" Text='<%#((HorizontalAppointmentTemplateContainer)Container).Items.StartTimeText.Text%>'
                        Visible='<%#((HorizontalAppointmentTemplateContainer)Container).Items.StartTimeText.Visible%>'></asp:Label>
                    -
                    <asp:Label ID="lblEndtTime" runat="server" Style="white-space: normal; font: 8pt Tahoma;
                        color: #37414D;" Text='<%#((HorizontalAppointmentTemplateContainer)Container).Items.EndTimeText.Text%>'
                        Visible='<%#((HorizontalAppointmentTemplateContainer)Container).Items.EndTimeText.Visible%>'></asp:Label>
