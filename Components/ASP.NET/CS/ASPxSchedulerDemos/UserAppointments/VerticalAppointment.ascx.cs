...
public partial class VerticalAppointment : System.Web.UI.UserControl {
	...
	protected void Page_Load(object sender, EventArgs e) {
		...
		this.lblLocation.Text = HttpUtility.HtmlEncode(Container.AppointmentViewInfo.Appointment.Location);
		this.lblDescription.Text = HttpUtility.HtmlEncode(Container.AppointmentViewInfo.Appointment.Description);
