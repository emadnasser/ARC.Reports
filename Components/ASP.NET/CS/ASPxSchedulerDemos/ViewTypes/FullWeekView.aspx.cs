...
public partial class ViewTypes_FullWeekView : System.Web.UI.Page {
    ...
    void ApplyOptions() {
        ...
        try {
            DevExpress.Web.ASPxScheduler.FullWeekView fullWeekView = ASPxScheduler1.FullWeekView;
            ...
            fullWeekView.AppointmentDisplayOptions.SnapToCellsMode = (AppointmentSnapToCellsMode)cbSnapToCellsMode.Value;
            fullWeekView.TimeIndicatorDisplayOptions.Visibility = (TimeIndicatorVisibility)cbTimeIndicatorVisibility.Value;
            fullWeekView.TimeMarkerVisibility = (TimeMarkerVisibility)cbTimeMarkerVisibility.Value;
        } finally {
