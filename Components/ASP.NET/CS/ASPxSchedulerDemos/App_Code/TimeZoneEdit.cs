...
namespace DevExpress.Web.Demos.ASPxScheduler {
    ...
    public class ASPxTimeZoneEditEx : ASPxTimeZoneEdit {
        ...
        protected override void RegisterIncludeScripts() {
            ...
            RegisterIncludeScript(typeof(ASPxTimeZoneEditEx), ASPxTimeZoneEditEx.ScriptFileName);
        }
        protected new void RegisterIncludeScript(Type type, string resourceName) {
            string key = type.FullName + "_" + resourceName;
            if(ResourceManager.ScriptBlocksRegistrator.RegisteredScriptBlocks.ContainsKey(key))
                return;
