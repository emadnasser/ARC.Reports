...
public static class DataHelper {
    ...
    public static void SetupDefaultMappings(ASPxScheduler control, bool useImageResourceMapping) {
...
public class DbRowInsertionProvider {
    ...
    void AppointmentsEntityDataSource_Inserted(object sender, EntityDataSourceChangedEventArgs e) {
        this.lastInsertedIdList.Add((e.Entity as MedicsSchedulingDb_MedicalAppointments).ID);
    }
