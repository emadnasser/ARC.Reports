<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TasksGridView.ascx.cs" Inherits="UserControls_ViewControls_TasksGridView" %>
        ...
        <dx:GridViewDataColumn Caption="% Completed" Width="200">
            <DataItemTemplate>
                <table><tr><td class="progressBarCell">
                    <dx:ASPxProgressBar ID="Progress" runat="server" ShowPosition="false" Position='<%# (int)Eval("Completion") %>' Width="140" Height="10" />
                </td><td>
                    <%# Eval("Completion") %>%
                </td></tr></table>
            </DataItemTemplate>
