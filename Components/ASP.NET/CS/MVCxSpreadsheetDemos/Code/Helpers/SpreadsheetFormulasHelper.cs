...
namespace DevExpress.Web.Demos {
    public class SpreadsheetFormulasDemoHelper {
        ...
        public static void PrepareSpreadsheet(MVCxSpreadsheet Spreadsheet, int invoiceSheetIndex) {
            ...
            Worksheet sheet = book.Worksheets[invoiceSheetIndex];
