<%@ Control Language="vb" AutoEventWireup="true" CodeFile="FooterControl.ascx.vb" Inherits="UserControls_FooterControl" %>
<div class="footer">
    ...
    <div class="info">
        <div class="content-сolumn">
            <div class="copyright">
                Copyright (c) <%:Date.Today.Year.ToString()%> Developer Express Inc.
            </div>
            <div class="logo">
