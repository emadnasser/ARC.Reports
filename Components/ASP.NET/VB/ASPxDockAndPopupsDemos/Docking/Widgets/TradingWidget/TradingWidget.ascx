<%@ Control Language="vb" ClassName="Trading" %>
<%@ Register Src="~/Docking/Widgets/TradingWidget/MarketLeadersTableRow.ascx" TagName="MarketLeadersTableRow" TagPrefix="uc" %>
<%@ Register Src="~/Docking/Widgets/TradingWidget/CurrencyRatesTableRow.ascx" TagName="CurrencyRatesTableRow" TagPrefix="uc" %>
<script runat="server">
</script>
