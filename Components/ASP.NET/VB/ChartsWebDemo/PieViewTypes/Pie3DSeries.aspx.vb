...
Partial Public Class Pie3DSeries
	...
	Private ReadOnly Property Label() As Pie3DSeriesLabel
		...
		End Get
	End Property
	Private ReadOnly Property View() As Pie3DSeriesView
		Get
			Return CType(Series.View, Pie3DSeriesView)
		End Get
	End Property
	...
	Protected Sub WebChartControl1_CustomCallback(ByVal sender As Object, ByVal e As DevExpress.XtraCharts.Web.CustomCallbackEventArgs)
		...
		ElseIf e.Parameter = "ExplodeDistance" Then
	...
	End Sub
	Private Sub PerformExplodeDistanceAction()
