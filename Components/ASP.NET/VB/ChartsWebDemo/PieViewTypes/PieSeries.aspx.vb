...
Partial Public Class PieSeries
	...
	Private ReadOnly Property Series() As Series
		...
		End Get
	End Property
	Private ReadOnly Property Label() As PieSeriesLabel
		Get
			Return CType(Series.Label, PieSeriesLabel)
		End Get
	End Property
	Private ReadOnly Property View() As PieSeriesViewBase
		Get
			Return CType(Series.View, PieSeriesViewBase)
		End Get
	End Property
