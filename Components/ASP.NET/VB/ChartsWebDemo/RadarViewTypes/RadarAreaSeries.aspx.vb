...
Partial Public Class RadarAreaSeries
	...
	Private Sub PerformShowMarkersAction()
		For Each series As Series In WebChartControl1.Series
			CType(series.View, RadarAreaSeriesView).MarkerVisibility = If(cbShowMarkers.Checked, DefaultBoolean.True, DefaultBoolean.False)
		Next series
	End Sub
End Class
