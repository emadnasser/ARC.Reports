...
Partial Public Class RadarLineSeries
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
		If (Not IsPostBack) Then
			...
			Dim view As RadarLineSeriesView = CType(series.View, RadarLineSeriesView)
	...
	Private Sub PerformShowMarkersAction()
		For Each series As Series In WebChartControl1.Series
			CType(series.View, RadarLineSeriesView).MarkerVisibility = If(cbShowMarkers.Checked, DefaultBoolean.True, DefaultBoolean.False)
		Next series
	End Sub
End Class
