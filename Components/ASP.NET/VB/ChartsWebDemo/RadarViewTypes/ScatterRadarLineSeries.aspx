<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ScatterRadarLineSeries.aspx.vb" Inherits="ScatterRadarLineSeries" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHolder" runat="Server">
	...
	<dx:WebChartControl ID="WebChartControl1" runat="server" Height="400px" Width="700px" CssClass="AlignCenter TopLargeMargin"
		...
		<SeriesSerializable>
			<dx:Series Name="Function" ArgumentScaleType="Numerical" LabelsVisibility="False" ToolTipPointPattern="{A:F2}: {V:F2}">
				<ViewSerializable>
					<dx:ScatterRadarLineSeriesView Closed="False" MarkerVisibility="False">
						<LineMarkerOptions Size="8"></LineMarkerOptions>
					</dx:ScatterRadarLineSeriesView>
				</ViewSerializable>
				<LabelSerializable>
		...
		<DiagramSerializable>
			<dx:RadarDiagram StartAngleInDegrees="270">
				<AxisX>
					<Label TextPattern="{A:0.##}">
					</Label>
					<NumericScaleOptions AutoGrid="False" GridSpacing="0.523598">
					</NumericScaleOptions>
					<WholeRange Auto="False" AutoSideMargins="False" MaxValueSerializable="6.28" MinValueSerializable="0" SideMarginsValue="0">
					</WholeRange>
				</AxisX>
				<AxisY>
