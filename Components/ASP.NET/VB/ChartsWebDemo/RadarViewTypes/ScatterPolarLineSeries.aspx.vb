...
Partial Public Class ScatterPolarLineSeries
	...
	Private ReadOnly Property Series() As Series
		...
		End Get
	End Property
	Private ReadOnly Property View() As ScatterPolarLineSeriesView
		Get
			Return CType(Series.View, ScatterPolarLineSeriesView)
		End Get
	End Property
