<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="RadarAreaSeries.aspx.vb" Inherits="RadarAreaSeries" %>
	...
	<dx:WebChartControl ID="WebChartControl1" runat="server" Height="400px" Width="700px" CssClass="AlignCenter TopLargeMargin"
		...
		<SeriesSerializable>
			<dx:Series Name="Day (max)" ArgumentScaleType="DateTime" LabelsVisibility="False">
				...
				<ViewSerializable>
					<dx:RadarAreaSeriesView>
						<MarkerOptions Size="8"></MarkerOptions>
					</dx:RadarAreaSeriesView>
				</ViewSerializable>
			</dx:Series>
