<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="RadarRangeAreaSeries.aspx.vb" Inherits="RadarRangeAreaSeries" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHolder" runat="Server">
	<dx:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" Width="100%" ShowHeader="False">
		...
		<dx:PanelContent ID="PanelContent1" runat="server">    
			<table style="width: 100%;">
				...
				<tr>
					<td><dx:ASPxCheckBox ID="cbShowMarkers" runat="server" Text="Show Markers" ClientInstanceName="chbShowMarkers">
	...
	<dx:WebChartControl ID="WebChartControl1" runat="server" Height="400px" Width="700px" CssClass="AlignCenter TopLargeMargin"
		...
		<SeriesSerializable>
			<dx:Series Name="Day-Night" ArgumentScaleType="DateTime" LabelsVisibility="False">
				<Points>
					<dx:SeriesPoint Values="6;2" ArgumentSerializable="01/01/2001 00:00:00.000"></dx:SeriesPoint>
					<dx:SeriesPoint Values="7;2" ArgumentSerializable="02/01/2001 00:00:00.000"></dx:SeriesPoint>
					<dx:SeriesPoint Values="10;3" ArgumentSerializable="03/01/2001 00:00:00.000"></dx:SeriesPoint>
					<dx:SeriesPoint Values="14;5" ArgumentSerializable="04/01/2001 00:00:00.000"></dx:SeriesPoint>
					<dx:SeriesPoint Values="18;8" ArgumentSerializable="05/01/2001 00:00:00.000"></dx:SeriesPoint>
					<dx:SeriesPoint Values="21;11" ArgumentSerializable="06/01/2001 00:00:00.000"></dx:SeriesPoint>
					<dx:SeriesPoint Values="22;13" ArgumentSerializable="07/01/2001 00:00:00.000"></dx:SeriesPoint>
					<dx:SeriesPoint Values="22;13" ArgumentSerializable="08/01/2001 00:00:00.000"></dx:SeriesPoint>
					<dx:SeriesPoint Values="19;11" ArgumentSerializable="09/01/2001 00:00:00.000"></dx:SeriesPoint>
					<dx:SeriesPoint Values="15;8" ArgumentSerializable="10/01/2001 00:00:00.000"></dx:SeriesPoint>
					<dx:SeriesPoint Values="10;5" ArgumentSerializable="11/01/2001 00:00:00.000"></dx:SeriesPoint>
					<dx:SeriesPoint Values="7;3" ArgumentSerializable="12/01/2001 00:00:00.000"></dx:SeriesPoint>
				</Points>
				<ViewSerializable>
					<dx:RadarRangeAreaSeriesView>
					</dx:RadarRangeAreaSeriesView>
				</ViewSerializable>
			</dx:Series>
