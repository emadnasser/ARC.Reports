<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AreaSeries.aspx.vb" Inherits="AreaSeries" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHolder" runat="Server">
	...
	<dx:WebChartControl ID="WebChartControl1" runat="server" Height="400px"
		...
		ToolTipEnabled="False" SeriesDataMember = "Company" DataSourceID="chartDataSource">
		<CrosshairOptions   GroupHeaderPattern="Year: {A:yyyy}">
			<CommonLabelPositionSerializable>
				<dx:CrosshairFreePosition DockCorner="RightTop" OffsetX="20" OffsetY="60">
				</dx:CrosshairFreePosition>
			</CommonLabelPositionSerializable>
		</CrosshairOptions>
		<Titles>
