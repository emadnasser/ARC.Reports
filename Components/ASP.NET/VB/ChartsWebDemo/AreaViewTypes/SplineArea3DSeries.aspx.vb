...
Partial Public Class SplineArea3DSeries
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
		If (Not IsPostBack) Then
			...
			ComboBoxHelper.PrepareTransparencyComboBox(cbTransparency, (CType(series.View, SplineArea3DSeriesView)).Transparency)
	...
	Private Sub PerformTransparencyAction()
		...
		CType(WebChartControl1.SeriesTemplate.View, SplineArea3DSeriesView).Transparency = transparency
	End Sub
