...
Partial Public Class SplineArea3DStackedSeries
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
		If (Not IsPostBack) Then
			...
			ComboBoxHelper.PrepareTransparencyComboBox(cbTransparency, (CType(series.View, StackedSplineArea3DSeriesView)).Transparency)
	...
	Private Sub PerformTransparencyAction()
		...
		CType(WebChartControl1.SeriesTemplate.View, StackedSplineArea3DSeriesView).Transparency = transparency
	End Sub
