...
Partial Public Class Area3DFullStackedSeries
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
		If (Not IsPostBack) Then
			...
			ComboBoxHelper.PrepareTransparencyComboBox(cbTransparency, (CType(series.View, Area3DSeriesView)).Transparency)
	...
	Private Sub PerformTransparencyAction()
		...
		CType(WebChartControl1.SeriesTemplate.View, Area3DSeriesView).Transparency = transparency
	End Sub
