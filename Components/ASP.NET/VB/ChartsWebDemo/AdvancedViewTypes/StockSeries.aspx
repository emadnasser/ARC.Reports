<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="StockSeries.aspx.vb" Inherits="StockSeries" %>
		...
		<dx:PanelContent ID="PanelContent1" runat="server">      
			<table style="width: 100%;">
				<tr>
					...
					<td><div class="Spacer"></div></td>                            
					<td><div class="Spacer"></div></td>                            
					<td class="NoWrap"><dx:ASPxLabel ID="lblStockType" runat="server" Text="Stock Type:"/></td>
					<td><div class="Spacer" style="width: 5px"></div></td>                            
					<td>
						<dx:ASPxComboBox ID="cbStockType" runat="server" Width="80px">
							<ClientSideEvents SelectedIndexChanged="function(s, e) { chart.PerformCallback(&quot;StockType&quot;); }" />
						</dx:ASPxComboBox>
					</td>                    
				</tr>
	...
	<dx:WebChartControl ID="WebChartControl1" runat="server" Height="400px" Width="700px" CssClass="AlignCenter TopLargeMargin"
		...
		<SeriesSerializable>
			<dx:Series Name="Google Inc." ArgumentScaleType="DateTime" LabelsVisibility="False"
				...
				<ViewSerializable>
					<dx:StockSeriesView Color="Black"></dx:StockSeriesView>
				</ViewSerializable>
				<LabelSerializable>
