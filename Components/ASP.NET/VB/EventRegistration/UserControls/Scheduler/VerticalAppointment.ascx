<%@ Control Language="vb" AutoEventWireup="true" CodeFile="VerticalAppointment.ascx.vb"
...
<div id="AppointmentDiv" runat="server" class="apt">
	...
	<div class="session">
		<dx:ASPxHyperLink ID="hlTitle" runat="server" CssClass="title" Text="<%#(CType(Container, VerticalAppointmentTemplateContainer)).AppointmentViewInfo.Appointment.Subject%>">
