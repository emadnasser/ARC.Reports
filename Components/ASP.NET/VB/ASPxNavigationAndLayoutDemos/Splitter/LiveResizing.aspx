<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="LiveResizing.aspx.vb"
	Inherits="Splitter_LiveResizing" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHolder" runat="Server">
	<dx:ASPxSplitter ID="ASPxSplitter1" runat="server" Height="400px" Width="100%" ResizingMode="Live">
		<Panes>
