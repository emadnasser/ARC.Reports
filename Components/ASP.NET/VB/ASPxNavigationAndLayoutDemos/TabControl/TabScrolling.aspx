<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TabScrolling.aspx.vb" Inherits="TabControl_TabScrolling" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHolder" runat="Server">
	<dx:ASPxPageControl ID="ASPxPageControl1" runat="server" Width="705px" Height="350px"
		TabAlign="Justify" ActiveTabIndex="5" EnableTabScrolling="true">
			...
			<dx:TabPage Text="Scheduling">
				<ContentCollection>
					<dx:ContentControl ID="ContentControl1" runat="server">
						<dx:ComponentView ID="ComponentView1" runat="server" ComponentGroupName="Scheduling" />
					</dx:ContentControl>
				</ContentCollection>
			</dx:TabPage>
