<%@ Page Language="vb" AutoEventWireup="true" CodeFile="Sales.aspx.vb" MasterPageFile="~/SiteBase.master" Inherits="Sales" %>
<%@ Register assembly="DevExpress.Web.v16.2" namespace="DevExpress.Data.Linq" tagprefix="dx" %>
...
<asp:Content ID="ContentHolder" runat="server" ContentPlaceHolderID="ContentPlaceHolder">
    ...
    <div>
        <dx:LinqServerModeDataSource ID="SalesDataSource" runat="server" OnSelecting="SalesDataSource_Selecting" />
        <dx:ASPxPivotGrid ID="SalesPivotGrid" runat="server" OnInit="SalesPivotGrid_Init"
            ...
            <Fields>
                <dx:PivotGridField ID="fieldGroupName" AllowedAreas="ColumnArea" Area="ColumnArea" AreaIndex="0" Caption="Product" FieldName="Product.Name">
                </dx:PivotGridField>
