<%@ Page Language="vb" AutoEventWireup="true" MasterPageFile="~/SiteBase.master" CodeFile="RevenueByChannel.aspx.vb" Inherits="RevenueByChannel" %>
                    ...
                    <div>
                        ...
                        <div class="verticalAlignTop horizontalAlignRight">
                            <div class="revenueByChannelLegend">
                                <%
                                For i As Integer = 0 To ChannelsRevenue.Count - 1
                                %>
                        ...
                        <div class="verticalAlignTop horizontalAlignLeft">
                            ...
                            <div class="revenueChannelList">
                                ...
                                <div class="row total">
                                    ...
                                    <div><%=String.Format("{0:C0}", ChannelsRevenue.Sum(Function(x) x.Value))%></div>
                                </div>
                            </div>
                        </div>
                        <div class="verticalAlignTop horizontalAlignRight">
