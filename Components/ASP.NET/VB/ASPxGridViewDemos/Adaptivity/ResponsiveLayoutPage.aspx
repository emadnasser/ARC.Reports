...
<head runat="server">
	...
	<title>Responsive Layout - ASP.NET GridView Control</title>
...
<body>
	<form id="form1" runat="server">
		<dx:ASPxGridView runat="server" Width="100%" ID="ASPxGridView1" ClientInstanceName="sampleGrid"
			...
			<Columns>
				<dx:GridViewCommandColumn ShowNewButtonInHeader="true" ShowDeleteButton="False" ShowEditButton="true" Width="50" />
				...
				<dx:GridViewDataSpinEditColumn FieldName="UnitsInStock" Width="110px">
