<%@ Page Title="" Language="vb" MasterPageFile="~/Print.master" AutoEventWireup="true" CodeFile="PrintContacts.aspx.vb" Inherits="PrintContacts" %>
				...
				<dx:ReportToolbarTemplateItem>
					<Template>
						<div class="dxtb-comboBoxMenuItem" style="float: right">
							<dx:ASPxComboBox ID="PrintAddressFilterCombo" runat="server" SelectedIndex="1" Caption="Address Book:">
								<Items>
