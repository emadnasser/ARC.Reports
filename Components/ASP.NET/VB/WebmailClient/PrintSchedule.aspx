<%@ Page Title="" Language="vb" MasterPageFile="~/Print.master" AutoEventWireup="true" CodeFile="PrintSchedule.aspx.vb" Inherits="PrintSchedule" %>
	...
	<div class="ReportToolbarContainer">
		<dx:ReportToolbar ID="ScheduleReportToolbar" runat="server"  ClientInstanceName="ClientReportToolbar" CssClass="ReportToolbar"
			...
			<Items>
				...
				<dx:ReportToolbarLabel Text="Page" ItemKind="PageLabel" />
				<dx:ReportToolbarComboBox ItemKind="PageNumber" Width="65px" />
				<dx:ReportToolbarLabel Text="of" ItemKind="OfLabel" />
				...
				<dx:ReportToolbarTemplateItem>
					<Template>
						<div class="dxtb-comboBoxMenuItem">
							<dx:ASPxDateEdit ID="StartDateEdit" runat="server" ClientInstanceName="ClientPrintStartDateEdit" Caption="Start:" UseMaskBehavior="true" OnLoad="StartDateEdit_Load">
				...
				<dx:ReportToolbarTemplateItem>
					<Template>
						<div class="dxtb-comboBoxMenuItem">
							<dx:ASPxDateEdit ID="EndDateEdit" runat="server" ClientInstanceName="ClientPrintEndDateEdit" Caption="End:" UseMaskBehavior="true" OnLoad="EndDateEdit_Load">
