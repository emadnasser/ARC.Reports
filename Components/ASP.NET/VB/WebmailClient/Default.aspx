<%@ Page  Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Default.aspx.vb" Inherits="_Default" 
	...
	<dx:ASPxTreeView runat="server" ID="MailTree" ClientInstanceName="ClientMailTree" AllowSelectNode="True" CssClass="MailTree"
		...
		<Nodes>
			<dx:TreeViewNode Text="Inbox" Name="Inbox" Expanded="True" Image-SpriteProperties-CssClass="Sprite_Inbox">
				<Nodes>
					<dx:TreeViewNode Text="ASP" Name="ASP" Image-SpriteProperties-CssClass="Sprite_ASP" />
					<dx:TreeViewNode Text="Announcements" Name="Announcements" Image-SpriteProperties-CssClass="Sprite_Announcements" />
					<dx:TreeViewNode Text="DevExtreme" Name="DevExtreme" Image-SpriteProperties-CssClass="Sprite_DevExtreme" />
					<dx:TreeViewNode Text="Frameworks" Name="Frameworks" Image-SpriteProperties-CssClass="Sprite_Frameworks" />
				</Nodes>
			</dx:TreeViewNode>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainHolder" Runat="Server">
	<dx:ASPxGridView runat="server" ID="MailGrid"
		...
		<Columns>
			...
			<dx:GridViewDataColumn FieldName="HasAttachment" Width="50" VisibleIndex="1">
				...
				<HeaderCaptionTemplate>
					<dx:ASPxImage ID="I" runat="server" SpriteCssClass='<%#If(Utils.IsDarkTheme, "Sprite_Attachment_Light", "Sprite_Attachment")%>' />
				</HeaderCaptionTemplate>
				<DataItemTemplate>                                                    
					...
					<%#If(Utils.IsIE7 AndAlso (Not CBool(Eval("HasAttachment"))), "&nbsp;", "")%>
				</DataItemTemplate>
				<HeaderStyle HorizontalAlign="Center" SortingImageSpacing="5" />
			</dx:GridViewDataColumn>
			<dx:GridViewDataTextColumn FieldName="From" Settings-AllowFilterBySearchPanel="True" Width="15%"  VisibleIndex="2" />
			<dx:GridViewDataTextColumn FieldName="To" Settings-AllowFilterBySearchPanel="True" Width="15%" Visible="false" VisibleIndex="2" />
			<dx:GridViewDataColumn FieldName="Subject" Settings-AllowFilterBySearchPanel="True" VisibleIndex="3" />
		...
		<SettingsBehavior AutoExpandAllGroups="true" EnableRowHotTrack="True" />
