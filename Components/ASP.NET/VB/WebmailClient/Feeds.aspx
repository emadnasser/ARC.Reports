<%@ Page Title="" Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Feeds.aspx.vb" Inherits="Feeds" 
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainHolder" Runat="Server">
	<dx:ASPxGridView runat="server" ID="FeedGrid" ClientInstanceName="ClientFeedGrid" Width="100%" KeyFieldName="ID" EnableRowsCache="false"
		...
		Border-BorderWidth="0">
		<Columns>
			<dx:GridViewDataColumn FieldName="Title" Settings-AllowFilterBySearchPanel="True" />
			<dx:GridViewDataColumn FieldName="From" Settings-AllowFilterBySearchPanel="True" Width="200" />
