<%@ Page Title="" Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DataCell.aspx.vb" Inherits="Templates_DataCell" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHolder" runat="Server">
	<dx:ASPxVerticalGrid ID="VerticalGrid" runat="server" DataSourceID="CategoriesDataSource" KeyFieldName="CategoryID" EnableRecordsCache="false" Width="100%">
		<Rows>
		...
		<Settings RecordWidth="260" HorizontalScrollBarMode="Visible" />
	</dx:ASPxVerticalGrid>
