...
Partial Public Class Filtering_FilterBuilder
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
		VerticalGrid.SettingsFilterControl.ViewMode = If(cbEnableTextTab.Checked, FilterControlViewMode.VisualAndText, FilterControlViewMode.Visual)
		...
		End If
	End Sub
	Protected Sub VerticalGrid_FilterControlColumnsCreated(ByVal source As Object, ByVal e As FilterControlColumnsCreatedEventArgs)
