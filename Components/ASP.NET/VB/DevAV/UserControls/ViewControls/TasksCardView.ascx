<%@ Control Language="vb" AutoEventWireup="true" CodeFile="TasksCardView.ascx.vb" Inherits="UserControls_ViewControls_TasksCardView" %>
            ...
            <dx:CardViewColumnLayoutItem CssClass="taskCardContent">
                <Template>
                    <table class="taskCardData">
                        <tr>
                            <td>
                                ...
                                <%#DirectCast(Eval("StartDate"), Date).ToShortDateString()%>
                            </td>
                            <td>
                                <span>Due Date</span>
                                <%#DirectCast(Eval("DueDate"), Date).ToShortDateString()%>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                    ...
                    <div class="taskCardProgress">
                        <%#Eval("Completion")%>%
                        <dx:ASPxProgressBar ID="ASPxProgressBar2" ShowPosition="false" runat="server" Position='<%#DirectCast(Eval("Completion"), Integer)%>' Height="10px" Width="100%"></dx:ASPxProgressBar>
                    </div>
                </Template>
            </dx:CardViewColumnLayoutItem>
