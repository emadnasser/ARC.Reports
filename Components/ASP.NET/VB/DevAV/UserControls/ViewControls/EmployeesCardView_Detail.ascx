<%@ Control Language="vb" AutoEventWireup="true" CodeFile="EmployeesCardView_Detail.ascx.vb" Inherits="UserControls_ViewControls_EmployeesCardView_Detail" %>
                                    ...
                                    <table>
                                        <tr>
                                            <td class="progressBarCell">
                                                <dx:ASPxProgressBar ID="ASPxProgressBar1" ShowPosition="false" runat="server" Position='<%#DirectCast(Eval("Completion"), Integer)%>' Height="10px" Width="100%"></dx:ASPxProgressBar>
                                            </td>
                                            <td>
                                                <%#Eval("Completion")%>%
                                            </td>
