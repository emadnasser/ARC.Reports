<%@ Control Language="vb" AutoEventWireup="true" CodeFile="ShowHotels.ascx.vb" Inherits="UserControls_ShowHotels" %>
            ...
            <dx:ASPxDataView runat="server" ID="SearchResultsDataView" CssClass="data-view" Width="100%">
                ...
                <ItemTemplate>
                    ...
                    <div class="price">
                        STARTING FROM
                    <h4>
                        <%#String.Format("{0:C0}", Math.Truncate(DirectCast(Eval("StartPrice"), Decimal)))%>
                    </h4>
                    </div>
