<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CheckBoxList.aspx.vb"
	Inherits="ListEditors_CheckBoxList" %>
		...
		<tr>
			<td style="width: 900px; padding-right: 20px">
				 <dx:ASPxCheckBoxList ID="checkBoxList" runat="server" DataSourceID="ProgLanguages"
					ValueField="ID" TextField="Name" RepeatColumns="4" RepeatLayout="Table" Caption="Select the languages ​​you've worked with">
					<CaptionSettings Position="Top" />
				</dx:ASPxCheckBoxList>
				<asp:XmlDataSource ID="ProgLanguages" DataFile="~/App_Data/ProgLanguages.xml" XPath="//Language"
					runat="server" />
			</td>
			<td style="vertical-align: top">
				<table class="OptionsTable">
					<tr>
						<td>
							<dx:ASPxLabel runat="server" ID="layoutLabel" AssociatedControlID="cmbRepeatLayout"
								Text="RepeatLayout:" />
						</td>
						<td>
