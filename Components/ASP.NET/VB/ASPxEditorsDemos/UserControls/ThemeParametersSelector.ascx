...
<script runat="server">
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
		...
		rblFonts.DataBind()
		rblFonts.SelectedIndex = If((Not String.IsNullOrEmpty(ASPxWebControl.GlobalThemeFont)), rblFonts.Items.IndexOfValue(ASPxWebControl.GlobalThemeFont), 0)
	End Sub
	Protected Sub btnColor_Load(ByVal sender As Object, ByVal e As EventArgs)
		Dim button = (CType(sender, ASPxButton))
		...
		Dim currentColor = System.Drawing.ColorTranslator.FromHtml(If((Not String.IsNullOrEmpty(ASPxWebControl.GlobalThemeBaseColor)), ASPxWebControl.GlobalThemeBaseColor, Utils.CurrentThemeDefaultBaseColor))
							...
							<ItemTemplate><!--Fix whitespace issue
							 --><div class="color-item-container">
									<div class="color-item-wrapper">
										<dx:ASPxButton runat="server" ID="btnColor" GroupName="colors" CssClass="color-item" BackColor="<%#System.Drawing.ColorTranslator.FromHtml(CStr(Container.DataItem))%>"
