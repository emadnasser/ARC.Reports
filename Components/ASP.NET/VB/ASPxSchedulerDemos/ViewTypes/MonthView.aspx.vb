...
Partial Public Class ViewTypes_MonthView
...
'        
	...
	Private Sub ApplyOptions()
		...
		Try
			Dim monthView As DevExpress.Web.ASPxScheduler.MonthView = ASPxScheduler1.MonthView
			...
			monthView.WeekCount = CInt(Fix(cbWeekCount.Value))
		Finally
