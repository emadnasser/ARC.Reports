...
<table class="dxscBorderSpacing" style="width:100%; height:100%">
	<tr>
		...
		<td class="dxscCellWithPadding" style="width:100%">
			<dx:ASPxDateEdit ClientInstanceName="_dx" ID="edtDate" runat="server" Width="100%" Date='<%#(CType(Container, GotoDateFormTemplateContainer)).Date%>' />
		</td> 
	</tr>
	<tr>
		<td class="dxscCellWithPadding">
		...
		<td class="dxscCellWithPadding" style="width:100%">
			<dx:ASPxComboBox ClientInstanceName="_dx" ID="cbView" runat="server" Width="100%" DataSource='<%#(CType(Container, GotoDateFormTemplateContainer)).ViewsDataSource%>'></dx:ASPxComboBox>
		</td>
	</tr>
	<tr>
		<td class="dx-ac dxscCellWithPadding" <%=DevExpress.Web.Internal.RenderUtils.GetAlignAttributes(Me, "center", Nothing)%> colspan="2" style="width: 100%">
