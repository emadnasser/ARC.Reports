...
Partial Public Class Customization_CustomInplaceEditor
...
'        
	...
	Protected Sub ASPxScheduler1_BeforeExecuteCallbackCommand(ByVal sender As Object, ByVal e As SchedulerCallbackCommandEventArgs)
		If e.CommandId = SchedulerCallbackCommandId.InplaceEditorSave Then
			e.Command = New MyInplaceEditorSaveCallbackCommand(CType(sender, ASPxScheduler))
		End If
	End Sub
End Class
