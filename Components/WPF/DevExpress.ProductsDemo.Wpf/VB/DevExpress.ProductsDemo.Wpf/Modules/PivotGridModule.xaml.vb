...
Namespace ProductsDemo.Modules
 Partial Public Class PivotGridModule
  ...
  Public Property PivotGridControl() As PivotGridControl
   Get
       Return DirectCast(GetValue(PivotGridControlProperty), PivotGridControl)
   End Get
 ...
 Public Class IntToKMConverter
  ...
  Public Function Convert(ByVal value As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As System.Globalization.CultureInfo) As Object Implements IValueConverter.Convert
   ...
   If Integer.TryParse(s, result) AndAlso result > 0 Then
