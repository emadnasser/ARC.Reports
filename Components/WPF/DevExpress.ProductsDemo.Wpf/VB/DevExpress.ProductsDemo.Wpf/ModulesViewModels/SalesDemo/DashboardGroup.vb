...
Namespace ProductsDemo
    ...
    Public Class DashboardGroup
        ...
        Public Shared ReadOnly ContentProperty As DependencyProperty = DependencyProperty.Register("Content", GetType(Object), GetType(DashboardGroup), New PropertyMetadata(Nothing))
        ...
        Public Property HeaderMargin() As Thickness
            Get
                Return DirectCast(GetValue(HeaderMarginProperty), Thickness)
            End Get
