...
Namespace ProductsDemo
    Public Class DecimalToRangeValueConverter
        ...
        Public Function Convert(ByVal value As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As CultureInfo) As Object Implements IValueConverter.Convert
            ...
            Dim valueType As RangeValueType = If(parameter Is Nothing, RangeValueType.Absolute, DirectCast(parameter, RangeValueType))
            Return New RangeValue(doubleValue, valueType)
        End Function

        Public Function ConvertBack(ByVal value As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As CultureInfo) As Object Implements IValueConverter.ConvertBack
            Dim rv As RangeValue = DirectCast(value, RangeValue)
            Return rv.Value
        End Function
    End Class
End Namespace
