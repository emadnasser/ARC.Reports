...
Namespace ProductsDemo
    Partial Public Class MainWindow
        ...
        Private Sub OnDocumentFrameNavigated(ByVal sender As Object, ByVal e As NavigationEventArgs)
            ...
            End If
        End Sub
        Private Sub navPanelView_NavPaneExpandedChanged(ByVal sender As Object, ByVal e As NavPaneExpandedChangedEventArgs)
            layoutPanel.ItemWidth = GridLength.Auto
        End Sub
        Private Sub navPanelView_NavPaneExpandedChanging(ByVal sender As Object, ByVal e As NavPaneExpandedChangingEventArgs)
            navPanelView.Expander.MaxWidth = If(e.IsExpanded, Double.PositiveInfinity, navPanelView.Expander.ActualWidth)
        End Sub
    End Class
End Namespace
