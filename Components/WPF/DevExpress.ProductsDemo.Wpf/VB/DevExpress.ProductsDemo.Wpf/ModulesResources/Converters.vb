...
Namespace ProductsDemo.Modules
    ...
    Public Class ColumnPriorityConverter
        ...
        End Function
    End Class
    Public Class GenderImageConverter
        Implements IValueConverter

        Public Function Convert(ByVal value As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As System.Globalization.CultureInfo) As Object Implements IValueConverter.Convert
            If value Is Nothing OrElse Not(TypeOf value Is ContactGender) Then
                Return Nothing
            End If
            Dim gender As ContactGender = DirectCast(value, ContactGender)
        ...
        End Function
    End Class
    Public Class TitleImageConverter
        Implements IValueConverter

        Public Function Convert(ByVal value As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As System.Globalization.CultureInfo) As Object Implements IValueConverter.Convert
            If value Is Nothing OrElse Not(TypeOf value Is ContactTitle) Then
                Return Nothing
            End If
            Dim title As ContactTitle = DirectCast(value, ContactTitle)
            If title = ContactTitle.None Then
                Return Nothing
            End If
        ...
        End Function
    End Class
    Public Class TitleStringConverter
        Implements IValueConverter
        ...
        Public Function Convert(ByVal value As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As System.Globalization.CultureInfo) As Object Implements IValueConverter.Convert
            ...
            End If
            Dim title As ContactTitle = DirectCast(value, ContactTitle)
            Return If(title = ContactTitle.None, Nothing, title.ToString())
        End Function
        Public Function ConvertBack(ByVal value As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As System.Globalization.CultureInfo) As Object Implements IValueConverter.ConvertBack
            Throw New NotSupportedException()
        End Function
