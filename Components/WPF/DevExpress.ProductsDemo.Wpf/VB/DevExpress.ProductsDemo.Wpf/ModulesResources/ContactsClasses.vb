...
Namespace ProductsDemo.Modules
    Public Class Contact
        ...
        Private photo_Renamed As BitmapImage
        ...
        Public Function Clone() As Object Implements ICloneable.Clone
            Return New Contact() With {.Address = DirectCast(Me.Address.Clone(), Address), .BirthDate = Me.BirthDate, .Email = Me.Email, .Gender = Me.Gender, .Name = DirectCast(Me.Name.Clone(), Name), .Photo = Me.Photo, .Phone = Me.Phone, .Notes = Me.Notes, .Activity = Me.Activity}
        End Function
    End Class
