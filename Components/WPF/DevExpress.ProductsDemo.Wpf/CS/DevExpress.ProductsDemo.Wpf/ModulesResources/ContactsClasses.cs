...
namespace ProductsDemo.Modules {
    public class Contact : BindableBase, ICloneable {
        ...
        public object Clone() {
            return new Contact() { Address = (Address)this.Address.Clone(), BirthDate = this.BirthDate, Email = this.Email, Gender = this.Gender, Name = (Name)this.Name.Clone(), Photo = this.Photo, Phone = this.Phone, Notes = this.Notes, Activity = this.Activity };
        }
    }
