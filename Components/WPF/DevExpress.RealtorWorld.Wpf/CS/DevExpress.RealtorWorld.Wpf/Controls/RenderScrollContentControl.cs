...
namespace DevExpress.RealtorWorld.Xpf.Controls {
    ...
    public class RenderScrollContentControl : ContentControl {
        ...
        void UpdateScroll(Size finalSize) {
            UIElement child = Child;
            if(child == null) return;
            Size childSize = GetChildSize(child, finalSize);
            childSize = new Size(Math.Max(childSize.Width, finalSize.Width), Math.Max(childSize.Height, finalSize.Height));
            ...
            double maximum;
            double viewportSize;
            double x = CalculateArrange(childSize.Width, finalSize.Width, HorizontalValue, HorizontalScrollBarVisibility, out enableScrolling, out computedScrollBarVisibility, out maximum, out viewportSize);
            ...
            double y = CalculateArrange(childSize.Height, finalSize.Height, VerticalValue, VerticalScrollBarVisibility, out enableScrolling, out computedScrollBarVisibility, out maximum, out viewportSize);
        ...
        void RaiseComputedHorizontalScrollBarVisibilityChanged(DependencyPropertyChangedEventArgs e) { UpdateComputedBothScrollBarsVisiblity(); if(ComputedHorizontalScrollBarVisibilityChanged != null) ComputedHorizontalScrollBarVisibilityChanged(this, EventArgs.Empty); }
        void RaiseComputedVerticalScrollBarVisibilityChanged(DependencyPropertyChangedEventArgs e) { UpdateComputedBothScrollBarsVisiblity(); if(ComputedVerticalScrollBarVisibilityChanged != null) ComputedVerticalScrollBarVisibilityChanged(this, EventArgs.Empty); }
