...
namespace DevExpress.DevAV.Reports {
    public class TaskDetailReport : DevExpress.XtraReports.UI.XtraReport {
        ...
        private void InitializeComponent() {
            ...
            this.xrLabel1.Font = new System.Drawing.Font("Segoe UI", 14F);
            this.xrLabel1.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(77)))), ((int)(((byte)(130)))), ((int)(((byte)(184)))));
            this.xrLabel1.LocationFloat = new DevExpress.Utils.PointFloat(126.0144F, 65.17023F);
            this.xrLabel1.Name = "xrLabel1";
            this.xrLabel1.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabel1.SizeF = new System.Drawing.SizeF(47.91667F, 33.41675F);
        ...
        private void ModifyGauge(XRGauge gauge) {
            ...
            SetupImageIndicator(gaugeControl, imageIndicator);
        }
        ...
        void SetupArcScale(ArcScale arcScale) {
            arcScale.EndAngle = -40F;
            arcScale.MaxValue = 100F;
            arcScale.Name = "Gauge0_Scale1";
            arcScale.RadiusX = 98F;
            arcScale.RadiusY = 98F;
            arcScale.StartAngle = -275F;
            arcScale.Value = 50F;
        ...
        void SetupImageIndicator(DashboardGauge gaugeControl, ImageIndicator imageIndicator) {
            gaugeControl.BeginUpdate();

            imageIndicator.Name = "circularGauge1_ImageIndicator1";
            imageIndicator.AllowImageSkinning = true;
            imageIndicator.Image = Image.FromStream(Assembly.GetExecutingAssembly().GetManifestResourceStream("DevExpress.DevAV.Reports.Images.droplet.png"));
            imageIndicator.Position = new DevExpress.XtraGauges.Core.Base.PointF2D(125F, 125F);
            imageIndicator.ZOrder = -1001;

            gaugeControl.Model.Composite.Add(imageIndicator);
            gaugeControl.Elements.Add(imageIndicator);
