    ...
    public class DemoModulesControl : Control {
        ...
        public void SelectDemoModule(DemoModule demoModule) {
            if(demoModule == null) {
                ...
                var prevGroup = navBar.ActiveGroup;
                var prevItem = prevGroup == null ? null : prevGroup.SelectedItem;
                OnNavBarItemSelecting(navBar, new NavBarItemSelectingEventArgs(prevGroup, prevItem, null, null));
                navBar.SelectedItem = null;                
            } else {
                navBar.SelectedItem = ((ClassicShowType)demoModule.ShowMethodType).Category;
        ...
        public void SelectDemoModuleCategory(DemoModuleCategory category) {
            ...
            if(!demoModules.TryGetValue(category, out categoryDemoModules)) return;
            navBar.SelectedItem = category;
        ...
        DemoModuleCategory CurrentCategory { get { return navBar.SelectedItem == null ? null : (DemoModuleCategory)navBar.SelectedItem; } }
