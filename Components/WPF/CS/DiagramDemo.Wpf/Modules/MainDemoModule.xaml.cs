...
namespace DiagramDemo {
    public partial class MainDemoModule : DiagramDemoModule {
        ...
        void ShowDiagramDesignerControl(object sender, RoutedEventArgs e) {
            var diagramControl = new DiagramDesignerControl() { UseLayoutRounding = true };
            diagramControl.SelectedStencils = new StencilCollection { BasicShapes.StencilId, ArrowShapes.StencilId, DecorativeShapes.StencilId };
