...
namespace ChartsDemo {
    ...
    public partial class AnimationControl : ChartsDemoModule {
        ...
        static List<DataPoint> CreatePolarRangeDataSource() {
            List<DataPoint> dataSource = new List<DataPoint>();
            Random random = new Random();
            int pointsCount = 6;
            for (int i = 0; i < pointsCount; i++)
                dataSource.Add(DataPoint.CreatePolarRangeDataPoint(Math.Floor(i / (double)pointsCount * 360), Math.Floor(random.NextDouble() * 10 + 30), Math.Floor(random.NextDouble() * 10 + 10)));
            return dataSource;
        }
        ...
        static DataTable CreateFinancialDataSource() {
        ...
        List<DataPoint> polarRangeDataSource;
        ...
        Type DefaultPointAnimationType {
            get {
                if (FirstSeries != null) {
                    ...
                    if (FirstSeries is CircularSeriesBase2D)
        ...
        Type DefaultSeriesAnimationType {
            get {
                if (FirstSeries != null) {
                    ...
                    if (FirstSeries is CircularRangeAreaSeries2D)
                        return typeof(CircularAreaZoomInAnimation);
                }
                return null;
            }
        ...
        void InitializeSeriesComboBox() {
            ...
            cbSeriesTypes.Items.Add(new SeriesTypeItem(typeof(XYDiagram2D), typeof(AreaStepStackedSeries2D), "2D Stacked Step Areas", 3));
            cbSeriesTypes.Items.Add(new SeriesTypeItem(typeof(XYDiagram2D), typeof(AreaStepFullStackedSeries2D), "2D Full-Stacked Step Areas", 3));
            ...
            cbSeriesTypes.Items.Add(new SeriesTypeItem(typeof(RadarDiagram2D), typeof(RadarRangeAreaSeries2D), "2D Radar Range Area", 1));
            ...
            cbSeriesTypes.Items.Add(new SeriesTypeItem(typeof(PolarDiagram2D), typeof(PolarRangeAreaSeries2D), "2D Polar Range Area", 1));
        ...
        void InitializePolarSeries(CircularSeries2D circularSeries) {
        ...
        void InitializePolarRangeSeries(CircularRangeAreaSeries2D circularRangeSeries) {
        ...
        void UpdateSeries(Series series, int index) {
            ...
            if (series is CircularRangeAreaSeries2D) {
                InitializePolarRangeSeries(series as CircularRangeAreaSeries2D);
                return;
            }
    ...
    public class DataPoint {
        ...
        public static DataPoint CreatePolarRangeDataPoint(double argument, double value1, double value2) {
        ...
        DataPoint(double argument, double value1, double value2) {
            this.NumericalArgument = argument;
            this.Value1 = value1;
            this.Value2 = value2;
        }
