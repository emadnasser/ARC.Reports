...
namespace ChartsDemo {
    ...
    public partial class SelectionControl : ChartsDemoModule {
        ...
        public override ChartControlBase ActualChart {
            get { return pieChart; }
        }
    ...
    class CountriesInfoDataReader {
        const string UriToXmlFile = "/Data/Top10LargestCountriesInfo.xml";
        ...
        public static List<CountryStatisticInfo> Load() {
            ...
            try {
                XDocument Top10LargestCountriesInfo_xml = DataLoader.LoadXmlFromResources(UriToXmlFile);
                foreach (XElement countryInfo in Top10LargestCountriesInfo_xml.Root.Elements("CountryInfo")) {
    ...
    public class DashboardViewModel : INotifyPropertyChanged {
        ...
        public void SetMapItems(IList<MapItem> layerMapItemCollection) {
            foreach (MapItem item in layerMapItemCollection) {
                string shapeName = item.Attributes["NAME"] != null ? (string)item.Attributes["NAME"].Value : string.Empty;
