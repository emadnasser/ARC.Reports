...
namespace ChartsDemo {
    public static class Chart3DUtils {
        public static ObservableCollection<Function3DItemData> CreateFunctionItemsData() {
            ObservableCollection<Function3DItemData> data = new ObservableCollection<Function3DItemData>();
            data.Add(new Function3DItemData() { Type = FunctionsType.First, Image = CreateFunctionImage(1) });
            data.Add(new Function3DItemData() { Type = FunctionsType.Second, Image = CreateFunctionImage(2) });
            data.Add(new Function3DItemData() { Type = FunctionsType.Third, Image = CreateFunctionImage(3) });
            data.Add(new Function3DItemData() { Type = FunctionsType.Four, Image = CreateFunctionImage(4) });
            data.Add(new Function3DItemData() { Type = FunctionsType.Five, Image = CreateFunctionImage(5) });
            return data;
        }
        static BitmapImage CreateFunctionImage(int index) {
        ...
        public static ObservableCollection<StarData> ReadStarsData() {
            string fileName = "starsdata.csv";
            ObservableCollection<StarData> dataSource = new ObservableCollection<StarData>();
            try {
    ...
    public class DataPointHelper {
        public static ObservableCollection<Point3D> GenerateRandomData(int pointsCount, int maxValue = 200) {
            Random rand = new Random();
            ObservableCollection<Point3D> data = new ObservableCollection<Point3D>();
