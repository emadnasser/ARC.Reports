...
namespace ChartsDemo {
    ...
    public class DemoValuesProvider {
        ...
        public IEnumerable<Marker3DPointModel> PredefinedBubble3DModels {
            get {
    ...
    public class FunctionsPointGenerator {
        public static List<RangeDataPoint> GeneratePoints(CircularFunction f) {
            switch (f) {
        ...
        static List<RangeDataPoint> GeneratePointsOfLemniskate() {
        ...
        static List<RangeDataPoint> GeneratePointsOfCardioid() {
            List<RangeDataPoint> list = new List<RangeDataPoint>();
            const double a = 0.5;
        ...
        static List<RangeDataPoint> GeneratePointsOfTaubinsHeart() {
            List<RangeDataPoint> list = new List<RangeDataPoint>();
            for (double x = 0; x < 360; x += 15) {
                double xRadian = DegreeToRadian(x);
