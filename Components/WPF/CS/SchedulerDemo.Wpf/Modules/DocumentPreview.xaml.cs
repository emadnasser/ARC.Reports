...
namespace SchedulerDemo {
    public partial class DocumentPreview : SchedulerDemoModule {
        ...
        public static readonly DependencyProperty IntervalStartProperty = DependencyProperty.Register("IntervalStart", typeof(DateTime), typeof(DocumentPreview), new PropertyMetadata(new DateTime(2016, 07, 13), new PropertyChangedCallback(OnIntervalStartChanged)));
        ...
        public static readonly DependencyProperty IntervalEndProperty = DependencyProperty.Register("IntervalEnd", typeof(DateTime), typeof(DocumentPreview), new PropertyMetadata(new DateTime(2016, 07, 20), new PropertyChangedCallback(OnIntervalEndChanged)));
        ...
        #endregion
        #region Report
        public XtraSchedulerReport Report {
            get { return (XtraSchedulerReport)GetValue(ReportProperty); }
            set { SetValue(ReportProperty, value); }
        }
        public static readonly DependencyProperty ReportProperty = DevExpress.Xpf.Core.Native.DependencyPropertyHelper.RegisterProperty<DocumentPreview, XtraSchedulerReport>("Report", null);
        #endregion
