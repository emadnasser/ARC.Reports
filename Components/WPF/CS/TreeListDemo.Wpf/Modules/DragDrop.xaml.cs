...
namespace TreeListDemo {
    public partial class DragDrop : TreeListDemoModule {
        ...
        void UpdateNode(TreeListNode targetNode, DragDropManagerBase sourceManager, object obj) {
            (sourceManager.GetObject(obj) as Employee).GroupName = (targetNode.Content as Employee).GroupName;
            TreeListNode node = obj as TreeListNode;
            if(node == null || !node.HasChildren)
                return;
            foreach (object subObject in node.Nodes)
