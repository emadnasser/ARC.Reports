...
namespace DevExpress.Spreadsheet.Demos
{
    internal class HomeAccountingDocumentGenerator {
        ...
        void InitializeSummary() {
            ...
            cells["C6"].FormulaInvariant = "=TotalIncomeForJanuary" +
            ...
            cells["E6"].FormulaInvariant = "=TotalExpenseForJanuary" +
        ...
        public void AddTransaction(bool income, DateTime date, float sum, string category) {
            ...
            if (income) {
                if (i == 7) cells["B7"].FormulaInvariant = "=1";
                else cells["B" + i].FormulaInvariant = "=B" + (i - 1) + "+1";
                ...
                if (i == 7) cells["G7"].FormulaInvariant = "=1";
                else cells["G" + i].FormulaInvariant = "=G" + (i - 1) + "+1";
        ...
        void UpdateCategorys() {
            ...
            for (int i = 0; i < incomeCategorysArray.Length; i++) {
                ...
                cells["C" + index].FormulaInvariant = "=SUMIF(IncomeCategorysInJanuary,\"" + incomeCategorysArray[i] + "\",IncomeByCategoryInJanuary)+" +
            ...
            for (int i = 0; i < expenseCategorysArray.Length; i++) {
                ...
                cells["E" + index].FormulaInvariant = "=SUMIF(ExpenseCategorysInJanuary,\"" + expenseCategorysArray[i] + "\",ExpenseByCategoryInJanuary)+" +
