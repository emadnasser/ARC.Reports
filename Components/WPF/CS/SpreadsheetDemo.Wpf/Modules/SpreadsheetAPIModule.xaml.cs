...
namespace SpreadsheetDemo {
    public partial class SpreadsheetAPIModule : SpreadsheetDemoModule {
        ...
        public SpreadsheetAPIModule() {
            InitializeComponent();
            string examplePath = DemoUtils.GetRelativeDirectoryPath("CodeExamples");
            Dictionary<string, FileInfo> examplesCS = SuppressExamples(CodeExampleDemoUtils.GatherExamplesFromProject(examplePath, ExampleLanguage.Csharp));
            Dictionary<string, FileInfo> examplesVB = SuppressExamples(CodeExampleDemoUtils.GatherExamplesFromProject(examplePath, ExampleLanguage.VB));
        ...
        Dictionary<string, FileInfo> SuppressExamples(Dictionary<string, FileInfo> examples) {
        ...
        void evaluator_OnBeforeCompile(object sender, EventArgs args) {
            ...
            bool loaded = workbook.LoadDocument(DemoUtils.GetRelativePath("Document.xlsx"));
    ...
    public class SpreadsheetExampleEvaluatorByTimer : ExampleEvaluatorByTimer {
        public SpreadsheetExampleEvaluatorByTimer(bool runTimer)
            : base(runTimer) {
        }
