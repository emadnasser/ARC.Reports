...
namespace RichEditDemo {
    public partial class HyperlinkClickHandling : RichEditDemoModule {
        ...
        public HyperlinkClickHandling() {
            InitializeComponent();
            this.richEdit.Options.Hyperlinks.ModifierKeys = System.Windows.Forms.Keys.None;
        ...
        Point GetWindowLocation() {
            ...
            System.Drawing.Rectangle richViewBounds = GetRichEditViewBounds();
        ...
        System.Drawing.Rectangle GetRichEditViewBounds() {
            DocumentLayoutUnitConverter documentLayoutUnitConverter = new DocumentLayoutUnitDocumentConverter(this.richEdit.DpiX, this.richEdit.DpiY);
