...
namespace MapDemo {
    public class CityInformationControl : VisibleControl {
        ...
        static void CityInfoPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            if(control != null && !object.Equals(e.NewValue, e.OldValue))
        ...
        public CityInformationControl() {
            ...
            Unloaded += CityInformationControl_Unloaded;
        }

        void CityInformationControl_Unloaded(object sender, RoutedEventArgs e) {
        ...
        void ImageChangeTimer_Tick(object sender, EventArgs e) {
            if(CityInfo != null && CityInfo.Places.Count > 0) {
                currentPlaceIndex++;
