    ...
    public class NavBarDemoModule : DemoModule {
        ...
        void OnThemeChanged(DependencyObject sender, ThemeChangedRoutedEventArgs e) {
            ...
            if(navBarControl != null) {
                ...
                navBarControl.SetResourceReference(ForegroundProperty, new DevExpress.Xpf.NavBar.Themes.CommonElementsThemeKeyExtension() { ResourceKey = DevExpress.Xpf.NavBar.Themes.CommonElementsThemeKeys.ItemForegroundBrush, ThemeName = ApplicationThemeHelper.ApplicationThemeName });
            }
        ...
        private static bool IsDarkTheme() {
            return ApplicationThemeHelper.ApplicationThemeName == "Office2010Black" || ApplicationThemeHelper.ApplicationThemeName == "MetropolisDark" || ApplicationThemeHelper.ApplicationThemeName == "VS2010";
        }
        private static bool IsDarkBackgroundTheme() {
            return ApplicationThemeHelper.ApplicationThemeName == "MetropolisDark" || ApplicationThemeHelper.ApplicationThemeName == "Office2010Black";
        }
