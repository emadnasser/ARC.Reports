...
namespace DevExpress.DevAV {
    public partial class App : Application {
        ...
        public static void Start(Action baseStart, Application application) {
            ...
            DevExpress.Internal.Reallife.DataDirectoryHelper.LocalPrefix = "WpfOutlookInspiredApp";
            ...
            bool exit;
            singleInstanceApplicationGuard = DevExpress.Internal.Reallife.DataDirectoryHelper.SingleInstanceApplicationGuard("DevExpressWpfOutlookInspiredApp", out exit);
            if(exit) {
