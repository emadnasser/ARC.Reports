...
Namespace DevExpress.DevAV.ViewModels
    Partial Public Class EmployeeTaskCollectionViewModel
        ...
        Public Overrides Sub Delete(ByVal projectionEntity As EmployeeTask)
            If MessageBoxService.ShowMessage(String.Format(ScaffoldingLocalizer.GetString(ScaffoldingStringId.Confirmation_Delete), EntityDisplayName), ScaffoldingLocalizer.GetString(ScaffoldingStringId.Confirmation_Caption), MessageButton.YesNo) <> MessageResult.Yes Then
                Return
            End If
            Try
                Do
