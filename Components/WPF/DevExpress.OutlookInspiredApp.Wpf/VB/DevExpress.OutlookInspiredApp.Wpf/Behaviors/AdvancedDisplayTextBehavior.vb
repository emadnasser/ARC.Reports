...
Namespace DevExpress.DevAV
    Public Class AdvancedDisplayTextBehavior
        ...
        Public Property Filters() As ObservableCollection(Of FilterItem)
            ...
            End Set
        End Property
        Public Shared ReadOnly DisplayPropertyProperty As DependencyProperty = DependencyProperty.Register("DisplayProperty", GetType(String), GetType(AdvancedDisplayTextBehavior), New PropertyMetadata("Overdue Tasks"))
        Public Property DisplayProperty() As String
            Get
                Return CStr(GetValue(DisplayPropertyProperty))
            End Get
        ...
        Private Sub OnFiltersChanged(ByVal e As DependencyPropertyChangedEventArgs)
            ...
            Dim item As FilterItem = Filters.FirstOrDefault(Function(x) x.Name = DisplayProperty)
