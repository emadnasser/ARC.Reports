...
Namespace DevExpress.DevAV.ViewModels
    Public Class FilterTreeViewModel(Of TEntity As Class, TPrimaryKey)
        ...
        Private Function GetWhereExpression(ByVal criteria As CriteriaOperator) As Expression(Of Func(Of TEntity, Boolean))
            Dim caseInsensitiveCriteria = Data.Helpers.StringsTolowerCloningHelper.Process(criteria)
            Return If(Me.IsInDesignMode(), CriteriaOperatorToExpressionConverter.GetLinqToObjectsWhere(Of TEntity)(caseInsensitiveCriteria), CriteriaOperatorToExpressionConverter.GetGenericWhere(Of TEntity)(caseInsensitiveCriteria))
        End Function
