    ...
    Public Class BackstageDocumentPreviewReportService
        ...
        Private Sub OnBackstageDocumentPreviewChanged(ByVal e As DependencyPropertyChangedEventArgs)
            If e.OldValue IsNot Nothing Then
                RemoveHandler DirectCast(e.OldValue, CustomBackstageDocumentPreview).Loaded, AddressOf BackstageDocumentPreview_Loaded
            End If
            If e.NewValue IsNot Nothing Then
                AddHandler DirectCast(e.NewValue, CustomBackstageDocumentPreview).Loaded, AddressOf BackstageDocumentPreview_Loaded
            End If
        End Sub
        Private Sub BackstageDocumentPreview_Loaded(ByVal sender As Object, ByVal e As RoutedEventArgs)
            Dim document = DirectCast(sender, CustomBackstageDocumentPreview)
