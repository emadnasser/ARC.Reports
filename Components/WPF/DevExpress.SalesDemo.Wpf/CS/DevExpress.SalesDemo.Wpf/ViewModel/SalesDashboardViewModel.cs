...
namespace DevExpress.SalesDemo.Wpf.ViewModel {
    public class SalesDashboardViewModel : PageViewModel {
        ...
        protected override void Initialize() {
            ...
            DailySalesPerformanceViewModel = PerformanceAreaChartViewModel.Create(ModuleType.Dashboard, PerformanceViewMode.Daily);
            MonthlySalesPerformanceViewModel = PerformanceAreaChartViewModel.Create(ModuleType.Dashboard, PerformanceViewMode.Monthly);
        }
    }
}
