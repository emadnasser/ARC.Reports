...
namespace DevExpress.SalesDemo.Wpf.ViewModel {
    public class PerformanceAreaChartViewModel : DataViewModel {
        public static PerformanceAreaChartViewModel Create(ModuleType moduleType, PerformanceViewMode mode) {
        ...
        protected PerformanceAreaChartViewModel()
            : this(ModuleType.Dashboard, PerformanceViewMode.Daily) {
        }
        protected PerformanceAreaChartViewModel(ModuleType moduleType, PerformanceViewMode mode) {
        ...
        protected virtual void ValidateMode(ModuleType moduleType, PerformanceViewMode mode) {
            if(moduleType != ViewModel.ModuleType.Dashboard)
