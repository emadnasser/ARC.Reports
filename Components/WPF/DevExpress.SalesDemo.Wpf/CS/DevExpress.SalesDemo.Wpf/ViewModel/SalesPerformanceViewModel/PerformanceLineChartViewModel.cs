...
namespace DevExpress.SalesDemo.Wpf.ViewModel {
    public class PerformanceLineChartViewModel : DataViewModel {
        public static PerformanceLineChartViewModel Create(ModuleType moduleType) {
        ...
        protected PerformanceLineChartViewModel()
            : this(ModuleType.Channels) {
        }
        protected PerformanceLineChartViewModel(ModuleType moduleType) {
            ModuleType = moduleType;
            SelectedDate = DateTime.Now;
        }
        protected virtual void RequestData() {
            if(ModuleType == ModuleType.Channels) {
