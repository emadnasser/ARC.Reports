...
Namespace DevExpress.SalesDemo.Wpf.ViewModel
    Public Class PerformanceLineChartViewModel
        ...
        Public Shared Function Create(ByVal moduleType As ModuleType) As PerformanceLineChartViewModel
        ...
        Protected Overridable Overloads Sub RequestData()
            If ModuleType = ModuleType.Channels Then
