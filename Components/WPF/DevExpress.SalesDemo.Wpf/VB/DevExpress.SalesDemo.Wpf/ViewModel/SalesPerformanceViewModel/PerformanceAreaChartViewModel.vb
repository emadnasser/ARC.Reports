...
Namespace DevExpress.SalesDemo.Wpf.ViewModel
    Public Class PerformanceAreaChartViewModel
        ...
        Public Shared Function Create(ByVal moduleType As ModuleType, ByVal mode As PerformanceViewMode) As PerformanceAreaChartViewModel
        ...
        End Property
        Protected Sub New()
            Me.New(ModuleType.Dashboard, PerformanceViewMode.Daily)
        End Sub
        Protected Sub New(ByVal moduleType As ModuleType, ByVal mode As PerformanceViewMode)
            ...
            UpdateVolumeLables()
        End Sub
        Protected Overridable Sub ValidateMode(ByVal moduleType As ModuleType, ByVal mode As PerformanceViewMode)
            If moduleType <> ViewModel.ModuleType.Dashboard Then
        ...
        Private privateMode As PerformanceViewMode
