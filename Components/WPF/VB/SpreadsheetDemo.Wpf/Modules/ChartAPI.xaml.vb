...
Namespace SpreadsheetDemo
    Partial Public Class ChartAPI
        ...
        Public Sub New()
            InitializeComponent()
            Dim examplePath As String = DemoUtils.GetRelativeDirectoryPath("CodeExamples\Charts")
        ...
        Private Sub RearrangeExamples(ByVal examples As List(Of CodeExampleGroup))
            ...
            Loop
        End Sub
        Private Sub SuppressExamples(ByVal examples As List(Of CodeExampleGroup))
            For i As Integer = 0 To examples.Count - 1
                Dim group As CodeExampleGroup = examples(i)
                If group.Name = "View Options Actions" Then
                    Dim j As Integer = 0
                    Do While j < group.Examples.Count
                        Dim example As CodeExample = group.Examples(j)
                        If example.RegionName = "Smooth Lines" Then
