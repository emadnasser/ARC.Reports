...
Namespace DevExpress.DXperience.Demos
    ...
    Public MustInherit Class ExampleFinder
        ...
        Public Function Process(ByVal fileWithExample As FileInfo) As List(Of CodeExample)
            ...
            Dim code As String
            Using stream As FileStream = File.Open(fileWithExample.FullName, FileMode.Open, FileAccess.Read, FileShare.Read)
    ...
    Public MustInherit Class ExampleEvaluatorByTimer
        ...
        Public Sub New(ByVal enableTimer As Boolean)
            ...
            If enableTimer Then
                ...
                AddHandler compileExampleTimer.Tick, AddressOf leakSafeCompileEventRouter.OnCompileExampleTimerTick
        ...
        Public Sub Dispose() Implements IDisposable.Dispose
            If compileExampleTimer IsNot Nothing Then
                ...
                If leakSafeCompileEventRouter IsNot Nothing Then
                    RemoveHandler compileExampleTimer.Tick, AddressOf leakSafeCompileEventRouter.OnCompileExampleTimerTick
                End If
