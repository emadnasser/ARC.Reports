    ...
    Friend Class HomeAccountingDocumentGenerator
        ...
        Private Sub GenerateWorksheets()
            ...
            For i As Integer = 0 To 11
                ...
                cells("E5").FormulaInvariant = "=SUM(E7:E100)"
                ...
                cells("J5").FormulaInvariant = "=SUM(J7:J100)"
                ...
                End Try
                If i = 0 Then
                    cells("K2").FormulaInvariant = "=BalanceAtTheBeginningOfTheYear"
                Else
                    cells("K2").FormulaInvariant = "=" & workbook.Worksheets(i - 1).Name & "!BalanceAtTheEndOfTheMonth"
                End If
                cells("K3").FormulaInvariant = "=BalanceAtTheBeginningOfTheMonth+TotalIncomeFor" & worksheet.Name & "-TotalExpenseFor" & worksheet.Name
            Next i
        End Sub
        Private Sub InitializeSummary()
            ...
            cells("C6").FormulaInvariant = "=TotalIncomeForJanuary" & "+TotalIncomeForFebruary" & "+TotalIncomeForMarch" & "+TotalIncomeForApril" & "+TotalIncomeForMay" & "+TotalIncomeForJune" & "+TotalIncomeForJuly" & "+TotalIncomeForAugust" & "+TotalIncomeForSeptember" & "+TotalIncomeForOctober" & "+TotalIncomeForNovember" & "+TotalIncomeForDecember"

            cells("E6").FormulaInvariant = "=TotalExpenseForJanuary" & "+TotalExpenseForFebruary" & "+TotalExpenseForMarch" & "+TotalExpenseForApril" & "+TotalExpenseForMay" & "+TotalExpenseForJune" & "+TotalExpenseForJuly" & "+TotalExpenseForAugust" & "+TotalExpenseForSeptember" & "+TotalExpenseForOctober" & "+TotalExpenseForNovember" & "+TotalExpenseForDecember"
        ...
        End Sub
        Public Sub AddTransaction(ByVal income As Boolean, ByVal [date] As Date, ByVal sum As Single, ByVal category As String)
            If income Then
            ...
            If income Then
                If i = 7 Then
                    cells("B7").FormulaInvariant = "=1"
                Else
                    cells("B" & i).FormulaInvariant = "=B" & (i - 1) & "+1"
                End If
            ...
            Else
                If i = 7 Then
                    cells("G7").FormulaInvariant = "=1"
                Else
                    cells("G" & i).FormulaInvariant = "=G" & (i - 1) & "+1"
                End If
        ...
        Private Sub AddPayments()
            ...
            AddTransaction(True, New Date(2013, 1, 15), 13000, "Salary")
            AddTransaction(True, New Date(2013, 2, 15), 13000, "Salary")
            AddTransaction(True, New Date(2013, 3, 15), 13000, "Salary")
            AddTransaction(True, New Date(2013, 4, 15), 13000, "Salary")
            AddTransaction(True, New Date(2013, 5, 15), 13000, "Salary")
            AddTransaction(True, New Date(2013, 1, 30), 21300, "Salary")
            AddTransaction(True, New Date(2013, 2, 28), 21300, "Salary")
            AddTransaction(True, New Date(2013, 3, 30), 21300, "Salary")
            AddTransaction(True, New Date(2013, 4, 30), 21300, "Salary")
            AddTransaction(True, New Date(2013, 5, 30), 21300, "Salary")
            AddTransaction(True, New Date(2013, 1, 8), 80, "Scholarship")
            AddTransaction(True, New Date(2013, 2, 8), 80, "Scholarship")
            AddTransaction(True, New Date(2013, 3, 8), 80, "Scholarship")
            AddTransaction(True, New Date(2013, 4, 8), 80, "Scholarship")
            AddTransaction(True, New Date(2013, 5, 8), 80, "Scholarship")

            Dim months() As Byte = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 }
            For month As Integer = 0 To 4
                For day As Integer = 1 To months(month)
                    AddTransaction(False, New Date(2013, month + 1, day), 126, "Transportation")
                Next day
            Next month

            For month As Integer = 0 To 4
                AddTransaction(False, New Date(2013, month + 1, 2), 2400, "Credit")
            Next month

            For month As Integer = 0 To 4
                AddTransaction(False, New Date(2013, month + 1, 12), 11000, "Apartment")
            Next month
        End Sub
