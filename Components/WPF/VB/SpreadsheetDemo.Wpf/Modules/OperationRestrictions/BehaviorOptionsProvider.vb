...
Namespace DevExpress.Spreadsheet.Demos
    Public Class BehaviorOptionsProvider
        ...
        Public Sub New(ByVal options As SpreadsheetBehaviorOptions)
            ...
            Me.worksheetOptionsProvider = New SpreadsheetBehaviorWorksheetOptionsProvider(options.Worksheet)
            Me.columnOptionsProvider = New SpreadsheetBehaviorColumnOptionsProvider(options.Column)
            Me.rowOptionsProvider = New SpreadsheetBehaviorRowOptionsProvider(options.Row)
            Me.commentOptionsProvider = New SpreadsheetBehaviorCommentOptionsProvider(options.Comment)
            Me.groupOptionsProvider = New SpreadsheetBehaviorGroupOptionsProvider(options.Group)
            Me.selectionOptionsProvider = New SpreadsheetBehaviorSelectionOptionsProvider(options.Selection)
            Me.drawingOptionsProvider = New SpreadsheetBehaviorDrawingOptionsProvider(options.Drawing)
    ...
    Public Class SpreadsheetBehaviorClipboardOptionsProvider
        ...
        <DefaultValue(DevExpress.XtraSpreadsheet.DocumentCapability.Default)>
        Public Property Cut() As DocumentCapability
            Get
                Return options.Cut
            End Get
            Set(ByVal value As DevExpress.XtraSpreadsheet.DocumentCapability)
                options.Cut = value
            End Set
        End Property
        <DefaultValue(DevExpress.XtraSpreadsheet.DocumentCapability.Default)>
    ...
    Public Class SpreadsheetBehaviorSelectionOptionsProvider
        ...
        Public Property AllowMultiSelection() As Boolean
            ...
            End Set
        End Property
        <DefaultValue(DevExpress.XtraSpreadsheet.MoveActiveCellModeOnEnterPress.Down)>
        Public Property MoveActiveCellMode() As MoveActiveCellModeOnEnterPress
            Get
                Return options.MoveActiveCellMode
            End Get
            Set(ByVal value As DevExpress.XtraSpreadsheet.MoveActiveCellModeOnEnterPress)
                options.MoveActiveCellMode = value
            End Set
        End Property
        <DefaultValue(DevExpress.XtraSpreadsheet.ShowSelectionMode.Always)>
        Public Property ShowSelectionMode() As DevExpress.XtraSpreadsheet.ShowSelectionMode
            Get
                Return options.ShowSelectionMode
            End Get
            Set(ByVal value As DevExpress.XtraSpreadsheet.ShowSelectionMode)
    ...
    Public Class SpreadsheetBehaviorMiscellaneousOptionsProvider
        ...
        Public Property CellEditorCommitMode() As DevExpress.XtraSpreadsheet.CellEditorCommitMode
            Get
                Return options.CellEditorCommitMode
            End Get
            Set(ByVal value As DevExpress.XtraSpreadsheet.CellEditorCommitMode)
        ...
        Public Property FunctionNameCulture() As DevExpress.XtraSpreadsheet.FunctionNameCulture
            Get
                Return options.FunctionNameCulture
            End Get
            Set(ByVal value As DevExpress.XtraSpreadsheet.FunctionNameCulture)
