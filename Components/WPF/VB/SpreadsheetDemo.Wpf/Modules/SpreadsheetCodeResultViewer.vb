...
Namespace SpreadsheetDemo
    ...
    Public Class SpreadsheetCSExampleCodeEvaluator
    ...
    Public Class SpreadsheetVbExampleCodeEvaluator
        Inherits SpreadsheetExampleCodeEvaluator
