...
Namespace DemoUtils
    Public Class DemoRichControl
        ...
        Public Shared ReadOnly RowProperty As DependencyProperty = DependencyProperty.Register("Row", GetType(Integer), GetType(DemoRichControl), New PropertyMetadata(1))
        Public Shared ReadOnly ColumnProperty As DependencyProperty = DependencyProperty.Register("Column", GetType(Integer), GetType(DemoRichControl), New PropertyMetadata(1))
        ...
        Public Property Row() As Integer
            Get
                Return DirectCast(GetValue(RowProperty), Integer)
            End Get
        ...
        Public Property Column() As Integer
            Get
                Return DirectCast(GetValue(ColumnProperty), Integer)
            End Get
            Set(ByVal value As Integer)
        ...
        Public Property ClearSelectionCommand() As ICommand
        #End Region

        Public Sub New()
            ClearSelectionCommand = New DelegateCommand(AddressOf ClearSelectionCommandExecute, AddressOf CanClearSelectionCommandExecute)
        ...
        Protected Overrides Sub OnSelectionChanged(ByVal e As RoutedEventArgs)
            ...
            UpdateCaretPosInfo()
        End Sub
        Protected Sub UpdateCaretPosInfo()
            Dim actualLineCount As Integer = 0
            CaretPosition.GetLineStartPosition(Integer.MinValue, actualLineCount)
        ...
        Protected Function CanClearSelectionCommandExecute() As Boolean
            Return Not Selection.IsEmpty
        End Function
        Protected Sub ClearSelectionCommandExecute()
 ...
 End If
        ...
        Protected Overrides Sub OnLostKeyboardFocus(ByVal e As KeyboardFocusChangedEventArgs)
            Dim popupMenu As IPopupControl = BarManager.GetDXContextMenu(Me)
            If popupMenu IsNot Nothing AndAlso popupMenu.IsPopupOpen Then
                e.Handled = True
                Return
            End If
