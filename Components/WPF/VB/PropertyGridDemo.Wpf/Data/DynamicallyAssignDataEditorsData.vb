...
Namespace PropertyGridDemo
    ...
    Public Class DynamicallyAssignDataEditorsData
        Private Const SimpleEditorsGroup As String = "Simple editors"
        Private Const PopupEditorsGroup As String = "Popup editors"
        Private Const MiscEditorsGroup As String = "Misc editors"

        Public Sub New()
            Dim list = New MultiEditorsList()
    ...
    End Class
    Public NotInheritable Class DynamicallyAssignDataEditorsMetadata

        Private Sub New()
        End Sub

        Public Shared Sub BuildMetadata(ByVal builder As MetadataBuilder(Of DynamicallyAssignDataEditorsData))
