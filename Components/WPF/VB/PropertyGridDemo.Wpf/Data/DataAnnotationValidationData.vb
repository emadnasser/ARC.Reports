...
Namespace PropertyGridDemo
    ...
    End Class
    Public NotInheritable Class DataAnnotationValidationMetadata
        ...
        Public Shared Sub BuildMetadata(ByVal builder As MetadataBuilder(Of DataAnnotationValidationData))
