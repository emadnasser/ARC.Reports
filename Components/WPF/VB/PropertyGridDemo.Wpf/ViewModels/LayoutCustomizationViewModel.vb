...
Namespace PropertyGridDemo
    Public Class LayoutCustomizationViewModel
        ...
        Private Sub InitializeSkills()
            ...
            sManager.FromDate = New Date(1998, 05, 14)
            sManager.ToDate = New Date(2001, 03, 22)
            sManager.Skills.Add("Speaking")
            sManager.Skills.Add("Coordination")

            Dim sRepr = New CareerInfo()
            sRepr.JobTitle = "Sales Representative"
            sRepr.FromDate = New Date(2001, 04, 10)
            sRepr.ToDate = New Date(2007, 09, 11)
        ...
        Private privateRank As UInteger
        Public Overridable Property Rank() As UInteger
            Get
                Return privateRank
            End Get
            Protected Set(ByVal value As UInteger)
                privateRank = value
            End Set
        End Property
    ...
    Public Class CareerInfo
        ...
        Private privateSkills As ObservableCollection(Of String)
