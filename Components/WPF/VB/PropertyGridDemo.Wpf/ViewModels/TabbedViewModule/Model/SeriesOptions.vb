...
Namespace PropertyGridDemo
    ...
    Public Class SeriesOptions
        ...
        Private Sub InitializeOptions()
            ...
            DirectCast(Fill, SolidFillOptions).Do(Sub(x)
                x.Color = Colors.LightGray
                x.Opacity = 0.5R
            End Sub)
            BorderType = BorderOptionsType.Solid
            DirectCast(Border, SolidBorderOptions).Do(Sub(x)
                x.Color = DirectCast(ColorConverter.ConvertFromString("#FF093367"), Color)
                x.Opacity = 0.75
                x.Thickness = 7R
        ...
        <Category("SeriesOptions"), DisplayName("Series Options")>
