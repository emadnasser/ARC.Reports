...
Namespace MapDemo
    ...
    Public Class HotelsViewModel
        ...
        Public Overridable Property ZoomLevel() As Integer
        ...
        Private mapDefaultPosition As New GeoPoint(-21.16, -175.13)
        ...
        Private mapDefaultZoomLevel As Integer = 13
        ...
        Private Function LoadDataFromXML() As ObservableCollection(Of HotelInfo)
            Dim document As XDocument = DataLoader.LoadXmlFromResources("/Data/Hotels.xml")
            Dim infos As New ObservableCollection(Of HotelInfo)()
            If document IsNot Nothing Then
                For Each element As XElement In document.Element("Hotels").Elements()
                    Dim hotelInfo As New HotelInfo()
    ...
    Public Class HotelInfo
        ...
        Public Property Center() As CartesianPoint
