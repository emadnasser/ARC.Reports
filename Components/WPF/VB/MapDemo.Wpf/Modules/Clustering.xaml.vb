...
Namespace MapDemo
    ...
    Partial Public Class Clustering
        ...
        Public Sub New()
            InitializeComponent()
            DataContext = ViewModelSource.Create(Function() New ClusteringViewModel(TryCast(FindResource("clusterTemplate"), DataTemplate)))
        End Sub
    ...
    Public Class ClusteringViewModel
        ...
        Public Overridable Property IsLoadingDecoratorVisible() As Boolean
        ...
        Private Sub OnClustered(ByVal sender As Object, ByVal e As ClusteredEventArgs)
            Dispatcher.CurrentDispatcher.BeginInvoke(New Action(Sub() IsLoadingDecoratorVisible = False), DispatcherPriority.Render, Nothing)
        End Sub
        Private Sub Update()
