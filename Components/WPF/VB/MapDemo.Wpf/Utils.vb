...
Namespace MapDemo
        ...
        Private Function IValueConverter_Convert(ByVal value As Object, ByVal targetType As Type, ByVal parameter As Object, ByVal culture As CultureInfo) As Object Implements IValueConverter.Convert
            If TypeOf value Is ProviderName Then
                ...
                If providerName = MapDemo.ProviderName.Bing Then
                    Return "Copyright © 2017 Microsoft and its suppliers. All rights reserved."
                End If
    ...
    Public Class OpenWeatherMapService
        ...
        Public Class Coordinates
            <DataMember(Name := "lon")>
            Private lon1 As Double
            <DataMember(Name := "Lon")>
            Private lon2 As Double
            <DataMember(Name := "lat")>
            Private lat1 As Double
            <DataMember(Name := "Lat")>
            Private lat2 As Double
            Public ReadOnly Property Longitude() As Double
                Get
                    Return If(lon1 <> 0, lon1, lon2)
                End Get
            End Property
            Public ReadOnly Property Latitude() As Double
                Get
                    Return If(lat1 <> 0, lat1, lat2)
                End Get
            End Property
        End Class
        ...
        Private Sub forecastClient_OpenReadCompleted(ByVal sender As Object, ByVal e As OpenReadCompletedEventArgs)
            If e.Error Is Nothing Then
                ...
                Task.Factory.StartNew(Sub()
                    ...
                    cityWeatherInfo.SetForecast(forecast_Renamed.list)
                End Sub)
            End If
        End Sub
