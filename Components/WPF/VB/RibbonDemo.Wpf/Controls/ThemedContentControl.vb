...
Namespace RibbonDemo
    Public Class ThemedContentControl
        ...
        Private ReadOnly Property IsDarkTheme() As Boolean
            Get
                Return ApplicationThemeHelper.ApplicationThemeName = Theme.MetropolisDarkName OrElse ApplicationThemeHelper.ApplicationThemeName = Theme.TouchlineDarkName
            End Get
        End Property
        #End Region
        Public Sub New()
