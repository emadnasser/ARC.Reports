...
Namespace ChartsDemo
    <CodeFile("Modules/DataBinding/ColorizerControl(.SL).xaml"), CodeFile("Modules/DataBinding/ColorizerControl.xaml.(cs)")>
        ...
        Private Function GetHPIs() As List(Of HPIStatistics)
            ...
            If document IsNot Nothing Then
                For Each element As XElement In document.Element("G20HPIs").Elements()
                    ...
                    Dim population As Double = Integer.Parse(element.Element("Population").Value) \ 1000000.0
