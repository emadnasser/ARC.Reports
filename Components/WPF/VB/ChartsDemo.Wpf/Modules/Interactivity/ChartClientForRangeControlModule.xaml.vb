...
Namespace ChartsDemo
    <CodeFile("Modules/Interactivity/ChartClientForRangeControlModule(.SL).xaml"), CodeFile("Modules/Interactivity/ChartClientForRangeControlModule.xaml.(cs)")>
    Partial Public Class ChartClientForRangeControlModule
        Private Const dataCount As Integer = 100
        Private chartClientModel As ChartClientModel
        ...
        Public Sub New()
            ...
            Me.DataContext = chartClientModel
        End Sub
    ...
    Public Class ChartClientModel
        ...
        Private Shared Sub DateTimeGridAlignmentChanged(ByVal d As DependencyObject, ByVal e As DependencyPropertyChangedEventArgs)
