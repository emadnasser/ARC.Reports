...
Namespace ChartsDemo
    <CodeFile("Modules/ChartElements/SecondaryAxesControl(.SL).xaml"), CodeFile("Modules/ChartElements/SecondaryAxesControl.xaml.(cs)")>
    Partial Public Class SecondaryAxesControl
        ...
        Private ReadOnly Property FirstSeries() As XYSeries
            Get
                Return If(chart.Diagram.Series.Count > 0, CType(chart.Diagram.Series(0), XYSeries), Nothing)
            End Get
        End Property
        Private ReadOnly Property SecondSeries() As XYSeries
            Get
                Return If(chart.Diagram.Series.Count > 1, CType(chart.Diagram.Series(1), XYSeries), Nothing)
            End Get
        End Property
        ...
        End Sub
        Private Sub SecondaryAxesControl_ModuleAppear(ByVal sender As Object, ByVal e As RoutedEventArgs)
            chart.Animate()
            firstRun = False
        End Sub
        ...
        End Sub
        Private Sub CreateSeries(ByVal series1 As XYSeries, ByVal series2 As XYSeries)
        ...
        Private Sub lbSeries2AxisX_SelectedIndexChanged(ByVal sender As Object, ByVal e As RoutedEventArgs)
            If chart IsNot Nothing AndAlso SecondSeries IsNot Nothing Then
                If lbSeries2AxisX.SelectedIndex = 0 Then
                    XYDiagram2D.SetSeriesAxisX(SecondSeries, Nothing)
        ...
        Private Sub lbSeries2AxisY_SelectedIndexChanged(ByVal sender As Object, ByVal e As RoutedEventArgs)
            If chart IsNot Nothing AndAlso SecondSeries IsNot Nothing Then
                If lbSeries2AxisY.SelectedIndex = 0 Then
                    XYDiagram2D.SetSeriesAxisY(SecondSeries, Nothing)
