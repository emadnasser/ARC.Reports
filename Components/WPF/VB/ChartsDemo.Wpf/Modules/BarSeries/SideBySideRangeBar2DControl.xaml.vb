...
Namespace ChartsDemo
    <CodeFile("Modules/BarSeries/SideBySideRangeBar2DControl(.SL).xaml"), CodeFile("Modules/BarSeries/SideBySideRangeBar2DControl.xaml.(cs)")>
    Partial Public Class SideBySideRangeBar2DControl
        ...
        Public Sub New()
            ...
            For Each series As Series In chart.Diagram.Series
                series.ToolTipPointPattern = "Month: {A:MMMM}" & ControlChars.Lf & "Min Price: ${V1:0.00}" & ControlChars.Lf & "Max Price: ${V2:0.00}"
            Next series
        End Sub
