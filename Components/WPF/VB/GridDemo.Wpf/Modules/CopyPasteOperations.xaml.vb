...
Namespace GridDemo
    <CodeFile("ModuleResources/CopyPasteTemplates(.SL).xaml"), CodeFile("ModuleResources/CopyPasteClasses.(cs)")>
    Partial Public Class CopyPasteOperations
        ...
        Protected Overrides Sub RaiseIsPopupContentInvisibleChanged(ByVal e As DependencyPropertyChangedEventArgs)
            ...
            If IsPopupContentInvisible AndAlso secondGrid IsNot Nothing Then
