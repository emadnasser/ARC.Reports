...
Namespace GridDemo
    <CodeFile("Controls/MiltiSelectionOptionsControl.xaml.(cs)"), CodeFile("Controls/MiltiSelectionOptionsControl(.SL).xaml"), CodeFile("ModuleResources/MultiSelectionClasses.(cs)"), CodeFile("ModuleResources/MultiSelectionTemplates(.SL).xaml")>
