...
Namespace GridDemo
    <CodeFile("Descriptions/DataEditorTypesDescriptions(.SL).xaml"), CodeFile("ModuleResources/DataEditorTypesTemplates(.SL).xaml"), CodeFile("ModuleResources/DataEditorTypesClasses.(cs)")>
