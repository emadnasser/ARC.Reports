...
Namespace GridDemo.ModuleResources
    Public Class CardWinExplorerFileSource
        ...
        Public Sub New(ByVal fullPath As String, ByVal type As TypeElement, ByVal sizeType As CardWinExplorerDataSource.SizeIcon, ByVal size As Integer)
            Me.Type = type
        ...
        Private Sub SetIcon(ByVal type As TypeElement, ByVal fullPath As String, ByVal sizeType As CardWinExplorerDataSource.SizeIcon, ByVal sizeInt As Integer)
            Size = sizeInt
