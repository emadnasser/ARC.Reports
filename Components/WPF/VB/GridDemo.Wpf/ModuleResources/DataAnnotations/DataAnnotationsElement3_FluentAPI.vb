...
Namespace GridDemo
    ...
    Public NotInheritable Class DataAnnotationsElement3Metadata

        Private Sub New()
        End Sub

        Public Shared Sub BuildMetadata(ByVal builder As MetadataBuilder(Of DataAnnotationsElement3_FluentAPI))
