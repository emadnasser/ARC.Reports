...
Namespace GridDemo
    ...
    Public Class GridControlDefinition
        ...
        Public Shared ReadOnly DataSourceProperty As DependencyProperty = DependencyProperty.Register("DataSource", GetType(Object), GetType(GridControlDefinition), New PropertyMetadata(Nothing))
        ...
        Private columns_Renamed As List(Of GridColumnDefinition)
        ...
        End Property
        Public Sub New()
            columns_Renamed = New List(Of GridColumnDefinition)()
        End Sub
    End Class
