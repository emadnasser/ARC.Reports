...
Namespace GridDemo.Tests
  ...
  End Property
    ...
    Public Class CheckDemoOptionsFixture
        ...
        Private Sub UnboundExpressionEditorHandler(ByVal sender As Object, ByVal e As DevExpress.Xpf.Grid.UnboundExpressionEditorEventArgs)
        ...
        Private Sub AssertShowExpressionEditor(ByVal expectedExpression As String)
            AddHandler View.UnboundExpressionEditorCreated, AddressOf UnboundExpressionEditorHandler
            Try
            ...
            Finally
                RemoveHandler View.UnboundExpressionEditorCreated, AddressOf UnboundExpressionEditorHandler
            End Try
        End Sub
        #End Region
    #Region "hit test"
    ...
    #Region "Core"
        Private Sub CheckDefaultTheme()
            Assert.AreEqual(Theme.Default.Name, ApplicationThemeHelper.ApplicationThemeName)
        End Sub
    #End Region
    ...
    #Region "B144178"
        Private Sub Create_B144178_Actions()
            ...
            AddSimpleAction(Sub() AssertPrioritySorting("Priority(7)"))
            AddLoadModuleActions(GetType(CellEditors))
            AddSimpleAction(Sub() AssertPrioritySorting("Priority"))
