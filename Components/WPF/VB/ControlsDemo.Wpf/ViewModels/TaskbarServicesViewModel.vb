...
Namespace ControlsDemo
    Public Class TaskbarServicesViewModel
        ...
        Public Sub New()
            ...
            ButtonProperties = New ObservableCollection(Of Boolean) From {True, True, True, False, True}
            AddHandler ButtonProperties.CollectionChanged, AddressOf ButtonPropertyChanged
        End Sub
        ...
        Public Sub Dispose() Implements IDisposable.Dispose
            ...
            RemoveHandler ButtonProperties.CollectionChanged, AddressOf ButtonPropertyChanged
            ButtonProperties = Nothing
        ...
        End Sub
        Public Property OverlayIcons() As IEnumerable(Of NamedIcon)
        Private privateButtonProperties As ObservableCollection(Of Boolean)
        Public Overridable Property ButtonProperties() As ObservableCollection(Of Boolean)
            Get
                Return privateButtonProperties
            End Get
            Protected Set(ByVal value As ObservableCollection(Of Boolean))
                privateButtonProperties = value
            End Set
        End Property
        ...
        Private privateThumbnailClipMargin As Thickness
        Public Overridable Property ThumbnailClipMargin() As Thickness
            Get
                Return privateThumbnailClipMargin
            End Get
            Protected Set(ByVal value As Thickness)
                privateThumbnailClipMargin = value
            End Set
        End Property
        ...
        Private Sub SetButtonsProperties()
            For Each item As TaskbarThumbButtonInfo In TaskbarButtonService.ThumbButtonInfos
                ...
                item.Visibility = If(ButtonProperties(4), Visibility.Visible, Visibility.Collapsed)
            Next item
        End Sub
