    ...
    Public Class ZoomStackPanel
        ...
        Public Property ChildOffset() As Double
            ...
            Set(ByVal value As Double)
                ...
                If actualValue = _childOffset Then
                    Return
                End If
        ...
        Protected Overridable Function CoerceChildOffset(ByVal value As Double) As Double
            ...
            Do While res < MinChildOffset
                res += intervalLength
            Loop
            Do While res > MaxChildOffset
                res -= intervalLength
            Loop
            Return res
        End Function
        ...
        Protected Overrides Function ArrangeOverride(ByVal finalSize As Size) As Size
            ...
            For i As Integer = 0 To Children.Count - 1
                Dim child As UIElement = Children(i)
                Dim pos As New Point(x, 0)
                Dim size As New Size(child.DesiredSize.Width, finalSize.Height)
        ...
        End Function
    End Class
    Partial Public Class ZoomScroll
        ...
        Public Shared ReadOnly ValueProperty As DependencyProperty = DependencyProperty.Register("Value", GetType(Double), GetType(ZoomScroll), New PropertyMetadata(100R, New PropertyChangedCallback(AddressOf OnValuePropertyChanged), New CoerceValueCallback(AddressOf CoerceValueProperty)))
        ...
        Protected Shared Function CoerceValueProperty(ByVal d As DependencyObject, ByVal value As Object) As Object
            Dim obj As ZoomScroll = CType(d, ZoomScroll)
            Return obj.CoerceValue(DirectCast(value, Double))
        End Function
        #End Region ' Dependency Properties
        Public Property IncreaseDelta() As Double
            Get
                Return DirectCast(GetValue(IncreaseDeltaProperty), Double)
            End Get
            Set(ByVal value As Double)
        ...
        Public Property MouseWheelDelta() As Double
            Get
                Return DirectCast(GetValue(MouseWheelDeltaProperty), Double)
            End Get
            Set(ByVal value As Double)
        ...
        Public Property Value() As Double
            ...
            End Set
        End Property
        Private privateIsMouseLeftButtonPressed As Boolean
        Public Property IsMouseLeftButtonPressed() As Boolean
            Get
                Return privateIsMouseLeftButtonPressed
            End Get
            Protected Set(ByVal value As Boolean)
                privateIsMouseLeftButtonPressed = value
            End Set
        End Property
        ...
        Protected Overrides Sub OnMouseLeftButtonDown(ByVal e As MouseButtonEventArgs)
            ...
            Me.PrevMousePos = e.GetPosition(Me)
        End Sub
        ...
        Protected Overrides Sub OnMouseMove(ByVal e As MouseEventArgs)
            If Not IsMouseLeftButtonPressed Then
                Return
            End If
            Dim changeX As Double = e.GetPosition(Me).X - Me.PrevMousePos.X
            Me.PrevMousePos = e.GetPosition(Me)
