...
Namespace ControlsDemo
    Public Class VisualPropertyBehavior
        ...
        Public Property Visual() As Visual
            ...
            End Set
        End Property
        Public Shared ReadOnly VisualProperty As DependencyProperty = DependencyProperty.Register("Visual", GetType(Visual), GetType(VisualPropertyBehavior), New PropertyMetadata(Nothing))
