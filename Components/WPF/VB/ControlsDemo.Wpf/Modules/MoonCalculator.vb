...
Namespace ControlsDemo
    Public NotInheritable Class MoonCalculator
        ...
        End Function
        Private Shared Sub CalculateMoon(ByVal t As Double, ByRef l As Double, ByRef b As Double)
        ...
        End Sub
        Public Shared Function GetPhase(ByVal currentDate As Date) As Double
            Dim t As Double = (currentDate.Subtract(New Date(2000, 1, 1))).Duration().TotalDays / 36525
            Dim ls As Double = CalculateSun(t)
            Dim l As Double = Nothing, b As Double = Nothing
            CalculateMoon(t, l, b)
