...
Namespace ControlsDemo
    Public NotInheritable Class SunCalculatior
        ...
        Public Shared Function SunRise(ByVal [date] As Date, ByVal utcOffset As Double, ByVal lat As Double, ByVal lon As Double) As Date?
            Return Calculate([date], utcOffset, lat, lon, True)
        End Function
        Public Shared Function SunSet(ByVal [date] As Date, ByVal utcOffset As Double, ByVal lat As Double, ByVal lon As Double) As Date?
            Return Calculate([date], utcOffset, lat, lon, False)
        End Function
        Private Shared Function Calculate(ByVal [date] As Date, ByVal utcOffset As Double, ByVal lat As Double, ByVal lon As Double, ByVal rise As Boolean) As Date?
