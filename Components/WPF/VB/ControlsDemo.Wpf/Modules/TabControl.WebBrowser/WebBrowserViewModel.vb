...
Namespace ControlsDemo.TabControl.WebBrowser
    Public Class WebBrowserMainViewModel
        Private privateTabs As ObservableCollection(Of TabViewModel)
        Public Overridable Property Tabs() As ObservableCollection(Of TabViewModel)
            Get
                Return privateTabs
            End Get
            Protected Set(ByVal value As ObservableCollection(Of TabViewModel))
                privateTabs = value
            End Set
        End Property
        Private privateSpeedDials As ObservableCollection(Of SpeedDialViewModel)
        Public Overridable Property SpeedDials() As ObservableCollection(Of SpeedDialViewModel)
            Get
                Return privateSpeedDials
            End Get
            Protected Set(ByVal value As ObservableCollection(Of SpeedDialViewModel))
                privateSpeedDials = value
            End Set
        End Property
    ...
    Public Class TabViewModel
        Private privateIsNewTab As Boolean
        Public Overridable Property IsNewTab() As Boolean
            Get
                Return privateIsNewTab
            End Get
            Protected Set(ByVal value As Boolean)
                privateIsNewTab = value
            End Set
        End Property
