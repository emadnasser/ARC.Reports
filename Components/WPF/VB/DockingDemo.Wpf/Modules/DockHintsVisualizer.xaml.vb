...
Namespace DockingDemo
    Partial Public Class DockHintsVisualizer
        ...
        Private Sub OnShowingDockHints(ByVal sender As Object, ByVal e As ShowingDockHintsEventArgs)
            If Not AllowVisualizerEventsChecked Then
                Return
            End If
            If Object.Equals(e.DraggingTarget, Panel1) OrElse (TypeOf e.DraggingTarget Is LayoutGroup) Then
                e.HideAll()
                Return
            End If
            If Object.Equals(e.DraggingTarget, Panel2) Then
                Return
            End If
            If Object.Equals(e.DraggingTarget, Panel3) Then
                e.DisableAll()
                Return
            End If
            If Object.Equals(e.DraggingTarget, Panel4) Then
