...
Namespace DockingDemo.Tests
    ...
    Public Class DockingDemoModulesAccessor
        ...
        Public Sub ResetDockLayoutManager()
            manager = Nothing
        End Sub
        Public ReadOnly Property IDEComplexLayoutModule() As IDEDockLayout
            Get
                Return TryCast(DemoModule, IDEDockLayout)
            End Get
        End Property
    ...
    Public Class CheckDemoOptionsFixture
        ...
        Private Sub CheckMvvmSerializationModule()
            ...
            AddSimpleAction(AddressOf MVVMSerializationTest)
        End Sub
