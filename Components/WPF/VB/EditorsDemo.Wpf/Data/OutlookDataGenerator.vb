...
Namespace EditorsDemo
    ...
    Public NotInheritable Class OutlookDataGenerator
        ...
        Public Shared Function CreateOutlookArrayList(ByVal rowCount As Integer) As System.Collections.ArrayList
            ...
            Return dataList
        End Function
        Public Shared Function CreateNewServerObject() As WpfServerSideGridTest
            ...
            Return obj
        End Function
        Public Shared Function CreateServerObjectsList(ByVal count As Integer) As List(Of WpfServerSideGridTest)
            Dim list As New List(Of WpfServerSideGridTest)(count)
            For i As Integer = 0 To count - 1
                Dim obj As WpfServerSideGridTest = CreateNewServerObject()
                obj.OID = i
                list.Add(obj)
            Next i
            Return list
