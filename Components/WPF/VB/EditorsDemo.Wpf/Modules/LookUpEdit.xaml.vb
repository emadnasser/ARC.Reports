...
Namespace CommonDemo
    <CodeFile("ModuleResources/LookUpEditTemplates(.SL).xaml"), CodeFile("ModuleResources/LookUpEditWithMultipleSelectionTemplates(.SL).xaml"), CodeFile("ViewModels/LookUpEditorDemoViewModel.cs")>
