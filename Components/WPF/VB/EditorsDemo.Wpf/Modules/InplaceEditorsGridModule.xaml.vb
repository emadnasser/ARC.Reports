...
Namespace EditorsDemo
    <CodeFile("ModuleResources/DataEditorTypesDescriptions(.SL).xaml"), CodeFile("ModuleResources/DataEditorTypesTemplates(.SL).xaml"), CodeFile("ModuleResources/DataEditorTypesClasses.(cs)")>
