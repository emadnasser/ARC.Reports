...
Namespace EditorsDemo
    ...
    Partial Public Class InplaceEditorsPropertyGridModule
    ...
    Public Class PropertyGridMultiEditorsList
        ...
        Default Public ReadOnly Overloads Property Item(ByVal index As Integer) As Object
            Get
                Return Table(0)
            End Get
        End Property
        ...
        Protected Overrides Sub CreateDataTable()
            ...
            For i As Integer = 0 To rows.Count - 1
                ...
                dict("Brush") = New SolidColorBrush(DirectCast(dict("Color"), Color))
