...
Namespace CarouselDemo.Tests
    ...
    Public Class CheckDemoOptionsFixture
        ...
        Protected Overrides Sub CreateActions()
            ...
            AddSimpleAction(AddressOf CheckModule_MovingPath)
        End Sub
        #Region "MovingPath module checking"
        Private Sub CheckModule_MovingPath()
            AddLoadModuleActions(GetType(MovingPath))
            AddSimpleAction(AddressOf CheckDefaultProperties)
            AddSimpleAction(AddressOf CheckPathList)
            AddSimpleAction(AddressOf B152058_CheckPathPadding)
            AddSimpleAction(AddressOf CheckDrawPath)
            AddSimpleAction(AddressOf CheckStretchPath)
        End Sub
