...
Namespace TreeListDemo
    Public Class CodeViewer
        ...
        Public Property CurrentItemsCollection() As IEnumerable
            Get
                Return DirectCast(GetValue(CurrentItemsCollectionProperty), IEnumerable)
            End Get
        ...
        Private Sub OnCurrentItemsCollectionChanged()
            If CurrentItemsCollection IsNot Nothing Then
                Dim elementType As Type = DirectCast(New IEnumerableToFirstItemConverter(), IValueConverter).Convert(CurrentItemsCollection, Nothing, Nothing, CultureInfo.CurrentCulture).GetType()
