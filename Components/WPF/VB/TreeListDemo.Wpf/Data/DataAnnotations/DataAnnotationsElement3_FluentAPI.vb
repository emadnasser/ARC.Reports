...
Namespace TreeListDemo
    ...
    Public Class DataAnnotationsElement3Metadata
        ...
        Private Sub IMetadataProviderGeneric_BuildMetadata(ByVal builder As MetadataBuilder(Of DataAnnotationsElement3_FluentAPI)) Implements IMetadataProvider(Of DataAnnotationsElement3_FluentAPI).BuildMetadata
