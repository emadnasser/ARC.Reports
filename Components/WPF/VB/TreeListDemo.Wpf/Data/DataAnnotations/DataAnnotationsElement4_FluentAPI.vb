...
Namespace TreeListDemo
    ...
    Public Class DataAnnotationsElement4Metadata
        ...
        Private Sub IMetadataProviderGeneric_BuildMetadata(ByVal builder As MetadataBuilder(Of DataAnnotationsElement4_FluentAPI)) Implements IMetadataProvider(Of DataAnnotationsElement4_FluentAPI).BuildMetadata
