...
Namespace TreeListDemo
    Partial Public Class ScrollBarAnnotations
        ...
        Private Sub view_ValidateCell(ByVal sender As Object, ByVal e As DevExpress.Xpf.Grid.TreeList.TreeListCellValidationEventArgs)
        ...
        Private Sub view_NodeChanged(ByVal sender As Object, ByVal e As DevExpress.Xpf.Grid.TreeList.TreeListNodeChangedEventArgs)
            If e.ChangeType = NodeChangeType.Content AndAlso changedRows IsNot Nothing Then
                changedRows.Add(CType(e.Node.Content, SalesData).ID)
            End If
        End Sub
