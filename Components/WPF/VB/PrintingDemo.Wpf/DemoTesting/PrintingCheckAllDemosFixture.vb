...
Namespace PrintingDemo.Tests
    Public Class PrintingCheckAllDemosFixture
        ...
        Protected Overrides Sub CreateSetCurrentDemoActions(ByVal [module] As ModuleDescription, ByVal checkMemoryLeaks As Boolean)
            MyBase.CreateSetCurrentDemoActions([module], checkMemoryLeaks)
            AddConditionAction(DocumentBuildCompletedConditionFactory.Create(Me), Nothing)
            AddSimpleAction(Sub()
