...
Namespace DevExpress.Xpf.LayoutControlDemo
    ...
    End Class
    Public NotInheritable Class AdvancedGroupedLayoutMetadata

        Private Sub New()
        End Sub

        Public Shared Sub BuildMetadata(ByVal builder As MetadataBuilder(Of AdvancedGroupedLayoutData_FluentAPI))
