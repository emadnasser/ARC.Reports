...
Namespace DevExpress.Xpf.LayoutControlDemo
    ...
    End Class
    Public NotInheritable Class SupportedDataTypesMetadata

        Private Sub New()
        End Sub

        Public Shared Sub BuildMetadata(ByVal builder As MetadataBuilder(Of SupportedDataTypesData_FluentAPI))
