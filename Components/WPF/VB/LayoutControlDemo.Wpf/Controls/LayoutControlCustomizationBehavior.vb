...
Namespace DevExpress.Xpf.LayoutControlDemo
    Public Class LayoutControlCustomizationBehavior
        ...
        Public Property SelectedItem() As FrameworkElement
            ...
            End Set
        End Property
        Public Shared ReadOnly SelectedItemProperty As DependencyProperty = DependencyProperty.Register("SelectedItem", GetType(FrameworkElement), GetType(LayoutControlCustomizationBehavior), New PropertyMetadata(Nothing))
        ...
        Public Property AllowCustomization() As Boolean
            ...
            End Set
        End Property
        Public Shared ReadOnly AllowCustomizationProperty As DependencyProperty = DependencyProperty.Register("AllowCustomization", GetType(Boolean), GetType(LayoutControlCustomizationBehavior), New PropertyMetadata(True, New PropertyChangedCallback(AddressOf AllowCustomizationChanged)))
        ...
        Private Sub OnAllowCustomizationChanged()
            If AssociatedObject IsNot Nothing AndAlso AssociatedObject.IsCustomization AndAlso (Not AllowCustomization) Then
        ...
        Private Sub OnAutoGeneratedUI(ByVal sender As Object, ByVal e As EventArgs)
            If AssociatedObject.AutoGeneratedItemsLocation = DataLayoutControlAutoGeneratedItemsLocation.AvailableItems Then
