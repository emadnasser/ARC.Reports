...
Namespace DevExpress.Xpf.LayoutControlDemo
    <TemplateVisualState(Name := SampleLayoutItem.UnselectedStateName, GroupName := SampleLayoutItem.SelectionStatesGroupName), TemplateVisualState(Name := SampleLayoutItem.SelectedStateName, GroupName := SampleLayoutItem.SelectionStatesGroupName)>
    Public Class SampleLayoutItem
        ...
        Public Property IsMaximized() As Boolean
            ...
            Set(ByVal value As Boolean)
                If IsMaximized <> value And TypeOf Parent Is FlowLayoutControl Then
                    CType(Parent, FlowLayoutControl).MaximizedElement = If(value, Me, Nothing)
                End If
            End Set
        End Property
