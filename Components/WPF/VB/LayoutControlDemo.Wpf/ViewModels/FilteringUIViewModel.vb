...
Namespace DevExpress.Xpf.LayoutControlDemo
    ...
    Public Class VehiclesFilteringViewModel
        ...
        <Display(Name := "Transmission Type"), FilterLookup("TransmissionTypes", DisplayMember := "Name", ValueMember := "ID", UseFlags := False, UseSelectAll := True)>
        Public Property TransmissionTypeID() As Integer
        ...
        <Display(Name := "Doors"), FilterLookup("DoorTypes", UseFlags := False, UseSelectAll := True)>
