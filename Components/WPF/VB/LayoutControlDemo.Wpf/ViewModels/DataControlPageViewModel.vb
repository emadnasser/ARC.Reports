...
Namespace DevExpress.Xpf.LayoutControlDemo
    Public Class DataControlPageViewModel
        Public Class ObjectNamePair
            ...
            End Sub
        End Class
        Private privateObjectList As IEnumerable(Of ObjectNamePair)
