...
Namespace DevExpress.Xpf.LayoutControlDemo
    Partial Public Class pageRealEstate
        ...
        Public Sub New()
            ...
            ThemeManager.AddThemeChangedHandler(Me, AddressOf OnThemeChanged)
            UpdateTheme(ApplicationThemeHelper.ApplicationThemeName)
        End Sub
        ...
        Protected Overrides Sub Clear()
            MyBase.Clear()
            ThemeManager.RemoveThemeChangedHandler(Me, AddressOf OnThemeChanged)
        End Sub
        ...
        End Sub
        Private Function IsDarkTheme(ByVal themeName As String) As Boolean
            Select Case themeName
                Case Theme.Office2010BlackName, Theme.Office2016BlackName, Theme.Office2016BlackTouchName
                    Return True
            End Select
            Return False
        End Function
        Private Sub UpdateTheme(ByVal themeName As String)
            LayoutRoot.ItemStyle = CType(Resources(If(IsDarkTheme(themeName), "LayoutItemDarkStyle", "LayoutItemLightStyle")), Style)
        End Sub
