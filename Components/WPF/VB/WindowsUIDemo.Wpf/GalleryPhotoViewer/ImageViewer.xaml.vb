...
Namespace WindowsUIDemo
    Partial Public Class ImageViewer
        ...
        Protected Shared Sub OnFlipPropertyChanged(ByVal d As DependencyObject, ByVal e As DependencyPropertyChangedEventArgs)
            CType(d, ImageViewer).OnFlipChanged(DirectCast(e.OldValue, Boolean))
        End Sub
        ...
        Public Property Flip() As Boolean
            Get
                Return DirectCast(GetValue(FlipProperty), Boolean)
            End Get
    ...
    Public Class ImagePresenter
        ...
        End Sub
        Protected Shared Sub OnFlipPropertyChanged(ByVal d As DependencyObject, ByVal e As DependencyPropertyChangedEventArgs)
            CType(d, ImagePresenter).OnFlipChanged(DirectCast(e.OldValue, Boolean))
        End Sub
