...
namespace DevExpress.MailClient.DataProvider {
    public class DesignTimeDataProvider : DataProviderBase {
        ...
        protected override IList<MailMessageViewModel> FillMessages() {
            ...
            message.From = "Peter Thorpe";
            message.To = "peter_thorpe@dxmail.com";
            message.Subject = "AsyncMode for Pivot Grid (available in v2011.1)";
            message.Text = "&lt;p&gt;Cool will it work as normal if you use chart integration or need some modification?&lt;/p&gt;";
            message.Folder = MessageFolderName.Announcements;
            ...
            message.Subject = "XAF – Model Merge Tool (coming in v2011 vol1)";
            message.Text = "&lt;p&gt;Great! This is an useful enhancement that will save us time. One more step making XAF more RAD.&lt;/p&gt;";
            message.Folder = MessageFolderName.Frameworks;
            message.IsReply = true;
            ...
            message.Subject = "WinForms Tab Control - Custom Buttons (coming in v2011 vol 1)";
            message.Text = "&lt;p&gt;Sorry, I don't agree with Chris at all, the assumption that Winforms is legacy doesn’t site right with me, " +
                "quite a lot of my users are not interested, so I am more inclined to agree with the others.&lt;/p&gt;&lt;p&gt;More attention really" +
                ...
                "give one of the other vendors a try.&lt;/p&gt;";
            message.Folder = MessageFolderName.Announcements;
            message.IsReply = true;
            ...
            message.Subject = "ASP.NET MVC - Code Usability Improvement (available now in v2011.1)";
            message.Text = "&lt;p&gt;Graeme,&lt;/p&gt;&lt;p&gt;Thanks! And it's possible so we'll consider it for a future release. &lt;/p&gt;";
            message.Folder = MessageFolderName.ASP;
            message.IsUnread = true;
        ...
        protected override IList<AppointmentViewModel> FillAppointments() {
            ...
            var subjects = new List<string>() {
                ...
                "Webinar - ASP.NET MVC Charting Preview",
                "Webinar - Preview of v2011.1 ASP.NET features announced, so far…",
        ...
        protected override IList<ContactItemViewModel> FillContacts() {
            ...
            contact.Photo = new BitmapImage(FilePathHelper.GetAppImageUri("Contacts/Unknown-user", UriKind.RelativeOrAbsolute));
