...
namespace DevExpress.MailClient.ViewModel {
    public class MailNavigationViewModel : NavigationViewModelBase {
        ...
        protected override void Initialize() {
            ...
            FillFolders();
            CurrentFolder = GetFolderByFolderDescription(MessageFolderName.Announcements, MessageType.Inbox, Folders);
        }
        ...
        void FillFolders() {
            ...
            mainInbox.SubFolders.Add(MailFolderViewModel.Create("ASP", FilePathHelper.GetAppImageUri("FoldersIcons/ASP"), MessageFolderName.ASP, MessageType.Inbox));
            mainInbox.SubFolders.Add(MailFolderViewModel.Create("Announcements", FilePathHelper.GetAppImageUri("FoldersIcons/Announcements"), MessageFolderName.Announcements, MessageType.Inbox));
            mainInbox.SubFolders.Add(MailFolderViewModel.Create("WinForms", FilePathHelper.GetAppImageUri("FoldersIcons/WinForms"), MessageFolderName.WinForms, MessageType.Inbox));
            mainInbox.SubFolders.Add(MailFolderViewModel.Create("IDE Tools", FilePathHelper.GetAppImageUri("FoldersIcons/IDE"), MessageFolderName.IDETools, MessageType.Inbox));
            mainInbox.SubFolders.Add(MailFolderViewModel.Create("Frameworks", FilePathHelper.GetAppImageUri("FoldersIcons/Frameworks"), MessageFolderName.Frameworks, MessageType.Inbox));
