...
namespace DevExpress.StockMarketTrader.Model {
    ...
    public class RealTimeDataModel {
        ...
        public RealTimeDataModel() {
            ...
            this.networkMonitor.InternetAvaliableChanged += networkMonitor_InternetAvaliableChanged;
        ...
        void networkMonitor_InternetAvaliableChanged(object sender, EventArgs e) {
        ...
        public string NetworkState {
            get { return networkMonitor.IsInternetAvaliable ? "Connected" : "Offline"; }
        }
