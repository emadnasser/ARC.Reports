...
Namespace DevExpress.DevAV.ViewModels
    Partial Public Class OrderCollectionViewModel
        Private Const NumberOfAverageOrders As Integer = 200
        ...
        Public Sub ShowPrintPreview()
            ...
            Me.GetRequiredService(Of IDocumentManagerService)().CreateDocument("PrintableControlPrintPreview", PrintableControlPreviewViewModel.Create(link), Nothing, Me).Show()
        End Sub
