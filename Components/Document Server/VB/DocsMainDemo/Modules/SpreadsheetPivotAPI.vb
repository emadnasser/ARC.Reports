...
Namespace DevExpress.Docs.Demos
	Public Class PivotAPIModule
		...
		Public ReadOnly Property TestDocumentName() As String
			Get
				Return "PivotTableTemplate.xlsx"
			End Get
		End Property
		...
		Protected Overrides Sub RearrangeExamples(ByVal examples As List(Of CodeExampleGroup))
			Dim i As Integer = 0
