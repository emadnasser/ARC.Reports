...
Namespace DevExpress.Docs.Demos
	Public Class MultiplicationTableDocumentGenerator
		...
		Public Property FitToPage() As Boolean
			...
			End Set
		End Property
		Private privateCreateInfoCells As Boolean
		Public Property CreateInfoCells() As Boolean
			Get
				Return privateCreateInfoCells
			End Get
			Set(ByVal value As Boolean)
				privateCreateInfoCells = value
			End Set
		End Property
		Private privateUseSharedFormula As Boolean
		Public Property UseSharedFormula() As Boolean
			Get
				Return privateUseSharedFormula
			End Get
			Set(ByVal value As Boolean)
				privateUseSharedFormula = value
			End Set
		End Property
		#End Region
