<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="RichEditApi.aspx.vb"
	Inherits="RichEdit_RichEditApi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHolder" runat="server">
	<script type="text/javascript">
		...
		function UpdateCodePreview(s, e) {
			...
			previewFrame.src = 'richeditapi.aspx?preview=' + key;
		}
		// ]]> 
	</script>
	...
	<table id="mainTable" style="width: 100%;">
		<tr>
			...
			<td rowspan="2">
				<div id="treeListContainer" style="height: 550px; overflow: scroll; width: 280px;
					padding: 0; margin: 0;">
		...
		<tr>
			<td id="previewFrameContainer" style="vertical-align: top; width: 100%; height: 300px;
				padding-right: 2px;">
				<iframe id="previewFrame" src="RichEditApi.aspx?preview=0" class="borderedContent"
