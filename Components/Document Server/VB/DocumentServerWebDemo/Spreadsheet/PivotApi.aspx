<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PivotApi.aspx.vb"
	Inherits="Pivot_Api" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHolder" runat="server">
	...
	// <![CDATA[
		...
		function UpdateCodePreview(s, e) {
			...
			previewFrame.src = 'pivotapi.aspx?preview=' + key;
		}
	// ]]> 
	</script>
	...
	<table id="mainTable" style="width: 100%;">
		...
		<tr>
			<td id="previewFrameContainer" style="vertical-align: top; width: 100%; height: 340px;
				padding-right: 2px;">
				<iframe id="previewFrame" src="PivotApi.aspx?preview=0" class="borderedContent" style="width: 100%;
					height: 340px;"></iframe>
			</td>
		</tr>
	</table>
