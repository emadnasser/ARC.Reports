<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Api.aspx.vb"
	Inherits="Spreadsheet_Api" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHolder" runat="server">
	...
	// <![CDATA[
		...
		function UpdateCodePreview(s, e) {
			...
			previewFrame.src = 'api.aspx?preview=' + key;
		}
	// ]]> 
	</script>
	...
	<table id="mainTable" style="width: 100%;">
		...
		<tr>
			<td id="previewFrameContainer" style="vertical-align: top; width: 100%; height: 300px;
				padding-right: 2px;">
				<iframe id="previewFrame" src="Api.aspx?preview=0" class="borderedContent" style="width: 100%;
					height: 300px;"></iframe>
			</td>
		</tr>
	</table>
