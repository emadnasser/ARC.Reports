...
Partial Public Class Charts_Api
	...
	Private Sub RenderHTMLPreview()
		...
		Dim loaded As Boolean = workbook.LoadDocument(MapPath("~/App_Data/Document.xlsx"))
	...
	Private Sub LoadExamples()
		Dim examplePath As String = MapPath("~/App_Data/ApiExampleCode/Charts")
