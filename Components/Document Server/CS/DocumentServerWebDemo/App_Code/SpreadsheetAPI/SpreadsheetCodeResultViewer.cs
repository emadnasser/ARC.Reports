...
namespace DevExpress.Docs.Demos {
    ...
    public class SpreadsheetCSExampleCodeEvaluator : SpreadsheetExampleCodeEvaluator {
      ...
      "        public static void Process(IWorkbook workbook) { \r\n" +
      "        string rootPath = Path.GetDirectoryName(workbook.Path); \r\n" +
      "\r\n";
    ...
    #endregion
    #region SpreadsheetVBCodeResultViewer
    public class SpreadsheetVbExampleCodeEvaluator : SpreadsheetExampleCodeEvaluator {
     ...
     "Namespace SpreadsheetCodeResultViewer\r\n" +
     "	Public Class ExampleItem\r\n" +
     "		Public Shared Sub Process(ByVal workbook As IWorkbook)\r\n" +
     "        Dim rootPath As String = Path.GetDirectoryName(workbook.Path)\r\n" +
     "\r\n";
