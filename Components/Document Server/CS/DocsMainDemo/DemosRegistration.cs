...
namespace DevExpress.Docs.Demos {
    public class DemosInfo : ModulesInfo {
        public static void DoShowModule(string name, DevExpress.XtraEditors.GroupControl groupControl, DevExpress.Utils.Frames.ApplicationCaption caption, DocsRibbonMenuManager manager) {
