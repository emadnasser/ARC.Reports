...
namespace FeatureCenter.Module.Win {
    public partial class MainRibbonForm : RibbonForm, IActionControlsSite, IContextMenuHolder, IWindowTemplate, IDockManagerHolder, IBarManagerHolder, ISupportViewChanged, IXafDocumentsHostWindow, ISupportUpdate, IViewSiteTemplate, ISupportStoreSettings, IHintTemplate, ICaptionPanelHolder {
        ...
        protected void SetupSdi() {
            ...
            viewSiteControlPanel.Visible = true;
        ...
        private void SetupMdiCommon() {
            viewSiteControlPanel.Visible = false;
