...
namespace FeatureCenter.Module.Notifications {
    public class FeatureCenterNotificationsController : WindowController {
        ...
        public Boolean? IsSchedulerNotificationInitialize {
            get {
                return ValueManager.GetValueManager<Boolean?>("IsSchedulerNotificationInitialize").Value.HasValue ? ValueManager.GetValueManager<Boolean?>("IsSchedulerNotificationInitialize").Value.Value : false;
            }
        }
        public Boolean? IsCustomNotificationInitialize {
            get {
                return ValueManager.GetValueManager<Boolean?>("IsCustomNotificationInitialize").Value.HasValue ? ValueManager.GetValueManager<Boolean?>("IsCustomNotificationInitialize").Value.Value : false;
            }
        }
    }
