...
namespace FeatureCenter.Module.Actions {
	...
	public class ActionsDemoStrings {
		...
		public const string ParametrizedActionImageName =
            @"Action_ParametrizedAction_16x13";
        ...
        public const string FloatValueTooltip =
            @"To execute, enter an float value as a parameter.";
        //TODO Boolean
        //public const string BooleanValueTooltip =
        //    @"To execute, enter an boolean value as a parameter.";
