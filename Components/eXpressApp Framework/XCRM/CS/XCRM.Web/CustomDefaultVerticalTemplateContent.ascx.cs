...
namespace XCRM.Web
{
    public partial class CustomDefaultVerticalTemplateContent : TemplateContent, IXafPopupWindowControlContainer, IXafSecurityActionContainerHolder, IHeaderImageControlContainer
    {
        static CustomDefaultVerticalTemplateContent()
        {
