namespace EFDemo.Win {
	partial class EFDemoWinApplication {
		...
		private void InitializeComponent() {
            ...
            this.notificationModuleWin = new DevExpress.ExpressApp.Notifications.Win.NotificationsWindowsFormsModule();
			((System.ComponentModel.ISupportInitialize)(this)).BeginInit();
			// 
			// reportsModuleV21
			// 
			this.reportsModuleV21.EnableInplaceReports = true;
			this.reportsModuleV21.ReportDataType = typeof(EFDemo.Module.Data.ReportDataV2);
			// 
			// securityComplex1
			// 
			this.securityStrategyComplex1.Authentication = this.authenticationStandard1;
			this.securityStrategyComplex1.RoleType = typeof(EFDemo.Module.Data.PermissionPolicyRole);
			this.securityStrategyComplex1.UserType = typeof(EFDemo.Module.Data.PermissionPolicyUser);
			// 
			// authenticationStandard1
			// 
			this.authenticationStandard1.LogonParametersType = typeof(DevExpress.ExpressApp.Security.AuthenticationStandardLogonParameters);
			this.authenticationStandard1.UserType = typeof(EFDemo.Module.Data.PermissionPolicyUser);
			// 
            ...
            this.Modules.Add(this.notificationModuleWin);
        ...
        private DevExpress.ExpressApp.Notifications.Win.NotificationsWindowsFormsModule notificationModuleWin;
	}
}
