...
namespace Common.Win.ColumnView.RepositoryItems {
    [OnlineRepoLocation("http://goo.gl/O5PUj")]
    public class RepositoryItemModelAdapterController : ModelAdapterController, IModelExtender {
        static readonly HashSet<Type> _modelInterfaceTypes = new HashSet<Type>{
        ...
        IEnumerable<ITypeInfo> RepositoryItemDescendants() {
            ...
            var names = _modelInterfaceTypes.Select(type => type.Name.Substring(6)).ToList();
