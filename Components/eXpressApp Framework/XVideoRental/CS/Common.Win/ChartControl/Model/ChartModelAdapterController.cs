...
namespace Common.Win.ChartControl.Model {
    [OnlineRepoLocation("http://goo.gl/dM6ik")]
    public class ChartModelAdapterController : ModelAdapterController, IModelExtender {
        ...
        public void ExtendModelInterfaces(ModelInterfaceExtenders extenders) {
            ...
            var assembly = builder.Build(CreateBuilderData(), GetPath(typeof(DevExpress.XtraCharts.ChartControl).Name));

            XafTypesInfo.Instance.LoadTypes(assembly);

            builder.ExtendInteface<IModelOptionsChart, DevExpress.XtraCharts.ChartControl>(assembly);
        ...
        IEnumerable<InterfaceBuilderData> CreateBuilderData() {
            yield return new InterfaceBuilderData(typeof(DevExpress.XtraCharts.ChartControl)) {
