...
using System.Linq;
[assembly: OnlineRepoLocation("http://goo.gl/djgaC")]
namespace Common.Win.ChartControl.Model {
    ...
    public class ChartControlSynchronizer : ComponentSynchronizer<DevExpress.XtraCharts.ChartControl, IModelOptionsChart> {
        ...
        DevExpress.XtraPivotGrid.PivotGridControl GetPivotGridControl(IGrouping<IModelListView, IModelSeries> grouping) {
