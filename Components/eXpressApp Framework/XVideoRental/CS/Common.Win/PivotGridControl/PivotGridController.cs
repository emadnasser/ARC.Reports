...
using Common.Win.General.ToolTip;
using Common.Win.PivotGridControl.Model;
...
[assembly: OnlineRepoLocation("http://goo.gl/Wjm68")]

namespace Common.Win.PivotGridControl {
    public abstract class PivotGridControllerBase : ViewController<ListView> {
        ...
        protected override void OnActivated() {
            ...
            if (Active && PivotGridListEditor != null) {
                PivotGridListEditor.ModelApplied += PivotGridListEditor_ModelApplied;
            }
        }

        private void PivotGridListEditor_ModelApplied(object sender, EventArgs e) {
    ...
    public class PivotGridController : PivotGridControllerBase {
        ...
        void PivotGridControlOnCustomCellEditForEditing(object sender, PivotCustomCellEditEventArgs e) {
            var focusedCell = ((DevExpress.XtraPivotGrid.PivotGridControl)sender).Cells.FocusedCell;
        ...
        void pivotGridControl_ShowingEditor(object sender, CancelPivotCellEditEventArgs e) {
            var pivotGridControl = ((DevExpress.XtraPivotGrid.PivotGridControl)sender);
