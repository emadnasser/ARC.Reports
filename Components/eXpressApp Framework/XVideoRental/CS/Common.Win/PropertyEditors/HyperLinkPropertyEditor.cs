...
namespace Common.Win.PropertyEditors {
    ...
    public class HyperLinkGridListViewController : ViewController {
        ...
        protected override void OnViewControlsCreated() {
            ...
            gridListEditor = ((ListView)View).Editor as WinColumnsListEditor;
            if (gridListEditor != null) {
                DevExpress.XtraGrid.Views.Grid.GridView gridView = gridListEditor.ColumnView as DevExpress.XtraGrid.Views.Grid.GridView;
