...
[assembly: OnlineRepoLocation("http://goo.gl/wBmAQ")]
...
namespace Common.Win.General.Security {
    ...
    public static class SecuritySystemExtensions {
        ...
        public static SecuritySystemRole GetAdminRole(this IObjectSpace objectSpace, string roleName) {
            return GetAdminRole<XRole>(objectSpace, roleName);
        }
        ...
        public static XRole GetRole(this IObjectSpace objectSpace, string roleName) {
            return GetRole<XRole>(objectSpace, roleName);
        }
        ...
        public static bool IsGranted(this IRole role, IPermission permission) {
            ...
            foreach (var permission1 in role.Permissions) {
                permissionSet.AddPermission(permission1);
            }
