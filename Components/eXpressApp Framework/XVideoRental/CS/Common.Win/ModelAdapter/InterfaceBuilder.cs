...
[assembly: OnlineRepoLocation("http://goo.gl/YzYuR")]
...
namespace Common.Win.ModelAdapter {
    ...
    public class InterfaceBuilder {
        ...
        public static string GetTempDirectory() {
            var directory = Path.Combine(Environment.GetEnvironmentVariable("temp", EnvironmentVariableTarget.Machine) + "", AssemblyInfo.Version);
        ...
        string GetAttributeCode(object attribute, DynamicModelPropertyInfo info) {
            ...
            if(typeof(DescriptionAttribute).IsAssignableFrom(attributeType)) {
                if(((DescriptionAttribute)attribute).Description != null) {
        ...
        Type GalcType(Type extenderType, Assembly assembly) {
            ...
            else if(!extenderType.IsInterface) {
    ...
    public class ModelValueCalculatorWrapperAttribute : Attribute {
        ...
        public ModelValueCalculatorWrapperAttribute(ModelValueCalculatorAttribute modelValueCalculatorAttribute, Type calculatorType)
            ...
            _nodeType = modelValueCalculatorAttribute.NodeType;
    ...
    public static class InterfaceBuilderExtensions {
        ...
        static readonly Type[] BaseTypes = { typeof(BaseOptions), typeof(FormatInfo), typeof(AppearanceObject), typeof(TextOptions) };
