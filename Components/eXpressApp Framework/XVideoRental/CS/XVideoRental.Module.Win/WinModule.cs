...
namespace XVideoRental.Module.Win {
    ...
    public sealed partial class XVideoRentalWindowsFormsCommonWindowsFormsModule : ModuleBase {
        public XVideoRentalWindowsFormsCommonWindowsFormsModule() {
            InitializeComponent();
        }
        ...
        public override IEnumerable<ModuleUpdater> GetModuleUpdaters(IObjectSpace objectSpace, Version versionFromDB) {
            ...
            predefinedReportsUpdater.AddPredefinedReport<MovieRentalsByCustomer > ("XtraReport1", typeof(Customer));
