    ...
    public class Updater : ModuleUpdater
    {
        ...
        private PermissionPolicyRole CreateSecurityDemoRole() {
            ...
            if(securityDemoRole == null) {
                ...
                //By Navigation Permissions
                securityDemoRole.AddNavigationPermission("Application/NavigationItems/Items/Business Objects", SecurityPermissionState.Allow);
                securityDemoRole.AddNavigationPermission("Application/NavigationItems/Items/Class-level security", SecurityPermissionState.Allow);
                securityDemoRole.AddNavigationPermission("Application/NavigationItems/Items/Default", SecurityPermissionState.Allow);
                securityDemoRole.AddNavigationPermission("Application/NavigationItems/Items/Member-level security", SecurityPermissionState.Allow);
                securityDemoRole.AddNavigationPermission("Application/NavigationItems/Items/Object-level security", SecurityPermissionState.Allow);
            }
