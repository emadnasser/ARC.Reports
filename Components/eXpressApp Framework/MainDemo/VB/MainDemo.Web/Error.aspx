                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td class="ViewCaption">
                                        <h1>
                                            <asp:Literal ID="ApplicationTitle" runat="server" Text="Test Application"></asp:Literal></h1>
                                    </td>
                                            ...
                                            <asp:TableCell runat="server" ID="ViewSite">
                                                ...
                                                <asp:Panel runat="server" ID="ErrorPanel" Width="100%">
                                                    <p class="StaticText" id="MainErrorText">
                                                        <asp:PlaceHolder ID="ReportResult" runat="server">Your report was sent. Thank you.
                                                            <br />
                                                        </asp:PlaceHolder>
                                                        <asp:PlaceHolder ID="ApologizeMessage" runat="server">We apologize, but an error occurred and your request could not be completed.
                                                            <br />
                                                            You could go&nbsp;
                                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="javascript:Back();">back</asp:HyperLink>&nbsp;and
                                                    try again or  
                                                    ...
                                                    <p class="StaticText" id="PopupErrorText">
                                                        <asp:PlaceHolder ID="PopupReportResult" runat="server">Your report was sent. Thank you.
                                                            <br />
                                                        </asp:PlaceHolder>
                                                        <asp:PlaceHolder ID="PopupApologizeMessage" runat="server">We apologize, but an error occurred and your request could not be completed.
                                                            <br />
                                                            You could go&nbsp;
                                                            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="javascript:Back();">back</asp:HyperLink>&nbsp;and
                                                    try again.
                                                        </asp:PlaceHolder>
                                                    </p>
...
<asp:literal id="DetailsText" runat="server"></asp:literal></pre>
                                                        </div>
                                                    </asp:Panel>
                                                    <asp:Panel ID="ReportForm" runat="server" Width="100%">
                                                        ...
                                                        may have caused this error please report the problem.
                                                        </p>
                                                        <table cellpadding="0" cellspacing="0" border="0">
                                                            <tr>
                                                                <td align="right" style="padding-bottom: 10px">
                                                                    <asp:TextBox ID="DescriptionTextBox" runat="server" Columns="60" Rows="8" TextMode="MultiLine">
                                                                    </asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
