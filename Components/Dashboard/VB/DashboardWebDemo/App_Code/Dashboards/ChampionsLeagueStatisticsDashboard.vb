...
''' </summary>
Public Class ChampionsLeagueStatisticsDashboard
	Inherits Dashboard
	Private scatterChartLeagueStatistics As ScatterChartDashboardItem
	Private groupCountryStatistics As DashboardItemGroup
	Private pivotGoalDifference As PivotDashboardItem
	Private groupGoalDifference As DashboardItemGroup
	Private comboBoxCountries As ComboBoxDashboardItem
	Private chartStatisticsBySeason As ChartDashboardItem
	Private dashboardObjectDataSource1 As DashboardObjectDataSource
	...
	Private Sub InitializeComponent()
			...
			dashboardLayoutItem1.Weight = 70.308483290488425R
			dashboardLayoutItem2.DashboardItem = Me.chartStatisticsBySeason
			dashboardLayoutItem2.Weight = 29.691516709511568R
			...
			dashboardLayoutGroup2.Weight = 59.9687255668491R
			...
			dashboardLayoutGroup3.Weight = 40.0312744331509R
...
'			Me.DataLoading += New DevExpress.DashboardCommon.DashboardDataLoadingEventHandler(Me.ChampionsLeagueStatisticsDashboard_DataLoading);
	...
	Private Sub ChampionsLeagueStatisticsDashboard_DataLoading(ByVal sender As Object, ByVal e As DashboardDataLoadingEventArgs) Handles MyBase.DataLoading
