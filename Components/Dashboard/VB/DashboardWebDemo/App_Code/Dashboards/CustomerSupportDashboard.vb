...
''' </summary>
Public Class CustomerSupportDashboard
	Inherits Dashboard
	Private chartProcessedIssuesByPlatform As ChartDashboardItem
	Private dsCustomerSupport As DashboardObjectDataSource
	Private range As RangeFilterDashboardItem
	Private chartAvgResponseTimeByPlatform As ChartDashboardItem
	Private chartOpenedIssuesByMonth As ChartDashboardItem
	Private chartAvgResponseTimeByMonth As ChartDashboardItem
	''' <summary>
	...
	Private Sub InitializeComponent()
			Dim resources As System.Resources.ResourceManager = Global.Resources.CustomerSupportDashboard.ResourceManager
			...
			Me.dsCustomerSupport.DataMember = "CustomerSupportItem"
			Me.dsCustomerSupport.DataSchema = resources.GetString("dsCustomerSupport.DataSchema")
			...
			Me.chartOpenedIssuesByMonth.Legend.OutsidePosition = DevExpress.DashboardCommon.ChartLegendOutsidePosition.BottomCenterHorizontal
			...
			Me.chartProcessedIssuesByPlatform.Legend.OutsidePosition = DevExpress.DashboardCommon.ChartLegendOutsidePosition.BottomCenterHorizontal
			...
			Me.chartAvgResponseTimeByMonth.Legend.OutsidePosition = DevExpress.DashboardCommon.ChartLegendOutsidePosition.BottomCenterHorizontal
			...
			Me.chartAvgResponseTimeByPlatform.DataItemRepository.Add(measure5, "DataItem4")
			...
			Me.chartAvgResponseTimeByPlatform.Legend.OutsidePosition = DevExpress.DashboardCommon.ChartLegendOutsidePosition.BottomCenterHorizontal
			...
			dashboardLayoutItem1.Weight = 36.381709741550694R
			dashboardLayoutItem2.DashboardItem = Me.chartProcessedIssuesByPlatform
			dashboardLayoutItem2.Weight = 63.618290258449306R
			...
			dashboardLayoutGroup3.Weight = 52.023546725533478R
			dashboardLayoutItem3.DashboardItem = Me.chartAvgResponseTimeByMonth
			dashboardLayoutItem3.Weight = 36.381709741550694R
			dashboardLayoutItem4.DashboardItem = Me.chartAvgResponseTimeByPlatform
			dashboardLayoutItem4.Weight = 63.618290258449306R
			...
			dashboardLayoutGroup4.Weight = 47.976453274466522R
