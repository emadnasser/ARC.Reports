...
''' </summary>
Public Class ProductDetailsDashboard
	Inherits Dashboard
	...
	Private comboBoxDashboardItem1 As ComboBoxDashboardItem
	Private dashboardItemGroup1 As DashboardItemGroup
	Private dashboardItemGroup2 As DashboardItemGroup
	Private comboBoxDashboardItem2 As ComboBoxDashboardItem
	Private boundImageDashboardItem2 As BoundImageDashboardItem
	...
	Private Sub InitializeComponent()
			Dim resources As System.Resources.ResourceManager = Global.Resources.ProductDetailsDashboard.ResourceManager
			...
			calculatedField1.Expression = "Aggr(Sum([SalesAmount]), [Name])"
			calculatedField1.Name = "ProductSalesByCustomer"
			calculatedField2.DataMember = "Customers"
			calculatedField2.Expression = "Aggr(Sum([SalesAmount]), GetYear([OrderDate]))"
			calculatedField2.Name = "ProductSalesByYear"
			...
			xmlFileConnectionParameters1.FileName = "CS\App_Data\DashboardProductDetails.xml"
			...
			measure1.WindowDefinition = Nothing
			measure2.Calculation = Nothing
			measure2.DataMember = "Description"
			measure2.Name = "Description"
			measure2.SummaryType = DevExpress.DashboardCommon.SummaryType.Min
			measure2.WindowDefinition = Nothing
			measure3.Calculation = Nothing
			...
			measure3.WindowDefinition = Nothing
			measure4.Calculation = Nothing
			...
			measure4.WindowDefinition = Nothing
			measure5.Calculation = Nothing
			measure5.DataMember = "RetailPrice"
			measure5.Name = "Retail Price"
			measure5.SummaryType = DevExpress.DashboardCommon.SummaryType.Min
			measure5.WindowDefinition = Nothing
			measure6.Calculation = Nothing
			...
			measure6.WindowDefinition = Nothing
			measure7.Calculation = Nothing
			...
			measure7.WindowDefinition = Nothing
			...
			Me.boundImageDashboardItem1.UriPattern = "CS\Content\ProductDetailsImages\{0}.jpg"
			' 
			...
			Me.boundImageDashboardItem2.UriPattern = "CS\Content\ProductDetailsImages\{0} Secondary.jpg"
			' 
			...
			measure8.Calculation = Nothing
			measure8.DataMember = "SalesAmount"
			measure8.Name = "Sales Amount"
			measure8.WindowDefinition = Nothing
			...
			dashboardLayoutItem1.Weight = 7.4245939675174011R
			dashboardLayoutItem2.DashboardItem = Me.textBoxDashboardItem1
			dashboardLayoutItem2.Weight = 66.125290023201856R
			dashboardLayoutItem3.DashboardItem = Me.boundImageDashboardItem1
			dashboardLayoutItem3.Weight = 65.91836734693878R
			dashboardLayoutItem4.DashboardItem = Me.boundImageDashboardItem2
			dashboardLayoutItem4.Weight = 34.081632653061227R
			...
			dashboardLayoutGroup3.Weight = 26.450116009280741R
			...
			dashboardLayoutGroup2.Weight = 48.991354466858787R
			...
			dashboardLayoutGroup4.Weight = 51.008645533141213R
...
'			Me.DashboardLoading += New System.EventHandler(Me.ProductDetailsDashboard_DashboardLoading);
	...
	Private Sub ProductDetailsDashboard_DashboardLoading(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.DashboardLoading
		boundImageDashboardItem2.UriPattern = DataLoader.GetProductDetailsImagePattern()
	End Sub
End Class
