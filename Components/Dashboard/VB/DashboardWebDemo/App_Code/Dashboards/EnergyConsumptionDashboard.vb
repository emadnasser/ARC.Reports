...
''' Summary description
''' </summary>
Public Class EnergyConsumptionDashboard
	Inherits Dashboard
	Private chartConsumptionHistory As ChartDashboardItem
	Private dsConsumptionBySector As DashboardObjectDataSource
	Private pieConsumption As PieDashboardItem
	Private mapProduction As BubbleMapDashboardItem
	Private dsConsumptionTotal As DashboardObjectDataSource
	''' <summary>
	...
	Private Sub InitializeComponent()
			Dim resources As System.Resources.ResourceManager = Global.Resources.EnergyConsumptionDashboard.ResourceManager
			...
			Me.mapProduction.DataItemRepository.Add(dimension1, "DataItem1")
			...
			Me.mapProduction.DataItemRepository.Add(dimension3, "DataItem4")
			Me.mapProduction.DataItemRepository.Add(measure3, "DataItem5")
			...
			Me.mapProduction.Longitude = dimension1
			...
			Me.mapProduction.TooltipDimensions.AddRange(New DevExpress.DashboardCommon.Dimension() { dimension3})
			Me.mapProduction.TooltipMeasures.AddRange(New DevExpress.DashboardCommon.Measure() { measure3})
			...
			Me.mapProduction.Weight = measure2
			...
			Me.dsConsumptionTotal.DataMember = "CountriesTotal"
			Me.dsConsumptionTotal.DataSchema = resources.GetString("dsConsumptionTotal.DataSchema")
			...
			Me.dsConsumptionBySector.DataMember = "CountriesBySector"
			Me.dsConsumptionBySector.DataSchema = resources.GetString("dsConsumptionBySector.DataSchema")
			...
			dashboardLayoutItem1.Weight = 55.982905982905983R
			dashboardLayoutItem2.DashboardItem = Me.pieConsumption
			dashboardLayoutItem2.Weight = 51.020408163265309R
			dashboardLayoutItem3.DashboardItem = Me.chartConsumptionHistory
			dashboardLayoutItem3.Weight = 48.979591836734691R
			...
			dashboardLayoutGroup2.Weight = 44.017094017094017R
