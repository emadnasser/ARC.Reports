...
''' Summary description
''' </summary>
Public Class WebsiteStatisticsDashboard
	Inherits Dashboard
	Private trafficSourceChart As ChartDashboardItem
	Private siteVisitosDataSource As DashboardObjectDataSource
	Private trafficSourceGroup As DashboardItemGroup
	Private trafficSourceFilter As TreeViewDashboardItem
	Private browsersFilter As TreeViewDashboardItem
	Private browsersGroup As DashboardItemGroup
	Private browsersChart As ChartDashboardItem
	''' <summary>
	...
	Private Sub InitializeComponent()
			Dim resources As System.Resources.ResourceManager = Global.Resources.WebsiteStatistics.ResourceManager
...
'			Me.DataLoading += New DevExpress.DashboardCommon.DashboardDataLoadingEventHandler(Me.WebsiteStatisticsDashboard_DataLoading);
	...
	Private Sub WebsiteStatisticsDashboard_DataLoading(ByVal sender As Object, ByVal e As DashboardDataLoadingEventArgs) Handles MyBase.DataLoading
