...
''' Summary description
''' </summary>
Public Class RevenueAnalysisDashboard
	Inherits Dashboard
	Private pivotSalesByState As PivotDashboardItem
	Private dsSales As DashboardObjectDataSource
	Private pieSalesbyCategory As PieDashboardItem
	Private chartSalesbyYear As ChartDashboardItem
	''' <summary>
	...
	Private Sub InitializeComponent()
			Dim resources As System.Resources.ResourceManager = Global.Resources.RevenueAnalysisDashboard.ResourceManager
			...
			rangeInfo21.Value = 0R
			rangeInfo22.Value = 9000000R
			rangeInfo23.Value = 9400000R
			rangeInfo24.Value = 9500000R
			rangeInfo25.Value = 9600000R
			rangeInfo26.Value = 9700000R
			rangeInfo27.Value = 9800000R
			rangeInfo28.Value = 9900000R
			rangeInfo29.Value = 10000000R
			...
			dashboardLayoutItem1.Weight = 34.9600709849157R
			dashboardLayoutItem2.DashboardItem = Me.pieSalesbyCategory
			dashboardLayoutItem2.Weight = 65.0399290150843R
			...
			dashboardLayoutGroup2.Weight = 27.991452991452991R
			dashboardLayoutItem3.DashboardItem = Me.pivotSalesByState
			dashboardLayoutItem3.Weight = 72.008547008547012R
...
'			Me.DataLoading += New DevExpress.DashboardCommon.DashboardDataLoadingEventHandler(Me.RevenueAnalysisDashboard_DataLoading);
	...
	Private Sub RevenueAnalysisDashboard_DataLoading(ByVal sender As Object, ByVal e As DashboardDataLoadingEventArgs) Handles MyBase.DataLoading
