<%@ Page Language="vb" MasterPageFile="FullScreen.master" AutoEventWireup="true" CodeFile="WebsiteStatistics.aspx.vb" Inherits="WebsiteStatistics" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentHolder">
	<dx:ASPxDashboardViewer runat="server" ID="dashboardViewer1"
		DashboardSource="<%#GetType(WebsiteStatisticsDashboard)%>" AllowExportDashboardItems="True"
