<%@ Page Language="vb" MasterPageFile="FullScreen.master" AutoEventWireup="true" CodeFile="RevenueByIndustry.aspx.vb" Inherits="RevenueByIndustry" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentHolder">
	<dx:ASPxDashboardViewer runat="server" ID="dashboardViewer1"
		DashboardSource="<%#GetType(RevenueByIndustryDashboard)%>" AllowExportDashboardItems="True"
