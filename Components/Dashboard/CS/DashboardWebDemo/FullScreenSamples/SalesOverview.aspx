<%@ Page Language="C#" MasterPageFile="FullScreen.master" AutoEventWireup="true" CodeFile="SalesOverview.aspx.cs" Inherits="SalesOverview" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentHolder">
    <dx:ASPxDashboardViewer runat="server" ID="dashboardViewer1" 
        DashboardSource="<%# typeof(SalesOverviewDashboard) %>" AllowExportDashboardItems="True"
