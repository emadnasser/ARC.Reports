<%@ Page Language="C#" MasterPageFile="FullScreen.master" AutoEventWireup="true" CodeFile="SalesPerformance.aspx.cs" Inherits="SalesPerformance" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentHolder">
    <dx:ASPxDashboardViewer runat="server" ID="dashboardViewer1"
        DashboardSource="<%# typeof(SalesPerformanceDashboard) %>" AllowExportDashboardItems="True"
