<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EUTradeOverview.aspx.cs" Inherits="EUTradeOverview"  %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentHolder">
    <dx:ASPxDashboardViewer runat="server" ID="dashboardViewer1"
        DashboardSource="<%# typeof(EUTradeOverviewDashboard) %>" AllowExportDashboardItems="True" Width="100%" Height="800px" ColorScheme="light.compact" 
