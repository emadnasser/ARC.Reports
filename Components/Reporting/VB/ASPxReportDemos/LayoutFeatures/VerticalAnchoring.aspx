<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="VerticalAnchoring.aspx.vb"
	Inherits="LayoutFeatures_VerticalAnchoring" %>
...
<%
	   If IsASPViewer Then
%>
	<dx:ASPxDocumentViewer runat="server" ID="documentViewer" Width="1250px" EnableViewState="False" />
<%
