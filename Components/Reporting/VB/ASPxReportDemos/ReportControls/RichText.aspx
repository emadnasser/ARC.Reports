<%@ Page Language="vb" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="RichText.aspx.vb"
	Inherits="ReportControls_RichText" %>
...
<%
	   If IsASPViewer Then
%>
	<dx:ASPxDocumentViewer runat="server" ID="documentViewer" Width="720px" EnableViewState="False">
