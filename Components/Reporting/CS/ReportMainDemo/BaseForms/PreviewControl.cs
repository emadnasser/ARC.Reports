...
namespace XtraReportsDemos {
    ...
    public class PreviewControl: ModuleControl {
        ...
        public PreviewControl() {
            InitializeComponent();
            if(!documentViewerRibbonController1.AllowDefaultSvgImages.ToBoolean(WindowsFormsSettings.GetAllowDefaultSvgImages())) {
                this.barButtonItem2.ImageUri.Uri = string.Empty;
            }
        }
        ...
        public override void Activate() {
            if(Report != null || DesignMode) return;

            DevExpress.XtraBars.Docking.DockPanel navigationDockPanel = printControl.DockManager.Panels[new System.Guid("6b2e64eb-afd0-4676-bc3d-eca7e99946aa")];
		...
		private void InitializeComponent() {
            ...
            this.ribbonControl1.Size = new System.Drawing.Size(1112, 116);
    ...
    "the document.";
            ...
            this.printControl.Location = new System.Drawing.Point(2, 118);
            this.printControl.Name = "printControl";
            this.printControl.Size = new System.Drawing.Size(1112, 327);
            ...
            this.ribbonStatusBar1.Location = new System.Drawing.Point(2, 445);
            this.ribbonStatusBar1.Name = "ribbonStatusBar1";
            this.ribbonStatusBar1.Ribbon = this.ribbonControl1;
            this.ribbonStatusBar1.Size = new System.Drawing.Size(1112, 27);
            // 
    ...
    "";
            ...
            this.printPreviewBarItem4.Glyph = global::RibbonReportDesigner.PrintRibbonControllerResources.RibbonPrintPreview_Thumbnails;
            this.printPreviewBarItem4.Id = 4;
            this.printPreviewBarItem4.LargeGlyph = global::RibbonReportDesigner.PrintRibbonControllerResources.RibbonPrintPreview_ThumbnailsLarge;
    ...
    "s to the document, click Custom Margins.";
            ...
            this.barButtonItem2.ImageUri.ResourceType = typeof(XtraReportsDemos.PreviewControl);
            this.barButtonItem2.ImageUri.Uri = "resource://XtraReportsDemos.Resources.Designer.svg";
    ...
    "re editable.";
            ...
            this.panelControl1.Size = new System.Drawing.Size(1116, 474);
        ...
        void EditReport(Func<IDesignForm> createForm) {
            ...
            using(XtraReport newReport = XtraReport.FromFile(saveFileName, true)) {
                ...
                ShowDesignerForm(designForm.Form, this.FindForm());
			...
			if(File.Exists(fileName)) {
                ...
                try {
                    ...
                    Form form = FindForm();
                    if(form != null)
                        XtraMessageBox.Show(this.LookAndFeel.ParentLookAndFeel, form, 
                            ex.Message, "Error",
        ...
        static string GetNewFilePath(string repFullName, string ext) {
            ...
            while(i < 10) {
                try {
                    Stream fs = File.Open(path, FileMode.Create, FileAccess.ReadWrite, FileShare.None);
                    fs.Close();
                    return path;
                } catch { }
                i++;
        ...
        void barButtonItem2_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            if(Control.ModifierKeys == Keys.Control)
                ...
                EditReport(() => new RibbonFormWrapper());
        }
    }
    ...
    class StandardFormWrapper: IDesignForm {
        ReportDesigner.MainForm wrappedForm;
    ...
    class RibbonFormWrapper : IDesignForm {
        RibbonReportDesigner.MainForm wrappedForm;
