<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="MasterDetail.aspx.cs"
    Inherits="ReportTypes_MasterDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentHolder" runat="Server">
    ...
    <dx:ASPxDocumentViewer runat="server" ID="documentViewer"
        Width="1046px" OnCacheReportDocument="documentViewer_CacheReportDocument" OnRestoreReportDocumentFromCache="documentViewer_RestoreReportDocumentFromCache"
