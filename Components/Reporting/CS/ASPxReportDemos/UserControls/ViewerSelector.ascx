<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewerSelector.ascx.cs" Inherits="UserControls_ViewerSelectorControl" %>
            ...
            <div class="ContainerWrapper ViewerSelectorContainerWrapper">
                <div class="ThemeContainer ViewerSelectorContainer">
                    <dx:ASPxMenu ID="ViewerSelectorMenu" CssClass="ThemeGroupMenu" runat="server" EnableTheming="false"
                        ...
                        <ItemTextTemplate>
                            <div class="ThemeIco <%# ViewerSelectorState.GetByName((string)Eval("Name")).CssClass %>"></div>
                            <%# ViewerSelectorState.GetByName((string)Eval("Name")).Text %>
                        </ItemTextTemplate>
                    </dx:ASPxMenu>
                    <b class="Clear"></b>
                </div>
