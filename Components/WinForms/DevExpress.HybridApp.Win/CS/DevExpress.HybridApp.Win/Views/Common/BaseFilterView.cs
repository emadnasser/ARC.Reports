...
namespace DevExpress.DevAV.Views {
    public partial class BaseFilterView : XtraUserControl {
        ...
        protected ITileItem CreateTileForFilter(DevExpress.DevAV.ViewModels.FilterViewModelBase.FilterItem filter) {
        ...
        protected void UpdateTileItem(ITileItem tileItem, DevExpress.DevAV.ViewModels.FilterViewModelBase.FilterItem filter) {
