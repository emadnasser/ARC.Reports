...
namespace DevExpress.DevAV.Views {
    ...
    internal static class GridExtension {
        internal static void SetupTileView(this TileView view) {
            ...
            view.OptionsTiles.HorizontalContentAlignment = Utils.HorzAlignment.Near;
            ...
            view.OptionsTiles.VerticalContentAlignment = Utils.VertAlignment.Top;
            view.OptionsTiles.ItemBorderVisibility = XtraEditors.TileItemBorderVisibility.Never;
        }
        internal static void SetupCollectionGrid(this GridView view) {
            ...
            view.OptionsMenu.ShowAddNewSummaryItem = Utils.DefaultBoolean.False;
            view.OptionsMenu.EnableFooterMenu = false;
            view.OptionsSelection.EnableAppearanceFocusedCell = false;
            view.OptionsView.ShowFilterPanelMode = XtraGrid.Views.Base.ShowFilterPanelMode.Never;
            view.OptionsView.ShowFooter = true;
            view.OptionsView.ShowGroupPanel = false;
            view.OptionsView.ShowIndicator = false;
            view.Appearance.FooterPanel.TextOptions.WordWrap = Utils.WordWrap.Wrap;
            view.Appearance.GroupPanel.TextOptions.WordWrap = Utils.WordWrap.Wrap;
        }
