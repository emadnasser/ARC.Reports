...
Namespace DevExpress.DevAV.Modules
    ...
    Partial Public Class OrdersFilterPaneCollapsed
        Inherits BaseModuleControl
        Implements ISupportCompactLayout

        Private presenterCore As OrderFilterPanePresenter
        ...
        Public ReadOnly Overloads Property ViewModel() As OrdersFilterTreeViewModel
            ...
            End Get
        End Property
        Public ReadOnly Property Presenter() As OrderFilterPanePresenter
            Get
                Return presenterCore
            End Get
        End Property
        Protected Overridable Function CreatePresenter() As OrderFilterPanePresenter
