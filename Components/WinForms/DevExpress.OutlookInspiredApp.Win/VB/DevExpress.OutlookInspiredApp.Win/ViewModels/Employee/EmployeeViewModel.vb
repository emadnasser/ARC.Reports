...
Namespace DevExpress.DevAV.ViewModels
  ...
  Public Partial Class EmployeeViewModel
    ...
    ''' </summary>
    Public ReadOnly Property EmployeeAssignedTasksDetails As CollectionViewModel(Of EmployeeTask, long, IDevAVDbUnitOfWork)
      Get
        Return GetDetailsCollectionViewModel(Function(ByVal x As EmployeeViewModel) x.EmployeeAssignedTasksDetails, Function(ByVal x) x.Tasks, Function(ByVal x) x.AssignedEmployeeId, Sub(ByVal x, ByVal key) x.AssignedEmployeeId = key)
      End Get
    End Property    
    ''' <summary>
