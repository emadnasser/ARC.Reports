...
Namespace DevExpress.DevAV.ViewModels
    ...
    Public Class EmployeeMapViewModel
        ...
        Protected Overrides Sub OnEntityChanged()
            PointA = MapViewModelBase.DevAVHomeOffice
            PointB = If(Entity IsNot Nothing, Entity.Address, MapViewModelBase.DevAVHomeOffice)
            Me.RaisePropertyChanged(Function(x) x.FullName)
