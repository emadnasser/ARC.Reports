...
Namespace DevExpress.DevAV.ViewModels
    ...
    Public NotInheritable Class AnalysisPeriod
        ...
        Public Shared ReadOnly Start As New Date(Date.Now.Year - 3, 10, 1)
        Public Shared ReadOnly [End] As New Date(Date.Now.Year, 09, 30)
    ...
    Public Module ProductsAnalysis
        ...
        Public Function GetFinancialReport(ByVal UnitOfWork As IDevAVDbUnitOfWork) As IEnumerable(Of Item)
            ...
            Return From oi In orderItems
                   ...
                   Select New Item With {.ProductName = GroupKey.Product.Name, .Year = AnalysisPeriod.Start.Year + GroupKey.FY, .Month = AnalysisPeriod.Start.Month, .Total = If(g.Select(Function(o) CType(o.Total, Decimal?)).Sum(), 0)}
        End Function
        <System.Runtime.CompilerServices.Extension> _
        Public Function GetFinancialData(ByVal UnitOfWork As IDevAVDbUnitOfWork) As IEnumerable(Of Item)
            ...
            Return From oi In orderItems
                   ...
                   Select New Item With {.ProductCategory = GroupKey.Category, .Year = GroupKey.Year, .Month = GroupKey.Month, .Total = If(g.Select(Function(o) CType(o.Total, Decimal?)).Sum(), 0)}
        End Function
        Public Class Item
