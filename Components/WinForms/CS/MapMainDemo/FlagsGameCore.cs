...
namespace DevExpress.Demos.FlagsGameCore {
    ...
    public class FlagsGameCore : IDisposable {
        ...
        readonly string flagsDirectory;
        ...
        public FlagsGameCore(List<string> countriesList, string flagsDirectory) {
        ...
        Image GetCountryFlag(string countryName) {
            string flagPath = Path.Combine(flagsDirectory, countryName.Replace(' ', '_') + FlagExtension);
