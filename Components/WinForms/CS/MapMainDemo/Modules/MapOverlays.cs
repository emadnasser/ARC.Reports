...
namespace DevExpress.XtraMap.Demos {
    public partial class MapOverlays : MapTutorialControl {
        ...
        readonly string flagsDirectoryPath = DemoUtils.GetRelativeDirectoryPath(@"Images\Flags\Big");
        ...
        void CreateGameCore(List<string> countriesNames) {
            this.gameCore = new FlagsGameCore(countriesNames, flagsDirectoryPath);
