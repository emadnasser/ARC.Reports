...
namespace DevExpress.XtraPivotGrid.Demos {
	public class DemosInfo : ModulesInfo {
        public static void Show(string name, DevExpress.XtraEditors.GroupControl group, DevExpress.Utils.Frames.ApplicationCaption caption, Control description, PivotGridRibbonMenuManager manager) {
