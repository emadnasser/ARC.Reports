...
namespace DevExpress.DXperience.Demos {
    ...
    public static class CodeExampleDemoUtils {
        ...
        public static string GetExamplePath(string exampleFolderName) {//"CodeExamples"
    ...
    public abstract class ExampleFinder {
        ...
        public List<CodeExample> Process(FileInfo fileWithExample) {
            ...
            string code;
            using (FileStream stream = File.Open(fileWithExample.FullName, FileMode.Open, FileAccess.Read, FileShare.Read)) {
