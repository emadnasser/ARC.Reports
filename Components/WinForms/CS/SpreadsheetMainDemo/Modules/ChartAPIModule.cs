...
namespace DevExpress.XtraSpreadsheet.Demos {
    public class ChartAPIModule : SpreadSheetTutorialControlBase {
        ...
        public ChartAPIModule() {
            InitializeComponent();
            string examplePath = CodeExampleDemoUtils.GetExamplePath("CodeExamples\\Charts");
        ...
        void evaluator_OnAfterCompile(object sender, OnAfterCompileEventArgs args) {
            ...
            if (active.Charts.Count > 0) {
                Chart chart = active.Charts[active.Charts.Count - 1];
                active.SelectedCell = chart.BottomRightCell.Offset(5, 5);
            }
            else {
        ...
        private void InitializeComponent() {
            ...
            this.spreadsheet.Options.View.Charts.Antialiasing = DocumentCapability.Enabled;
