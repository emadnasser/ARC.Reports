...
namespace DevExpress.XtraSpreadsheet.Demos {
    public partial class SpreadsheetPreview : UserControl {
        ...
        SpreadhsheetPreviewZoom previewZoom = SpreadhsheetPreviewZoom.Default;
        ...
        public SpreadhsheetPreviewZoom PreviewZoom {
            get { return previewZoom; }
            set {
                if (previewZoom == value)
                    return;
                previewZoom = value;
                UpdatePreview();
            }
        ...
        void UpdateWorkbookSinglePreview() {
            ...
            link.CreateDocument();
            UpdateDocumentViewerZoom(this.documentViewerSinglePreview);
        }        
        ...
        private void UpdateDocumentViewerZoom(XtraPrinting.Preview.DocumentViewer documentViewer) {
