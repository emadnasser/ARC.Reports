...
namespace DevExpress.MVVM.Demos.Views {
    ...
    public partial class Accounts : XtraUserControl {
        public Accounts() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<DevExpress.MVVM.Demos.ViewModels.AccountCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as DevExpress.MVVM.Demos.Model.Account,
