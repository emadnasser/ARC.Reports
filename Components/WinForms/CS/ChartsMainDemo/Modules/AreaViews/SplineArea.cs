...
namespace DevExpress.XtraCharts.Demos.AreaViews {
    public partial class SplineAreaDemo : ChartDemoBase2D {
        ChartControl chart;
        ...
        public SplineAreaDemo() {
            InitializeComponent();
        }

        void checkEditShowMarkers_CheckedChanged(object sender, EventArgs e) {
            SplineAreaSeriesView view = ChartControl.SeriesTemplate.View as SplineAreaSeriesView;
            if (view != null)
        ...
        protected override void InitControls() {
            ...
            checkEditShowMarkers.Checked = ((SplineAreaSeriesView)ChartControl.SeriesTemplate.View).MarkerVisibility == DefaultBoolean.True;
