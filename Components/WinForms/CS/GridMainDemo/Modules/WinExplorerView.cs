...
namespace DevExpress.XtraGrid.Demos {
    public partial class ExplorerView : TutorialControl, IFileSystemNavigationSupports {
        string currentPath;
        public ExplorerView() {
            InitializeComponent();
        ...
        void UpdateNavigationPanelContent() {
            EditSearch.Height = BreadCrumb.Height;
            BreadCrumb.Location = new Point(BreadCrumb.Location.X, (navigationPanel.Height - BreadCrumb.Height) / 2);
            EditSearch.Location = new Point(EditSearch.Location.X, (navigationPanel.Height - EditSearch.Height) / 2);
        }
