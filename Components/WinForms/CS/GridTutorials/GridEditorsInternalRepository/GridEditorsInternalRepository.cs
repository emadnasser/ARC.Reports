...
namespace DevExpress.XtraGrid.Demos.Tutorials {
    ...
    /// </summary>
    public partial class GridEditorsInternalRepository : TutorialControl {
        public GridEditorsInternalRepository() {
            //
        ...
        #endregion
        private void GridEditorsInternalRepository_Load(object sender, System.EventArgs e) {
            InitData();
            InitViewLayout();
            InitTabEditors();
        }
        ...
        private void xtraTabControl1_SelectedPageChanged(object sender, DevExpress.XtraTab.TabPageChangedEventArgs e) {
            foreach(DevExpress.XtraGrid.Columns.GridColumn col in advBandedGridView1.Columns)
                if(col.VisibleIndex != -1)
                    if(col.Caption == xtraTabControl1.SelectedTabPage.Text) {
