...
Namespace DevExpress.VideoRent.Win.Forms
	Partial Public Class frmMovieAddArtist
		...
		Private Sub InitializeComponent()
			...
			Me.lueArtist = New DevExpress.XtraEditors.GridLookUpEdit()
			...
			CType(Me.lueArtist.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
			...
			Me.lcMain.Controls.Add(Me.lueArtist)
			...
			' lciArtist
			' 
			Me.lciArtist.Control = Me.lueArtist
			...
			Me.lciArtist.Text = "Actor/Crew:"
			Me.lciArtist.TextSize = New System.Drawing.Size(59, 13)
			' 
			' lueArtist
			' 
			Me.lueArtist.Location = New System.Drawing.Point(65, 2)
			Me.lueArtist.Name = "lueArtist"
			Me.lueArtist.Properties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() { New DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo), New DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Plus)})
			Me.lueArtist.Properties.NullText = ""
			Me.lueArtist.Properties.PopupSizeable = False
			Me.lueArtist.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.Standard
			Me.lueArtist.Properties.View = Me.gridLookUpEdit1View
			Me.lueArtist.Size = New System.Drawing.Size(325, 20)
			Me.lueArtist.StyleController = Me.lcMain
			Me.lueArtist.TabIndex = 4
'			Me.lueArtist.ButtonClick += New DevExpress.XtraEditors.Controls.ButtonPressedEventHandler(Me.lueArtist_ButtonClick);
			' 
			' gridLookUpEdit1View
			' 
			...
			Me.lciLine.CustomizationFormText = "Line"
			...
			Me.lciLine.TextSize = New System.Drawing.Size(59, 13)
			' 
			' lueLine
			' 
			Me.lueLine.Location = New System.Drawing.Point(65, 26)
			...
			Me.lueLine.Size = New System.Drawing.Size(325, 20)
			Me.lueLine.StyleController = Me.lcMain
			Me.lueLine.TabIndex = 5
			' 
			' meDescription
			' 
			Me.meDescription.Location = New System.Drawing.Point(65, 50)
			Me.meDescription.Name = "meDescription"
			Me.meDescription.Size = New System.Drawing.Size(325, 172)
			...
			Me.lciDescription.TextSize = New System.Drawing.Size(59, 13)
			' 
			' frmMovieAddArtist
			' 
			...
			CType(Me.lueArtist.Properties, System.ComponentModel.ISupportInitialize).EndInit()
		...
		Private WithEvents lueArtist As DevExpress.XtraEditors.GridLookUpEdit
