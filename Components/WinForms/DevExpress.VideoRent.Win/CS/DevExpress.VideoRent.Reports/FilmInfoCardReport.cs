...
namespace DevExpress.VideoRent.Reports {
    public partial class FilmInfoCardReport : ReportBase {
        const string filmListParameterName = "filmListParameter";
        const char separatorChar = ';';
        string separatorString = new string(new char[] { separatorChar, ' ' });
        ...
        CheckedComboBoxEdit CreateCheckedComboBoxEdit() {
        ...
        CheckedComboBoxEdit FindEditor(string parameterName) {
        ...
        bool AreAllItemsChecked(CheckedComboBoxEdit editor) {
        ...
        void xrBarCode2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e) {
        ...
        void xpCollectionMovieItems_ResolveSession(object sender, ResolveSessionEventArgs e) {
            e.Session = Session;
        }
