...
namespace DevExpress.VideoRent.Win {
    public class ElementConstStringLoader {
        ...
        public static void LoadConstStringsForAbout(object element) {
            ...
            SetPropertyPathValue(element, "lcLink1.LinkText", ConstStrings.Get("DXLink"));
            SetPropertyPathValue(element, "lcLink2.Text", ConstStrings.Get("WelcomeLink2"));
            SetPropertyPathValue(element, "lcLink2.LinkText", ConstStrings.Get("TrialsLink"));
            SetPropertyPathValue(element, "lcLink3.Text", ConstStrings.Get("WelcomeLink3"));
            SetPropertyPathValue(element, "lcLink3.LinkText", ConstStrings.Get("PurchaseLink"));
