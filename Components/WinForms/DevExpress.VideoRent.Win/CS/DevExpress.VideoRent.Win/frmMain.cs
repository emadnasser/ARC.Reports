...
namespace DevExpress.VideoRent.Win {
    public partial class frmMain : frmMainBase, IFormWithLayoutManager {
        ...
        static BarButtonItem CreateDesignerButton() {
            ...
            buttonItem.Glyph = ResourceImageHelper.CreateImageFromResources("DevExpress.VideoRent.Resources.Images.Action_Report_ShowDesigner.png", typeof(DevExpress.VideoRent.Resources.ImagesHelper).Assembly);
            buttonItem.LargeGlyph = ResourceImageHelper.CreateImageFromResources("DevExpress.VideoRent.Resources.Images.Action_Report_ShowDesigner_32x32.png", typeof(DevExpress.VideoRent.Resources.ImagesHelper).Assembly);
            return buttonItem;
        }
        #endregion
