...
namespace DevExpress.VideoRent.Win {
    ...
    public class FormLayoutManager {
        ...
        public void ShowOpenImageDialog(DevExpress.VideoRent.Win.Forms.frmOpenImageDialog.SetImageDelegate imageDelegate, Form parent) {
    ...
    public class WinFormProperties {
        ...
        public void LoadChartPaletteAppearance(ChartAppearanceManager chartManager) {
            ...
            string[] styles = CurrentProperty.ChartPaletteAppearance.Split('@');
