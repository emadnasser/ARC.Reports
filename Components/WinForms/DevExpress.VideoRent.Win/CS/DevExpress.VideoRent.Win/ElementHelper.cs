...
using DevExpress.VideoRent.Win.Modules;
...
namespace DevExpress.VideoRent.Win {
    ...
    public class EditorHelper {
        ...
        static int GetPersonImages(PersonGender gender) {
        ...
        public static RepositoryItemComboBox CreateLocationComboBox(RepositoryItemComboBox edit, RepositoryItemCollection collection) {
            ...
            for(int i = 1; i <= ReferenceData.ShelvesCount; i++)
                ret.Items.Add(string.Format(VideoRent.Properties.Resources.ShelfPattern, i));
            return ret;
        }
        ...
        static string GetRatingString(MovieRating rating) {
