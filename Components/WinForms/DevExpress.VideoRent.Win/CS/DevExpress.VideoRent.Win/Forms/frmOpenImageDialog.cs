...
namespace DevExpress.VideoRent.Win.Forms {
    public partial class frmOpenImageDialog : XtraForm {
        class FileAssociatedIcons {
            ...
            static Image GetIcon(string type, string file) {
            ...
            static string GetFileType(string file, bool folderOpen) {
        ...
        SetImageDelegate resultImage;
        static FileAssociatedIcons icons = new FileAssociatedIcons();
        string currentPath;
        Size maxImageSize = new Size(3000, 2000);
        Timer nodeChangedTimer;
        ...
        string[] pictureExtensions = { ".png", ".bmp", ".dib", ".jpg", ".jpeg", ".jpe", ".jfif", ".gif", ".tif", ".tiff", ".ico" };
        ...
        void nodeChangedTimer_Tick(object sender, EventArgs e) {
