...
namespace DevExpress.VideoRent.Win {
    public class TutorialControl : TutorialControlBase {
        ...
        internal protected virtual void ShowTutorial() { }
        #region Editing
    ...
    public class ChartExportTutorialControl : TutorialControl {
        ...
        PivotGridControl MainPivotGrid {
            get {
        ...
        void TransposePivotGrid(PivotGridControl pivotGrid) {
        ...
        CompositeLink GetPrintableLink() {
