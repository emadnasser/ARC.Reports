...
namespace DevExpress.VideoRent.Win.ModulesScheduler {
    public partial class RentalCalendar : TutorialControl {
        ...
        void SetupApointmentSearchInterval() {
            this.schedulerControl1.OptionsView.NavigationButtons.AppointmentSearchInterval = TimeSpan.FromDays(100);
        }
        void xpcRents_ResolveSession(object sender, DevExpress.Xpo.ResolveSessionEventArgs e) {
            e.Session = Session;
        }
        void xpcCustomers_ResolveSession(object sender, DevExpress.Xpo.ResolveSessionEventArgs e) {
            e.Session = Session;
        }

        void schedulerStorage1_FilterAppointment(object sender, DevExpress.XtraScheduler.PersistentObjectCancelEventArgs e) {
        ...
        private void schedulerControl1_InitAppointmentImages(object sender, AppointmentImagesEventArgs e) {
            ...
            ActiveRentType rentType = (apt.StatusKey == null) ? ActiveRentType.None : (ActiveRentType)apt.StatusKey;
