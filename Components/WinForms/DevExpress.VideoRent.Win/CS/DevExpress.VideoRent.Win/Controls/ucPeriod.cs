...
namespace DevExpress.VideoRent.Win.Controls {
    public partial class ucPeriod : XtraUserControl {
        ...
        void CreatePeriodItems() {
            icbPeriod.Properties.Items.Add(new ImageComboBoxItem(DevExpress.VideoRent.Reports.Properties.Resources.PeriodCustom, 0, -1));
            icbPeriod.Properties.Items.Add(new ImageComboBoxItem(DevExpress.VideoRent.Reports.Properties.Resources.PeriodMonth, 1, -1));
            icbPeriod.Properties.Items.Add(new ImageComboBoxItem(DevExpress.VideoRent.Reports.Properties.Resources.PeriodThreeMonths, 3, -1));
            icbPeriod.Properties.Items.Add(new ImageComboBoxItem(DevExpress.VideoRent.Reports.Properties.Resources.PeriodSixMonths, 6, -1));
            icbPeriod.Properties.Items.Add(new ImageComboBoxItem(DevExpress.VideoRent.Reports.Properties.Resources.PeriodYear, 12, -1));
            icbPeriod.Properties.Items.Add(new ImageComboBoxItem(DevExpress.VideoRent.Reports.Properties.Resources.PeriodTwoYears, 24, -1));
            icbPeriod.Properties.Items.Add(new ImageComboBoxItem(DevExpress.VideoRent.Reports.Properties.Resources.PeriodFiveYears, 60, -1));
            icbPeriod.Properties.Items.Add(new ImageComboBoxItem(DevExpress.VideoRent.Reports.Properties.Resources.PeriodTenYears, 120, -1));
        }
