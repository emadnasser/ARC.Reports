...
Namespace SnapDemos
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class CustomerOrdersDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Function AddCustomerOrdersRow(ByVal CustomerID As String, ByVal EmployeeID As Integer, ByVal OrderDate As Date, ByVal RequiredDate As Date, ByVal ShippedDate As Date, ByVal ShipVia As Integer, ByVal Freight As Decimal, ByVal ShipName As String, ByVal ShipAddress As String, ByVal ShipCity As String, ByVal ShipRegion As String, ByVal ShipPostalCode As String, ByVal ShipCountry As String, ByVal ContactName As String) As CustomerOrdersRow
...
Namespace SnapDemos.nwindDataSetTableAdapters
	...
	Partial Public Class ShippersTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        ShipperID, CompanyName, Phone" & vbCrLf & "FROM            Shippers"
	...
	Partial Public Class OrdersTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT        OrderID, CustomerID, EmployeeID, OrderDate, RequiredDate, ShippedDa" & "te, ShipVia, Freight, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCod" & "e, " & vbCrLf & "                         ShipCountry" & vbCrLf & "FROM            Orders"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
		End Sub
	...
	Partial Public Class Order_DetailsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT        Discount, OrderID, ProductID, Quantity, UnitPrice, Quantity * UnitP" & "rice AS SubTotal" & vbCrLf & "FROM            [Order Details]"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
		End Sub
		...
		Public Overridable Function Delete(ByVal Original_Discount As Single, ByVal Original_OrderID? As Integer, ByVal Original_ProductID As Integer, ByVal Original_Quantity As Short, ByVal Original_UnitPrice As Decimal) As Integer
			...
			If (Original_OrderID.HasValue = True) Then
				Me.Adapter.DeleteCommand.Parameters(2).Value = (CInt(Original_OrderID.Value))
			Else
				Me.Adapter.DeleteCommand.Parameters(2).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.DeleteCommand.Parameters(3).Value = (CInt(Original_ProductID))
		...
		Public Overridable Function Insert(ByVal Discount As Single, ByVal OrderID? As Integer, ByVal ProductID As Integer, ByVal Quantity As Short, ByVal UnitPrice As Decimal) As Integer
			...
			If (OrderID.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(1).Value = (CInt(OrderID.Value))
			Else
				Me.Adapter.InsertCommand.Parameters(1).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.InsertCommand.Parameters(2).Value = (CInt(ProductID))
		...
		Public Overridable Function Update(ByVal Discount As Single, ByVal OrderID? As Integer, ByVal ProductID As Integer, ByVal Quantity As Short, ByVal UnitPrice As Decimal, ByVal Original_Discount As Single, ByVal Original_OrderID? As Integer, ByVal Original_ProductID As Integer, ByVal Original_Quantity As Short, ByVal Original_UnitPrice As Decimal) As Integer
			...
			If (OrderID.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(1).Value = (CInt(OrderID.Value))
			Else
				Me.Adapter.UpdateCommand.Parameters(1).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(2).Value = (CInt(ProductID))
			...
			If (Original_OrderID.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(7).Value = (CInt(Original_OrderID.Value))
			Else
				Me.Adapter.UpdateCommand.Parameters(7).Value = Global.System.DBNull.Value
			End If
			Me.Adapter.UpdateCommand.Parameters(8).Value = (CInt(Original_ProductID))
	...
	Partial Public Class CategoriesTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT        Categories.*" & vbCrLf & "FROM            Categories"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
		End Sub
	...
	Partial Public Class CustomersTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT        Customers.*" & vbCrLf & "FROM            Customers"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
		End Sub
	...
	Partial Public Class EmployeesTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT        Employees.*" & vbCrLf & "FROM            Employees"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
		End Sub
	...
	Partial Public Class SuppliersTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = "SELECT        Suppliers.*" & vbCrLf & "FROM            Suppliers"
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
		End Sub
	...
	Partial Public Class TableAdapterManager
		...
		Private Class SelfReferenceComparer
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Private Function IComparerGeneric_Compare(ByVal row1 As Global.System.Data.DataRow, ByVal row2 As Global.System.Data.DataRow) As Integer Implements System.Collections.Generic.IComparer(Of Global.System.Data.DataRow).Compare
