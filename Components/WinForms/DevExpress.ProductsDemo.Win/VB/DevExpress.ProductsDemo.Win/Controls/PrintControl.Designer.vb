...
Namespace DevExpress.ProductsDemo.Win.Controls
	Partial Public Class PrintControl
		...
		Private Sub InitializeComponent()
			...
			Me.printerLabel = New DevExpress.ProductsDemo.Win.BackstageViewLabel()
			...
			Me.backstageViewLabel1 = New DevExpress.ProductsDemo.Win.BackstageViewLabel()
			Me.backstageViewLabel2 = New DevExpress.ProductsDemo.Win.BackstageViewLabel()
...
'			Me.printButton.Click += New System.EventHandler(Me.printButton_Click)
			...
			Me.lciPrintStyle.TextToControlDistance = 0
...
'			Me.zoomTextEdit.EditValueChanged += New System.EventHandler(Me.zoomTextEdit_EditValueChanged)
			...
			Me.pageButtonEdit.Properties.AutoHeight = (CBool(resources.GetObject("pageButtonEdit.Properties.AutoHeight")))
			Me.pageButtonEdit.Properties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() { New DevExpress.XtraEditors.Controls.EditorButton((CType(resources.GetObject("pageButtonEdit.Properties.Buttons"), DevExpress.XtraEditors.Controls.ButtonPredefines)), resources.GetString("pageButtonEdit.Properties.Buttons1"), (CInt(Fix(resources.GetObject("pageButtonEdit.Properties.Buttons2")))), (CBool(resources.GetObject("pageButtonEdit.Properties.Buttons3"))), (CBool(resources.GetObject("pageButtonEdit.Properties.Buttons4"))), (CBool(resources.GetObject("pageButtonEdit.Properties.Buttons5"))), (CType(resources.GetObject("pageButtonEdit.Properties.Buttons6"), DevExpress.XtraEditors.ImageLocation)), Nothing, New DevExpress.Utils.KeyShortcut(System.Windows.Forms.Keys.None), serializableAppearanceObject1, resources.GetString("pageButtonEdit.Properties.Buttons7"), Nothing, Nothing, (CBool(resources.GetObject("pageButtonEdit.Properties.Buttons8")))), New DevExpress.XtraEditors.Controls.EditorButton((CType(resources.GetObject("pageButtonEdit.Properties.Buttons9"), DevExpress.XtraEditors.Controls.ButtonPredefines)))})
