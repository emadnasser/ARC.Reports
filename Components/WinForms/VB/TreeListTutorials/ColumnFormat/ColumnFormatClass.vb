...
Namespace DevExpress.XtraTreeList.Demos.Tutorials
	Public Class ColumnFormatRecord
		...
		Private lenght_Renamed As Long
		Private purchaseDate_Renamed As DateTime
		Private number_Renamed As Integer

		Public Sub New(ByVal payment_Renamed As Double, ByVal lenght_Renamed As Long, ByVal purchaseDate_Renamed As DateTime, ByVal number_Renamed As Integer)
			Me.payment_Renamed = payment_Renamed
			Me.lenght_Renamed = lenght_Renamed
		...
		Public Property Lenght() As Long
			Get
				Return lenght_Renamed
			End Get
			Set
				lenght_Renamed = Value
			End Set
		End Property
