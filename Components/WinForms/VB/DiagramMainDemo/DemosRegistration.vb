...
Namespace DevExpress.XtraDiagram.Demos
    Public Class DemosInfo
        ...
        Public Shared Sub ShowDiagramModule(ByVal name As String, ByVal group As GroupControl, ByVal caption As ApplicationCaption, ByVal manager As RibbonMenuManager)
            ...
            Try
                ...
                Dim diagramTutorial As DiagramTutorialControl = TryCast(item.TModule, DiagramTutorialControl)
                If diagramTutorial IsNot Nothing Then
