...
Namespace XtraPrintingDemos
    ...
    Partial Public Class nwindDataSet
        ...
        Partial Public Class ProductsDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>
            Public Function AddProductsRow(ByVal ProductName As String, ByVal parentCategoriesRowByCategoriesProducts As CategoriesRow, ByVal CategoryName As String) As ProductsRow
                Dim rowProductsRow As ProductsRow = (DirectCast(Me.NewRow(), ProductsRow))
                Dim columnValuesArray() As Object = { Nothing, ProductName, Nothing, CategoryName}
        ...
        Partial Public Class ProductsRow
            ...
            Public Property CategoryName() As String
                Get
                    Try
                        Return (DirectCast(Me(Me.tableProducts.CategoryNameColumn), String))
                    Catch e As Global.System.InvalidCastException
...
Namespace XtraPrintingDemos.nwindDataSetTableAdapters
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        Products.ProductID, Products.ProductName, Products.CategoryID, Cate" & "gories.CategoryName" & ControlChars.CrLf & "FROM            (Products INNER JOIN" & ControlChars.CrLf & "                     " & "    Categories ON Products.CategoryID = Categories.CategoryID)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
