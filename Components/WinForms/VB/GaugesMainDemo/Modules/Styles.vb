...
Namespace DevExpress.XtraGauges.Demos
    Partial Public Class GaugesStyles
        Inherits TutorialControl

        Private animationLockCounterCore As Integer = 0
        Private timer As Timer
        Private Rnd As Random = New Random(DateTime.Now.Millisecond)
        ...
        Sub DoAnimation(ByVal gauge As GaugeControl)
            For Each gb As DevExpress.XtraGauges.Win.Base.BaseGaugeWin In gauge.Gauges
            ...
            Next gb
        End Sub
        Sub gaugeControl21_Click(ByVal sender As Object, ByVal e As EventArgs) Handles gaugeControl21.Click

        End Sub
        Overloads Sub OnLoad(ByVal sender As Object, ByVal e As EventArgs)
            timer = New Timer()
            timer.Interval = 166
