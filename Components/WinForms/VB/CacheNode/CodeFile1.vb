...
Namespace CacheNode
	Public Class CacheNode
		Inherits DataCacheNode
		Public Sub New()
			MyBase.New(CType(Activator.GetObject(GetType(ICachedDataStore), XpoDefault.ActiveConnectionString), ICachedDataStore))
		End Sub
	End Class
	...
	Friend Class Program
		...
		Shared Sub Main(ByVal args As String())
			Try
				ParseArgs(args)
				If XpoDefault.ConnectionString Is Nothing Then
		...
		Public Shared Sub ConfigureRemoting()
			...
			If RemotingParametersPassed Then
				...
				RemotingConfiguration.RegisterWellKnownServiceType(GetType(CacheNode), ObjectUri, WellKnownObjectMode.Singleton)
			Else
