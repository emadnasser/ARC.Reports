...
Namespace DevExpress.XtraRichEdit.Demos
	Public Class DemosInfo
		...
		Public Shared Overloads Sub ShowModule(ByVal name As String, ByVal groupControl As DevExpress.XtraEditors.GroupControl, ByVal caption As DevExpress.Utils.Frames.ApplicationCaption, ByVal manager As RichEditRibbonMenuManager)
