...
Namespace DevExpress.XtraTreeList.Demos
	Public Class DemosInfo
        ...
        Public Overloads Shared Sub ShowModule(ByVal name As String, ByVal group As DevExpress.XtraEditors.GroupControl, ByVal caption As DevExpress.Utils.Frames.ApplicationCaption, ByVal manager As TreeListRibbonMenuManager)
