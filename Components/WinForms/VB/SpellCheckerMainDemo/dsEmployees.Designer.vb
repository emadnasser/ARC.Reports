...
Partial Public Class dsEmployees
    ...
    Partial Public Class EmployeesDataTable
        ...
        Public Overloads Function AddEmployeesRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {Address, BirthDate, City, Country, Nothing, Extension, FirstName, HireDate, HomePhone, LastName, Notes, Photo, PostalCode, _Region, ReportsTo, Title, TitleOfCourtesy}
