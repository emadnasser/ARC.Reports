...
Namespace DevExpress.XtraSpellChecker.Demos
	...
	Partial Public Class CheckTextBox
		...
		Protected Overrides Sub OnCheckedChanged(ByVal sender As Object, ByVal e As EventArgs)
			...
			Else
				barManager1.SetPopupContextMenu(textBox1, Nothing)
			End If
		End Sub
		Protected Overrides Function GetActiveControl() As Control
			Return textBox1
		End Function
		Protected Sub OnEditControlKeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles textBox1.KeyDown
