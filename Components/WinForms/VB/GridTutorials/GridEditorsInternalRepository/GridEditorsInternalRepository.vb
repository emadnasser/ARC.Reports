...
Namespace DevExpress.XtraGrid.Demos.Tutorials
    ''' <summary>
    ''' Summary description for GridEditorsInternalRepository.
    ''' </summary>
    Partial Public Class GridEditorsInternalRepository
...
#Region "Init"
        ...
        End Sub
#End Region
        Private Sub GridEditorsInternalRepository_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
            InitData()
            InitViewLayout()
            InitTabEditors()
        End Sub
        ...
        Private Sub InitEditors()
            ...
            '<gridControl1>
            'Adding items to the internal grid editor repository.
            Me.gridControl1.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() {itemPictureEdit, itemRadioGroup, itemSpinEdit, itemCalcEdit, itemImageComboBox, itemTextEdit, itemCheckEdit, itemDateEdit})
