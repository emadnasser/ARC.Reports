...
Namespace DevExpress.XtraCharts.Demos.AreaViews
	Partial Public Class AreaDemo
		...
		Private Sub comboTransparencies_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles comboTransparencies.SelectedIndexChanged
			Dim view As AreaSeriesView = TryCast(ChartControl.SeriesTemplate.View, AreaSeriesView)
		...
		Protected Overrides Sub InitControls()
			...
			checkEditShowMarkers.Checked = (CType(ChartControl.SeriesTemplate.View, AreaSeriesView)).MarkerVisibility = DefaultBoolean.True
