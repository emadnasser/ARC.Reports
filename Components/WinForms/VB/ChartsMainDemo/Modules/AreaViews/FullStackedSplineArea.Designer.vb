...
Namespace DevExpress.XtraCharts.Demos.AreaViews
	Partial Public Class FullStackedSplineAreaDemo
		...
		Private Sub InitializeComponent()
			...
			Dim fullStackedSplineAreaSeriesView1 As New DevExpress.XtraCharts.FullStackedSplineAreaSeriesView()
			...
			Me.chart.SeriesTemplate.CrosshairLabelPattern = "{S}: {V} ({VP:0.00%})"
			Me.chart.SeriesTemplate.ValueDataMembersSerializable = "Sales"
			Me.chart.SeriesTemplate.View = fullStackedSplineAreaSeriesView1
...
'			Me.checkValueAsPercent.CheckedChanged += New System.EventHandler(Me.checkValueAsPercent_CheckedChanged);
			...
			Me.Name = "FullStackedSplineAreaDemo"
