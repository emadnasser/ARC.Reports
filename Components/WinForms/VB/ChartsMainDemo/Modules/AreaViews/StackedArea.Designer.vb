...
Namespace DevExpress.XtraCharts.Demos.AreaViews
	Partial Public Class StackedAreaDemo
		...
		Private Sub InitializeComponent()
			...
			Me.chart.SeriesTemplate.CrosshairLabelPattern = "{S}: ${V}M"
			...
			Me.chart.SeriesTemplate.View = stackedAreaSeriesView1
