...
Namespace DevExpress.XtraCharts.Demos.RadarPolarViews
	Partial Public Class RadarRangeAreaDemo
		...
		Private ReadOnly Property View() As RadarRangeAreaSeriesView
			Get
				Return If(Series IsNot Nothing, TryCast(Series.View, RadarRangeAreaSeriesView), Nothing)
			End Get
		End Property
		...
		Public Sub New()
			InitializeComponent()
			Series.CrosshairLabelPattern = "Month: {A:MMMM}" & Constants.vbLf & "2007: {V1:0.00}%" & Constants.vbLf & "2008: {V2:0.00}%"
		End Sub
