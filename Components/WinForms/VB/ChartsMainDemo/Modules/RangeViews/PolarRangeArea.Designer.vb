...
Namespace DevExpress.XtraCharts.Demos.RadarPolarViews
	Partial Public Class PolarRangeAreaDemo
		...
		Private Sub InitializeComponent()
			...
			Dim polarRangeAreaSeriesView1 As New DevExpress.XtraCharts.PolarRangeAreaSeriesView()
			...
			' checkEditShowLabels
			' 
			Me.checkEditShowLabels.Location = New System.Drawing.Point(595, 38)
...
'			Me.comboBoxEditMinMarkerSize.SelectedIndexChanged += New System.EventHandler(Me.comboBoxEditMinMarkerSize_SelectedIndexChanged);
			...
			polarRangeAreaSeriesView1.Marker2Visibility = DevExpress.Utils.DefaultBoolean.False
			polarRangeAreaSeriesView1.SeriesAnimation = circularSeriesLinearUnwindAnimation1
			...
			polarRangeAreaSeriesView1.SeriesPointAnimation = circularMarkerSlideAnimation1
			series1.View = polarRangeAreaSeriesView1
...
'			Me.comboBoxLabelKind.SelectedIndexChanged += New System.EventHandler(Me.comboBoxLabelKind_SelectedIndexChanged);
			...
			Me.comboBoxEditFunctionType.Location = New System.Drawing.Point(446, 9)
			...
			Me.comboBoxEditFunctionType.TabIndex = 66
'			Me.comboBoxEditFunctionType.SelectedIndexChanged += New System.EventHandler(Me.comboBoxEditFunctionType_SelectedIndexChanged);
			...
			' labelFunction
			' 
			Me.labelFunction.Location = New System.Drawing.Point(374, 12)
			Me.labelFunction.Margin = New System.Windows.Forms.Padding(0)
			Me.labelFunction.Name = "labelFunction"
			Me.labelFunction.Size = New System.Drawing.Size(45, 13)
			Me.labelFunction.TabIndex = 67
...
'			Me.comboBoxEditDiagramStyle.SelectedIndexChanged += New System.EventHandler(Me.comboBoxEditDiagramStyle_SelectedIndexChanged);
		...
		Protected WithEvents comboBoxEditFunctionType As XtraEditors.ComboBoxEdit
		Private labelFunction As XtraEditors.LabelControl
