...
Namespace DevExpress.XtraCharts.Demos
	...
	'''</summary>
	<Global.System.Serializable(), Global.System.ComponentModel.DesignerCategoryAttribute("code"), Global.System.ComponentModel.ToolboxItem(True), Global.System.Xml.Serialization.XmlSchemaProviderAttribute("GetTypedDataSetSchema"), Global.System.Xml.Serialization.XmlRootAttribute("DS4"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")> _
	Partial Public Class DS4
		...
		Public Overrides Function Clone() As Global.System.Data.DataSet
			Dim cln As DS4 = (CType(MyBase.Clone(), DS4))
			cln.InitVars()
		...
		Private Sub InitClass()
			Me.DataSetName = "DS4"
			Me.Prefix = ""
			Me.Namespace = "http://tempuri.org/DS4.xsd"
		...
		Partial Public Class CategoriesDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Function AddCategoriesRow(ByVal CategoryName As String, ByVal Quantity As Short, ByVal UnitPrice As Decimal, ByVal Sum As Decimal) As CategoriesRow
				Dim rowCategoriesRow As CategoriesRow = (CType(Me.NewRow(), CategoriesRow))
				Dim columnValuesArray() As Object = { CategoryName, Quantity, UnitPrice, Sum}
		...
		Partial Public Class CategoriesRow
			...
			Public Function IsQuantityNull() As Boolean
				Return Me.IsNull(Me.tableCategories.QuantityColumn)
			End Function

			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Sub SetQuantityNull()
				Me(Me.tableCategories.QuantityColumn) = Global.System.Convert.DBNull
			End Sub

			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Function IsUnitPriceNull() As Boolean
				Return Me.IsNull(Me.tableCategories.UnitPriceColumn)
			End Function

			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Sub SetUnitPriceNull()
				Me(Me.tableCategories.UnitPriceColumn) = Global.System.Convert.DBNull
			End Sub

			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Function IsSumNull() As Boolean
				Return Me.IsNull(Me.tableCategories.SumColumn)
			End Function

			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Sub SetSumNull()
				Me(Me.tableCategories.SumColumn) = Global.System.Convert.DBNull
			End Sub
		End Class
...
Namespace DevExpress.XtraCharts.Demos.DS4TableAdapters
	...
	Partial Public Class CategoriesTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        Categories.CategoryName, [Order Details].Quantity, [Order Details].UnitPrice, [Order Details].Quantity * [Order Details].UnitPrice AS [Sum]" & ControlChars.CrLf & "FROM            ((Categories INNER JOIN" & ControlChars.CrLf & "                         Products ON Categories.CategoryID = Products.CategoryID) INNER JOIN" & ControlChars.CrLf & "                         [Order Details] ON Products.ProductID = [Order Details].ProductID)"
		...
		Public Overridable Function Fill(ByVal dataTable As DS4.CategoriesDataTable) As Integer
		...
		Public Overridable Function GetData() As DS4.CategoriesDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New DS4.CategoriesDataTable()
