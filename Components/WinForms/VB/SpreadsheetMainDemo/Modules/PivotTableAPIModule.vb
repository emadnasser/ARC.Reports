...
Namespace DevExpress.XtraSpreadsheet.Demos
	Public Class PivotTableAPIModule
		...
		Private activeCell As Range

		Public Sub New()
			InitializeComponent()
			Dim examplePath As String = CodeExampleDemoUtils.GetExamplePath("CodeExamples\Pivots")
...
'			#End Region
		...
		Private Sub InitializeComponent()
			...
			' 
			Me.horizontalSplitContainerControl1.CaptionImageUri.Uri = ""
			...
			Me.richEditControlCS.Options.Bookmarks.ConflictNameResolution = DevExpress.XtraRichEdit.ConflictNameAction.Keep
			...
			Me.richEditControlVB.Options.Bookmarks.ConflictNameResolution = DevExpress.XtraRichEdit.ConflictNameAction.Keep
			...
			Me.spreadsheet.Size = New System.Drawing.Size(1005, 340)
			Me.spreadsheet.TabIndex = 5
			' 
			' verticalSplitContainerControl1
			' 
			Me.verticalSplitContainerControl1.CaptionImageUri.Uri = ""
