...
Namespace Modules.MailMergeDataSets
	...
	'''</summary>
	<Global.System.Serializable(), Global.System.ComponentModel.DesignerCategoryAttribute("code"), Global.System.ComponentModel.ToolboxItem(True), Global.System.Xml.Serialization.XmlSchemaProviderAttribute("GetTypedDataSetSchema"), Global.System.Xml.Serialization.XmlRootAttribute("FallCatalogDataSet"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")> _
	Partial Public Class FallCatalogDataSet
		...
		Public Overrides Function Clone() As Global.System.Data.DataSet
			Dim cln As FallCatalogDataSet = (CType(MyBase.Clone(), FallCatalogDataSet))
			cln.InitVars()
		...
		Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
			Dim ds As New FallCatalogDataSet()
		...
		Partial Public Class ProductsDataTable
			...
			Public Function AddProductsRow(ByVal ProductName As String, ByVal QuantityPerUnit As String, ByVal UnitPrice As Decimal, ByVal Description As String, ByVal Picture() As Byte, ByVal CategoryName As String) As ProductsRow
				...
				Dim columnValuesArray() As Object = { Nothing, ProductName, QuantityPerUnit, UnitPrice, Description, Picture, CategoryName, Nothing}
		...
		Partial Public Class Order_DetailsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Function AddOrder_DetailsRow(ByVal OrderID As Integer, ByVal parentProductsRowByProducts_Order_Details As ProductsRow, ByVal UnitPrice As Decimal, ByVal Quantity As Short, ByVal Discount As Single) As Order_DetailsRow
		...
		Partial Public Class ProductsRow
			...
			Public Function GetOrder_DetailsRows() As Order_DetailsRow()
				...
				Else
					Return (CType(MyBase.GetChildRows(Me.Table.ChildRelations("Products_Order Details")), Order_DetailsRow()))
				End If
			End Function
		End Class
		...
		Partial Public Class Order_DetailsRow
			...
			Public Property ProductsRow() As ProductsRow
				Get
					Return (CType(Me.GetParentRow(Me.Table.ParentRelations("Products_Order Details")), ProductsRow))
				End Get
...
Namespace Modules.MailMergeDataSets.FallCatalogDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT Products.ProductID, Products.ProductName, Products.QuantityPerUnit, Products.UnitPrice, Categories.Description, Categories.Picture, Categories.CategoryName, Categories.CategoryID FROM Products INNER JOIN Categories ON Products.CategoryID = Categories.CategoryID"
		...
		Public Overridable Function Fill(ByVal dataTable As FallCatalogDataSet.ProductsDataTable) As Integer
		...
		Public Overridable Function GetData() As FallCatalogDataSet.ProductsDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New FallCatalogDataSet.ProductsDataTable()
	...
	Partial Public Class Order_DetailsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
			Me._commandCollection(0).Connection = Me.Connection
			Me._commandCollection(0).CommandText = Constants.vbCrLf & "                      SELECT        [Order Details].*" & Constants.vbCrLf & "                      FR" & "OM            [Order Details]" & Constants.vbCrLf & Constants.vbTab + Constants.vbTab + Constants.vbTab + Constants.vbTab + Constants.vbTab + Constants.vbTab + Constants.vbTab + Constants.vbTab + Constants.vbTab + Constants.vbTab
			Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
		End Sub

		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, True)> _
		Public Overridable Function Fill(ByVal dataTable As FallCatalogDataSet.Order_DetailsDataTable) As Integer
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			If (Me.ClearBeforeFill = True) Then
				dataTable.Clear()
			End If
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Select, True)> _
		Public Overridable Function GetData() As FallCatalogDataSet.Order_DetailsDataTable
			Me.Adapter.SelectCommand = Me.CommandCollection(0)
			Dim dataTable As New FallCatalogDataSet.Order_DetailsDataTable()
			Me.Adapter.Fill(dataTable)
			Return dataTable
		End Function
	End Class
