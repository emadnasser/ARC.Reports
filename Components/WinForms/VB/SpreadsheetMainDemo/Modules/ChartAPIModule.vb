...
Namespace DevExpress.XtraSpreadsheet.Demos
	Public Class ChartAPIModule
		...
		Public Sub New()
			InitializeComponent()
			Dim examplePath As String = CodeExampleDemoUtils.GetExamplePath("CodeExamples\Charts")
		...
		Private Sub evaluator_OnAfterCompile(ByVal sender As Object, ByVal args As OnAfterCompileEventArgs)
			...
			If active.Charts.Count > 0 Then
				Dim chart As Chart = active.Charts(active.Charts.Count - 1)
...
'			#End Region
		...
		Private Sub InitializeComponent()
			...
			Me.spreadsheet.Options.View.Charts.Antialiasing = DocumentCapability.Enabled
