	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class ProductsDataTable
			...
			Public Function AddProductsRow(ByVal ProductName As String, ByVal UnitPrice As Decimal) As ProductsRow
				...
				Dim columnValuesArray() As Object = { ProductName, UnitPrice}
...
Namespace DevExpress.XtraSpreadsheet.Demos.nwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitConnection()
			...
			Me._connection.ConnectionString = String.Format("Provider=Microsoft.Jet.OLEDB.4.0;Data Source={0}", path)
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ProductName, UnitPrice FROM Products"
