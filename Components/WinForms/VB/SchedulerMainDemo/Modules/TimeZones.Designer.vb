...
Namespace DevExpress.XtraScheduler.Demos
	Partial Public Class TimeZonesModule
		...
		Private Sub InitializeComponent()
			...
			Dim timeRuler7 As New DevExpress.XtraScheduler.TimeRuler()
			Dim timeRuler8 As New DevExpress.XtraScheduler.TimeRuler()
			Dim timeRuler9 As New DevExpress.XtraScheduler.TimeRuler()
			...
			timeRuler4.TimeZoneId = "Greenwich Standard Time"
			timeRuler4.UseClientTimeZone = False
			timeRuler5.Caption = "Local"
			Me.schedulerControl.Views.FullWeekView.TimeRulers.Add(timeRuler4)
			...
			timeRuler7.Caption = "GMT"
			timeRuler7.TimeZoneId = "Greenwich Standard Time"
			timeRuler7.UseClientTimeZone = False
			timeRuler8.Caption = "Local"
			Me.schedulerControl.Views.WorkWeekView.TimeRulers.Add(timeRuler7)
			...
			Me.panelSeparatorControl.Location = New System.Drawing.Point(0, 180)
			Me.panelSeparatorControl.Name = "panelSeparatorControl"
			Me.panelSeparatorControl.Size = New System.Drawing.Size(704, 10)
			Me.panelSeparatorControl.TabIndex = 9
			' 
			' edtTimeZone
			' 
			Me.edtTimeZone.Location = New System.Drawing.Point(64, 10)
			...
			Me.edtTimeZone.Size = New System.Drawing.Size(309, 20)
			Me.edtTimeZone.TabIndex = 1
'			Me.edtTimeZone.EditValueChanged += New System.EventHandler(Me.edtTimeZone_EditValueChanged);
			' 
			' lblTimeZone
			' 
			Me.lblTimeZone.Location = New System.Drawing.Point(5, 13)
			...
			Me.panelControl.Size = New System.Drawing.Size(704, 39)
...
'			Me.Load += New System.EventHandler(Me.TimeZonesModule_Load);
		...
		Private WithEvents edtTimeZone As UI.TimeZoneEdit
		Private lblTimeZone As XtraEditors.LabelControl
		Private panelControl As XtraEditors.PanelControl
