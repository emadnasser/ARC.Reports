...
Namespace DevExpress.XtraScheduler.Demos
	Partial Public Class DragDropDataModule
		...
		Private Sub InitializeComponent()
			...
			Me.schedulerControl.Size = New System.Drawing.Size(704, 140)
			Me.schedulerControl.Start = New System.DateTime(2016, 11, 14, 0, 0, 0, 0)
...
'			Me.schedulerControl.AppointmentDrop += New DevExpress.XtraScheduler.AppointmentDragEventHandler(Me.schedulerControl_AppointmentDrop);
			' 
			' ribbonControl1
			' 
			...
			' schedulerStorage
			' 
			Me.schedulerStorage.Appointments.Labels.Add(System.Drawing.Color.FromArgb((CInt(Fix((CByte(128))))), (CInt(Fix((CByte(255))))), (CInt(Fix((CByte(128)))))), "Minor", "&Minor")
			Me.schedulerStorage.Appointments.Labels.Add(System.Drawing.Color.FromArgb((CInt(Fix((CByte(255))))), (CInt(Fix((CByte(192))))), (CInt(Fix((CByte(128)))))), "Moderate", "&Moderate")
			Me.schedulerStorage.Appointments.Labels.Add(System.Drawing.Color.FromArgb((CInt(Fix((CByte(255))))), (CInt(Fix((CByte(128))))), (CInt(Fix((CByte(128)))))), "Severe", "&Severe")
			Me.schedulerStorage.Appointments.Statuses.Add(DevExpress.XtraScheduler.AppointmentStatusType.Free, "Low", "&Low", System.Drawing.Color.FromArgb((CInt(Fix((CByte(128))))), (CInt(Fix((CByte(255))))), (CInt(Fix((CByte(128)))))))
			Me.schedulerStorage.Appointments.Statuses.Add(DevExpress.XtraScheduler.AppointmentStatusType.Tentative, "Normal", "&Normal", System.Drawing.Color.FromArgb((CInt(Fix((CByte(255))))), (CInt(Fix((CByte(192))))), (CInt(Fix((CByte(128)))))))
			Me.schedulerStorage.Appointments.Statuses.Add(DevExpress.XtraScheduler.AppointmentStatusType.OutOfOffice, "High", "&High", System.Drawing.Color.FromArgb((CInt(Fix((CByte(255))))), (CInt(Fix((CByte(128))))), (CInt(Fix((CByte(128)))))))
			' 
			' splitterControl1
			' 
			Me.splitterControl1.Dock = System.Windows.Forms.DockStyle.Bottom
			Me.splitterControl1.Location = New System.Drawing.Point(0, 281)
			...
			Me.grdTasks.RepositoryItems.AddRange(New DevExpress.XtraEditors.Repository.RepositoryItem() { Me.repImgPriority, Me.repSpinDuration, Me.repImgSeverity})
...
'			Me.gridView1.MouseDown += New System.Windows.Forms.MouseEventHandler(Me.grdTasks_MouseDown);
'			Me.gridView1.MouseMove += New System.Windows.Forms.MouseEventHandler(Me.grdTasks_MouseMove);
			' 
			' colSubject
			' 
...
'			Me.Load += New System.EventHandler(Me.DragDropDataModule_Load);
