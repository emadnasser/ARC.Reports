...
'			Me.schedulerControl.ActiveViewChanged += New System.EventHandler(Me.schedulerControl_ActiveViewChanged);
			...
			Me.cbView.EditValue = ""
			Me.cbView.Location = New System.Drawing.Point(51, 10)
...
'			Me.cbView.SelectedIndexChanged += New System.EventHandler(Me.cbView_SelectedIndexChanged);
			...
			' lblView
			' 
			Me.lblView.Location = New System.Drawing.Point(15, 13)
			...
			Me.btnCreateAppointmentWithReminder.Location = New System.Drawing.Point(491, 8)
...
'			Me.btnCreateAppointmentWithReminder.Click += New System.EventHandler(Me.btnCreateAppointmentWithReminder_Click);
			' 
			' btnGotoToday
			' 
			...
			Me.btnGotoToday.Location = New System.Drawing.Point(405, 8)
...
'			Me.btnGotoToday.Click += New System.EventHandler(Me.btnGotoToday_Click);
			' 
...
'			Me.Load += New System.EventHandler(Me.RemindersModule_Load);
'			Me.VisibleChanged += New System.EventHandler(Me.RemindersModule_VisibleChanged);
