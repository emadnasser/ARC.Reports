...
'			Me.schedulerControl.EditAppointmentFormShowing += New DevExpress.XtraScheduler.AppointmentFormEventHandler(Me.schedulerControl_EditAppointmentFormShowing);
			...
			Me.rgrpAptFormStyle.Properties.Items.AddRange(New DevExpress.XtraEditors.Controls.RadioGroupItem() { New DevExpress.XtraEditors.Controls.RadioGroupItem(Nothing, "Outlook"), New DevExpress.XtraEditors.Controls.RadioGroupItem(Nothing, "Default")})
			...
			Me.panelSeparatorControl.TabIndex = 8
			' 
...
'			Me.Load += New System.EventHandler(Me.AppointmentFormStylesModule_Load);
