...
Namespace DevExpress.XtraScheduler.Demos
	Partial Public Class XPOBoundModeModule
		...
		Private Sub InitializeComponent()
			...
			Me.xpCollectionTasks = New DevExpress.Xpo.XPCollection(Me.components)
			Me.session1 = New DevExpress.Xpo.Session(Me.components)
			Me.xpCollectionEmployees = New DevExpress.Xpo.XPCollection(Me.components)
			...
			Me.schedulerControl.Size = New System.Drawing.Size(704, 263)
...
'			Me.schedulerStorage.AppointmentsInserted += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.OnAppointmentsChanged);
'			Me.schedulerStorage.AppointmentsChanged += New DevExpress.XtraScheduler.PersistentObjectsEventHandler(Me.OnAppointmentsChanged);
			' 
			' xpCollectionTasks
			' 
...
'			Me.Load += New System.EventHandler(Me.XPOBoundModeModule_Load);
