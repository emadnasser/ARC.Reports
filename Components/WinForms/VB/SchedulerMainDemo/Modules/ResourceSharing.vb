...
Namespace DevExpress.XtraScheduler.Demos
	Partial Public Class ResourceSharingModule
		...
		End Function
		#End Region
		Private Sub schedulerStorage_AppointmentChanging(ByVal sender As Object, ByVal e As PersistentObjectCancelEventArgs) Handles schedulerStorage.AppointmentInserting, schedulerStorage.AppointmentChanging
