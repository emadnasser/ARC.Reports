...
'			Me.chEditKeepInView.CheckedChanged += New System.EventHandler(Me.chEditKeepInView_CheckedChanged);
			' 
			' contextButtonGroup
			' 
...
'			Me.cbContextButtonAlignment.SelectedIndexChanged += New System.EventHandler(Me.cbContextButtonAlignment_SelectedIndexChanged);
			' 
...
'			Me.cbContextButtonVisibility.SelectedIndexChanged += New System.EventHandler(Me.cbOpenContextButtonVisibility_SelectedIndexChanged);
			' 
...
'			Me.Load += New System.EventHandler(Me.ContextButtonsModule_Load);
		...
		Private contextButtonGroup As XtraEditors.GroupControl
		...
		Private WithEvents chEditKeepInView As XtraEditors.CheckEdit
		Private lbContextButtonVisibility As XtraEditors.LabelControl
		Private WithEvents cbContextButtonVisibility As XtraEditors.ImageComboBoxEdit
		Private contextButtonOptionsGroup As XtraEditors.GroupControl
		Private lbContextButtonAlignment As XtraEditors.LabelControl
		Private WithEvents cbContextButtonAlignment As XtraEditors.ImageComboBoxEdit
