...
Namespace DevExpress.MVVM.Demos.Views
    ...
    Partial Public Class Accounts
        ...
        Private Sub InitBindings()
            ...
            Dim fluentAPI = mvvmContext.OfType(Of DevExpress.MVVM.Demos.ViewModels.AccountCollectionViewModel)()
            ...
            fluentAPI.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(gridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.SelectedEntity, Function(args) TryCast(args.Row, DevExpress.MVVM.Demos.Model.Account), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
