...
Namespace DevExpress.MVVM.Demos.Views
    ...
    Partial Public Class CategoryEditForm
        ...
        Private Sub InitBindings()
            ...
            fluent.WithEvent(Of GridView, FocusedRowObjectChangedEventArgs)(transactionsGridView, "FocusedRowObjectChanged").SetBinding(Function(x) x.CategoryTransactionDetails.SelectedEntity, Function(args) TryCast(args.Row, DevExpress.MVVM.Demos.Model.Transaction), Sub(gView, entity) gView.FocusedRowHandle = gView.FindRow(entity))
