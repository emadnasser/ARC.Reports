...
Namespace DevExpress.MVVM.Demos.Common.ViewModel
    ...
    Public Class CloseAllMessage
        ...
        Private _viewModelPredicate As Func(Of Object, Boolean)
        ''' <summary>
        ...
        Public Sub New(ByVal cancelEventArgs As CancelEventArgs, ByVal viewModelPredicate As Func(Of Object, Boolean))
            Me._cancelEventArgs = cancelEventArgs
            Me._viewModelPredicate = viewModelPredicate
        End Sub
        Public Function ShouldProcess(ByVal viewModel As Object) As Boolean
            Return _viewModelPredicate(viewModel)
        End Function
        ''' <summary>
