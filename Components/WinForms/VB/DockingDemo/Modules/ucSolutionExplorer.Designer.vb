...
Namespace DevExpress.XtraBars.Demos.DockingDemo
	Partial Public Class ucSolutionExplorer
		...
		Private Sub InitializeComponent()
			...
			Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ucSolutionExplorer))
			...
			Me.iShow.Name = "iShow"
'			Me.iShow.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.iShow_ItemClick);
			' 
			' iProperties
			' 
...
'			Me.iProperties.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.iProperties_ItemClick);
			' 
...
'			Me.treeView.MouseDoubleClick += New System.Windows.Forms.MouseEventHandler(Me.treeView_MouseDoubleClick);
			' 
			' ucSolutionExplorer
			' 
