...
Namespace PhotoViewer
	Public NotInheritable Class FilterHelper
		...
		Private Shared Function ApplyContrastFilter(ByVal img As Image, ParamArray ByVal filterParams() As Object) As Image
            Dim param As Single
            If filterParams Is Nothing OrElse filterParams.Length = 0 Then param = 2.0F Else param = CSng(filterParams(0))
		...
		Private Shared Function ApplyBrightnessFilter(ByVal img As Image, ParamArray ByVal filterParams() As Object) As Image
            Dim param As Single
            If filterParams Is Nothing OrElse filterParams.Length = 0 Then param = 0.3F Else param = CSng(filterParams(0))
		...
		Public Shared Function ApplyFilter(ByVal name As String, ByVal img As Image, ParamArray ByVal filterParams() As Object) As Image
			...
			Return img
		End Function
		Private Shared filtersCore As List(Of FilterInfo)
	...
	Public Class FilterInfo
		...
		Private filterMethodCore As System.Delegate
		Private paramsControlTypeCore As Type

		Public Sub New(ByVal name As String, ByVal filterMethod As System.Delegate, ByVal paramsControlType As Type)
			Me.nameCore = name
			Me.filterMethodCore = filterMethod
			Me.paramsControlTypeCore = paramsControlType
		End Sub
		...
		Public Function CreateParamsControl() As SimpleFilterParams
			Dim ci As ConstructorInfo = paramsControlTypeCore.GetConstructor(New Type() { })
