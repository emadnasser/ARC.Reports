...
Namespace DevExpress.Xpo.Demos
    Partial Public Class frmMain
        ...
        End Sub
        Protected Overloads Overrides Sub ShowModule(ByVal name As String, ByVal group As GroupControl, ByVal lookAndFeel As DefaultLookAndFeel, ByVal caption As ApplicationCaption)
        ...
        Private Sub bbiWizard_Click(ByVal sender As Object, ByVal e As ItemClickEventArgs)
            If (TypeOf ModulesInfo.Instance.CurrentModuleBase.TModule Is TutorialControl) Then
                CType(ModulesInfo.Instance.CurrentModuleBase.TModule, TutorialControl).ShowWhatsThis()
            End If
        End Sub

        Private Sub MainTutorialForm_Resize(ByVal sender As Object, ByVal e As System.EventArgs)
            If (TypeOf ModulesInfo.Instance.CurrentModuleBase.TModule Is TutorialControl) Then
                CType(ModulesInfo.Instance.CurrentModuleBase.TModule, TutorialControl).DisableWhatsThis()
            End If
        End Sub
