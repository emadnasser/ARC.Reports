	...
	Partial Public Class ObjectsInAlias
		...
		Public Class Order
            ...
            Public Property MainCustomerIsOne() As Boolean
                ...
                End Get
                Set(ByVal value As Boolean)
                    SetPropertyValue("MainCustomerIsOne", _mainCustomerIsOne, value)
                End Set
            End Property
			Public Property CustomerOne() As Person
				...
				Set(ByVal value As Person)
					SetPropertyValue("CustomerOne", customer1, value)
				End Set
			End Property
			Public Property CustomerTwo() As Person
				...
				End Get
				Set(ByVal value As Person)
					SetPropertyValue("CustomerTwo", customer2, value)
				End Set
			End Property

			<PersistentAlias("Iif(MainCustomerIsOne, CustomerOne, CustomerTwo)")> _
			Public ReadOnly Property MainCustomer() As Person
				Get
					Return CType(EvaluateAlias("MainCustomer"), Person)
				End Get
			End Property
			<PersistentAlias("IsNull(CustomerOne, CustomerTwo)")> _
			Public ReadOnly Property NotNullCustomer() As Person
				Get
					Return CType(EvaluateAlias("NotNullCustomer"), Person)
				End Get
			End Property
			<PersistentAlias("[<Person>][Oid = ^.CustomerOne].Single()")> _
			Public ReadOnly Property CustomerOneBySingle() As Person
				Get
					Return CType(EvaluateAlias("CustomerOneBySingle"), Person)
				End Get
			End Property
