Namespace DevExpress.XtraGrid.Demos
	Partial Public Class SearchLookUpProperties
		...
		Private Sub InitializeComponent()
			Dim resources As New System.ComponentModel.ComponentResourceManager(GetType(SearchLookUpProperties))
			...
			Me.ceShowAddNewButton = New DevExpress.XtraEditors.CheckEdit()
			Me.icbFindMode = New DevExpress.XtraEditors.ImageComboBoxEdit()
			Me.icbFilterMode = New DevExpress.XtraEditors.ImageComboBoxEdit()
			...
			CType(Me.ceShowAddNewButton.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
			CType(Me.icbFindMode.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
			CType(Me.icbFilterMode.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
			...
			Me.groupControl1.Controls.Add(Me.ceShowClearButton)
			Me.groupControl1.Controls.Add(Me.ceShowAddNewButton)
			Me.groupControl1.Controls.Add(Me.icbFindMode)
			Me.groupControl1.Controls.Add(Me.icbFilterMode)
...
'			Me.ceShowClearButton.CheckedChanged += New System.EventHandler(Me.ceShowClearButton_CheckedChanged)
			...
			' ceShowAddNewButton
			' 
			resources.ApplyResources(Me.ceShowAddNewButton, "ceShowAddNewButton")
			Me.ceShowAddNewButton.Name = "ceShowAddNewButton"
			Me.ceShowAddNewButton.Properties.Caption = resources.GetString("ceShowAddNewButton.Properties.Caption")
'			Me.ceShowAddNewButton.CheckedChanged += New System.EventHandler(Me.ceShowAddNewButton_CheckedChanged)
			' 
			' icbFindMode
			' 
			resources.ApplyResources(Me.icbFindMode, "icbFindMode")
			Me.icbFindMode.Name = "icbFindMode"
			Me.icbFindMode.Properties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() { New DevExpress.XtraEditors.Controls.EditorButton((CType(resources.GetObject("icbFindMode.Properties.Buttons"), DevExpress.XtraEditors.Controls.ButtonPredefines)))})
'			Me.icbFindMode.SelectedIndexChanged += New System.EventHandler(Me.icbFindMode_SelectedIndexChanged)
			' 
			' icbFilterMode
			' 
			resources.ApplyResources(Me.icbFilterMode, "icbFilterMode")
			Me.icbFilterMode.Name = "icbFilterMode"
			Me.icbFilterMode.Properties.Buttons.AddRange(New DevExpress.XtraEditors.Controls.EditorButton() { New DevExpress.XtraEditors.Controls.EditorButton((CType(resources.GetObject("icbFilterMode.Properties.Buttons"), DevExpress.XtraEditors.Controls.ButtonPredefines)))})
'			Me.icbFilterMode.SelectedIndexChanged += New System.EventHandler(Me.icbFilterMode_SelectedIndexChanged)
			' 
			' ceShowPopupFooter
			' 
...
'			Me.ceEnableAppearanceOddRow.CheckedChanged += New System.EventHandler(Me.ceEnableAppearanceOddRow_CheckedChanged)
			...
			' 
			' SearchLookUpProperties
			' 
			resources.ApplyResources(Me, "$this")
			Me.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font
			Me.Controls.Add(Me.xtraScrollableControl1)
			Me.Name = "SearchLookUpProperties"
'			Me.Load += New System.EventHandler(Me.LookUpProperties_Load)
			...
			CType(Me.ceShowAddNewButton.Properties, System.ComponentModel.ISupportInitialize).EndInit()
			CType(Me.icbFindMode.Properties, System.ComponentModel.ISupportInitialize).EndInit()
			CType(Me.icbFilterMode.Properties, System.ComponentModel.ISupportInitialize).EndInit()
		...
		Private WithEvents ceShowAddNewButton As DevExpress.XtraEditors.CheckEdit
		Private WithEvents icbFindMode As DevExpress.XtraEditors.ImageComboBoxEdit
		Private WithEvents icbFilterMode As DevExpress.XtraEditors.ImageComboBoxEdit
