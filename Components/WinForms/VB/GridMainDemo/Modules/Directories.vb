...
#Region "FilesDir"
    ...
    Public Class Directories
        ...
        Private Function IRelationList_GetRelationName(ByVal index As Integer, ByVal relationIndex As Integer) As String Implements IRelationList.GetRelationName
            Return (If(relationIndex = 0, My.Resources.Directories, My.Resources.Files))
        End Function
        ...
        Default Public Overridable Shadows ReadOnly Property Item(ByVal index As Integer) As Directory
            Get
