...
Namespace DevExpress.XtraEditors.Demos
	Partial Public Class InplaceEditors
		...
		Public Sub New()
			...
			'TutorialInfo.WhatsThisCodeFile = "CS\\GridMainDemo\\Modules\\InplaceEditors.vb";
		...
		Private Sub AddRecordToLookUpDataTable(ByVal fName As String, ByVal department As String)
			Dim row As DataRow = Me.dataTableLookUp.NewRow()
			row("clnId") = Me.dataTableLookUp.Rows.Count + 1
			row("clnName") = fName
			row("clnDepartment") = department
			Me.dataTableLookUp.Rows.Add(row)
		End Sub
