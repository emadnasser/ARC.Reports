...
Namespace DevExpress.RealtorWorld.Win
	...
	Public Class Home
		...
		Public ReadOnly Property Type() As String
			Get
				Return DevExpress.Utils.EnumExtensions.GetEnumItemDisplayText(CType(row("Type"), PropertyType))
			End Get
		End Property
		Public ReadOnly Property Status() As String
			Get
				Return DevExpress.Utils.EnumExtensions.GetEnumItemDisplayText(CType(row("Status"), PropertyStatus))
			End Get
		End Property
	...
	Public Class DataHelper
		...
		Public Shared Sub InitZillowTile(ByVal tile As ITileItem)
			...
			info.UseImage = True
			info.UseText = True
			info.Image = My.Resources.zillow_logo
